...
class CreateSubNetworkInterfaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubNetworkInterfaceRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'subNetworkInterface' => '\G42Cloud\SDK\Vpc\V3\Model\CreateSubNetworkInterfaceOption'
    ];
    ...
    *  subNetworkInterface
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CreateSubNetworkInterfaceOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CreateSubNetworkInterfaceOption $subNetworkInterface subNetworkInterface
    *
    * @return $this
    */
