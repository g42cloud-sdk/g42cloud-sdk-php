...
class CreateSecurityGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRequestBody|null $body body
    *
    * @return $this
    */
