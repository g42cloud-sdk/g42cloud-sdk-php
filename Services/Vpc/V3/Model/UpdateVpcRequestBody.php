...
class UpdateVpcRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpcRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dryRun  功能说明：是否只预检此次请求 取值范围： -true：发送检查请求，不会更新VPC。检查项包括是否填写了必需参数、请求格式、业务限制。如果检查不通过，则返回对应错误。如果检查通过，则返回响应码202。 -false（默认值）：发送正常请求，并直接更新VPC。
    * vpc  vpc
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'vpc' => '\G42Cloud\SDK\Vpc\V3\Model\UpdateVpcOption'
    ];
    ...
    * Sets dryRun
    *
    * @param bool|null $dryRun 功能说明：是否只预检此次请求 取值范围： -true：发送检查请求，不会更新VPC。检查项包括是否填写了必需参数、请求格式、业务限制。如果检查不通过，则返回对应错误。如果检查通过，则返回响应码202。 -false（默认值）：发送正常请求，并直接更新VPC。
    *
    * @return $this
    */
    ...
    *  vpc
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\UpdateVpcOption
    */
    ...
    * Sets vpc
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\UpdateVpcOption $vpc vpc
    *
    * @return $this
    */
