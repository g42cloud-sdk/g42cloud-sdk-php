...
class CreateAddressGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'addressGroup' => '\G42Cloud\SDK\Vpc\V3\Model\CreateAddressGroupOption'
    ];
    ...
    *  addressGroup
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CreateAddressGroupOption
    */
    ...
    * Sets addressGroup
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CreateAddressGroupOption $addressGroup addressGroup
    *
    * @return $this
    */
