...
class ListSecurityGroupRulesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'securityGroupRules' => '\G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule[]',
    ...
    *  安全组规则列表响应体
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule[]|null $securityGroupRules 安全组规则列表响应体
    *
    * @return $this
    */
