...
class BatchCreateSubNetworkInterfaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'subNetworkInterface' => '\G42Cloud\SDK\Vpc\V3\Model\BatchCreateSubNetworkInterfaceOption',
            'count' => 'int'
    ];
    ...
    *  subNetworkInterface
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\BatchCreateSubNetworkInterfaceOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\BatchCreateSubNetworkInterfaceOption $subNetworkInterface subNetworkInterface
    *
    * @return $this
    */
