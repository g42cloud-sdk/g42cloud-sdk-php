...
class RemoveVpcExtendCidrResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveVpcExtendCidrResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpc' => '\G42Cloud\SDK\Vpc\V3\Model\Vpc',
            'requestId' => 'string'
    ];
    ...
    * Sets vpc
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\Vpc|null $vpc vpc
    *
    * @return $this
    */
