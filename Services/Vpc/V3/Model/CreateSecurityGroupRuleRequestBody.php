...
class CreateSecurityGroupRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'securityGroupRule' => '\G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRuleOption'
    ];
    ...
    *  securityGroupRule
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRuleOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRuleOption $securityGroupRule securityGroupRule
    *
    * @return $this
    */
