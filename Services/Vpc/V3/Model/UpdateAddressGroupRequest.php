...
class UpdateAddressGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'projectId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V3\Model\UpdateAddressGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\UpdateAddressGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\UpdateAddressGroupRequestBody|null $body body
    *
    * @return $this
    */
