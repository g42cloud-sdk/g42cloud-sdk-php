...
class ListSubNetworkInterfacesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'subNetworkInterfaces' => '\G42Cloud\SDK\Vpc\V3\Model\SubNetworkInterface[]',
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\SubNetworkInterface[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SubNetworkInterface[]|null $subNetworkInterfaces 1、功能说明：辅助弹性网卡查询对象 2、取值范围：N/A 3、约束：N/A 4、默认值：N/A 5、权限：N/A
    *
    * @return $this
    */
