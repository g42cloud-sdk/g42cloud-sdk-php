...
class ShowSubNetworkInterfacesQuantityRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSubNetworkInterfacesQuantityRequest';
