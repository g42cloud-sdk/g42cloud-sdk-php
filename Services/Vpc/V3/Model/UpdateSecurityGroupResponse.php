...
class UpdateSecurityGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityGroupResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'securityGroup' => '\G42Cloud\SDK\Vpc\V3\Model\SecurityGroupInfo'
    ];
    ...
    *  securityGroup
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupInfo|null
    */
    ...
    * Sets securityGroup
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupInfo|null $securityGroup securityGroup
    *
    * @return $this
    */
