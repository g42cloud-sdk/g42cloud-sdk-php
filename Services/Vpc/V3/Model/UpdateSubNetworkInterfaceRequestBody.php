...
class UpdateSubNetworkInterfaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'subNetworkInterface' => '\G42Cloud\SDK\Vpc\V3\Model\UpdateSubNetworkInterfaceOption'
    ];
    ...
    *  subNetworkInterface
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\UpdateSubNetworkInterfaceOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\UpdateSubNetworkInterfaceOption $subNetworkInterface subNetworkInterface
    *
    * @return $this
    */
