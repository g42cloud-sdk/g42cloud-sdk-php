...
class BatchCreateSubNetworkInterfaceOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateSubNetworkInterfaceOption';
    ...
    * Sets parentId
    *
    * @param string $parentId 功能说明：宿主网络接口的ID 取值范围：标注UUID 约束：必须是实际存在的端口ID
    *
    * @return $this
    */
