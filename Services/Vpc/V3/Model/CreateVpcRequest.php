...
class CreateVpcRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpcRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V3\Model\CreateVpcRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CreateVpcRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CreateVpcRequestBody|null $body body
    *
    * @return $this
    */
