...
class SecurityGroupInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityGroupInfo';
    ...
    *  安全组规则
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule[] $securityGroupRules 安全组规则
    *
    * @return $this
    */
