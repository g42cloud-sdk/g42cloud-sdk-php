...
class CreateSecurityGroupRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityGroupRuleResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'securityGroupRule' => '\G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule'
    ];
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SecurityGroupRule|null $securityGroupRule securityGroupRule
    *
    * @return $this
    */
