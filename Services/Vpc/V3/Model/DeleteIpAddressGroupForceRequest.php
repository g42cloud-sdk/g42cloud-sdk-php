...
class DeleteIpAddressGroupForceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIpAddressGroupForceRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID
    * addressGroupId  IP地址组的唯一标识，要删除的IP地址组ID
    *
    * @var string[]
    */
