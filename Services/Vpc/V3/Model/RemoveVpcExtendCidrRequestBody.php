...
class RemoveVpcExtendCidrRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'vpc' => '\G42Cloud\SDK\Vpc\V3\Model\RemoveExtendCidrOption'
    ];
    ...
    *  vpc
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\RemoveExtendCidrOption
    */
    ...
    * Sets vpc
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\RemoveExtendCidrOption $vpc vpc
    *
    * @return $this
    */
