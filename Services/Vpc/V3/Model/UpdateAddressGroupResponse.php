...
class UpdateAddressGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAddressGroupResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'addressGroup' => '\G42Cloud\SDK\Vpc\V3\Model\AddressGroup'
    ];
    ...
    * Sets addressGroup
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\AddressGroup|null $addressGroup addressGroup
    *
    * @return $this
    */
