...
class CreateSubNetworkInterfaceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubNetworkInterfaceResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'subNetworkInterface' => '\G42Cloud\SDK\Vpc\V3\Model\SubNetworkInterface'
    ];
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SubNetworkInterface|null $subNetworkInterface subNetworkInterface
    *
    * @return $this
    */
