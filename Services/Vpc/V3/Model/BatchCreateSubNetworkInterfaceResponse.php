...
class BatchCreateSubNetworkInterfaceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateSubNetworkInterfaceResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求ID
    * subNetworkInterfaces  批量创建辅助弹性网卡的响应体
    *
    * @var string[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\SubNetworkInterface[]|null $subNetworkInterfaces 批量创建辅助弹性网卡的响应体
    *
    * @return $this
    */
