...
class MigrateSubNetworkInterfaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrateSubNetworkInterfaceRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'migrationInfo' => '\G42Cloud\SDK\Vpc\V3\Model\MigrateSubNetworkInterfaceOption'
    ];
    ...
    */
    protected static $setters = [
            'dryRun' => 'setDryRun',
            'migrationInfo' => 'setMigrationInfo'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['migrationInfo'] = isset($data['migrationInfo']) ? $data['migrationInfo'] : null;
    }
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['migrationInfo'] === null) {
            $invalidProperties[] = "'migrationInfo' can't be null";
        }
    ...
    *  migrationInfo
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\MigrateSubNetworkInterfaceOption
    */
    public function getMigrationInfo()
    {
        return $this->container['migrationInfo'];
    }

    /**
    * Sets migrationInfo
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\MigrateSubNetworkInterfaceOption $migrationInfo migrationInfo
    *
    * @return $this
    */
    public function setMigrationInfo($migrationInfo)
    {
        $this->container['migrationInfo'] = $migrationInfo;
        return $this;
    }
