...
class UpdateVpcRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'vpcId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V3\Model\UpdateVpcRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\UpdateVpcRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\UpdateVpcRequestBody|null $body body
    *
    * @return $this
    */
