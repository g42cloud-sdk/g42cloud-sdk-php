...
class ListAddressGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'addressGroups' => '\G42Cloud\SDK\Vpc\V3\Model\AddressGroup[]',
    ...
    *  地址组列表响应体
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\AddressGroup[]|null
    */
    ...
    * Sets addressGroups
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\AddressGroup[]|null $addressGroups 地址组列表响应体
    *
    * @return $this
    */
