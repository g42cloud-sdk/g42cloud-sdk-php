...
class ShowSubNetworkInterfacesQuantityResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSubNetworkInterfacesQuantityResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求ID
    * subNetworkInterfaces  辅助弹性网卡数目
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'subNetworkInterfaces' => 'int'
    ];
    ...
    *
    * @param int|null $subNetworkInterfaces 辅助弹性网卡数目
    *
    * @return $this
    */
