...
class Vpc implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'createdAt' => '\DateTime',
            'updatedAt' => '\DateTime',
            'cloudResources' => '\G42Cloud\SDK\Vpc\V3\Model\CloudResource[]',
            'tags' => '\G42Cloud\SDK\Vpc\V3\Model\Tag[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CloudResource[]
    */
    ...
    * Sets cloudResources
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CloudResource[] $cloudResources 功能说明：VPC关联资源类型和数量 取值范围：目前只返回VPC关联的routetable和virsubnet
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\Tag[]
    */
    ...
    * Sets tags
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\Tag[] $tags 功能说明：VPC的标签信息，详情参见Tag对象 取值范围：0-10个标签键值对
    *
    * @return $this
    */
