...
class CreateSecurityGroupRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V3\Model\CreateSecurityGroupRuleRequestBody|null $body body
    *
    * @return $this
    */
