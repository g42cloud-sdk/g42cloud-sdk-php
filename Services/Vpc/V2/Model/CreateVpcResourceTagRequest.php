...
class CreateVpcResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpcResourceTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'vpcId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\CreateVpcResourceTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\CreateVpcResourceTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\CreateVpcResourceTagRequestBody|null $body body
    *
    * @return $this
    */
