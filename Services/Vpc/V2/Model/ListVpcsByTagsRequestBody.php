...
class ListVpcsByTagsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVpcsByTagsRequestBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'offset' => 'int',
            'matches' => '\G42Cloud\SDK\Vpc\V2\Model\Match[]',
            'tags' => '\G42Cloud\SDK\Vpc\V2\Model\ListTag[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\Match[]|null
    */
    ...
    * Sets matches
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\Match[]|null $matches 功能说明：搜索字段，key为要匹配的字段，value为匹配的值 约束：当前仅支持resource_name
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\ListTag[]|null
    */
    ...
    * Sets tags
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\ListTag[]|null $tags 包含标签，最多包含10个key，每个key下面的value最多10个，结构体不能缺失，key不能为空或者空字符串。Key不能重复，同一个key中values不能重复
    *
    * @return $this
    */
