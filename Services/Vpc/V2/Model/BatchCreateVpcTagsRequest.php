...
class BatchCreateVpcTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'vpcId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\BatchCreateVpcTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\BatchCreateVpcTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\BatchCreateVpcTagsRequestBody|null $body body
    *
    * @return $this
    */
