...
class CreatePortOption implements ModelInterface, ArrayAccess
{
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\FixedIp[]|null
    */
    ...
    * Sets fixedIps
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\FixedIp[]|null $fixedIps 功能说明：端口IP 例如：\"fixed_ips\": [{\"subnet_id\": \"4dc70db6-cb7f-4200-9790-a6a910776bba\", \"ip_address\": \"192.169.25.79\"}] 约束：ipv4场景下一个端口只支持一个fixed_ip，且不支持更新
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\AllowedAddressPair[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\AllowedAddressPair[]|null $allowedAddressPairs 功能说明：IP/Mac对列表 约束：IP地址不允许为 “0.0.0.0/0” 如果配置的地址池较大（CIDR掩码小于24位），建议为该port配置一个单独的安全组。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOpt[]|null
    */
    ...
    * Sets extraDhcpOpts
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOpt[]|null $extraDhcpOpts 功能说明：DHCP的扩展Option(扩展属性)
    *
    * @return $this
    */
