...
class NeutronPageLink implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronPageLink';
    ...
    * Sets rel
    *
    * @param string $rel API链接与该API版本的关系
    *
    * @return $this
    */
