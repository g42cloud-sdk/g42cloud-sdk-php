...
class NeutronListFirewallGroupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'firewallGroups' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronFirewallGroup[]',
            'firewallGroupsLinks' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]'
    ];
    ...
    * Sets firewallGroups
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronFirewallGroup[]|null $firewallGroups firewall_group对象列表
    *
    * @return $this
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]|null $firewallGroupsLinks 分页信息
    *
    * @return $this
    */
