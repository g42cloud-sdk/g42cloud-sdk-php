...
class NeutronListSecurityGroupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroups' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroup[]',
            'securityGroupsLinks' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]'
    ];
    ...
    *  安全组对象列表
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroup[]|null
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroup[]|null $securityGroups 安全组对象列表
    *
    * @return $this
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]|null $securityGroupsLinks 分页信息
    *
    * @return $this
    */
