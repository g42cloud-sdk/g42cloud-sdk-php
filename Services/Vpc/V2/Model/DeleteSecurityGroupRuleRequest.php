...
class DeleteSecurityGroupRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSecurityGroupRuleRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['securityGroupRuleId'] === null) {
            ...
            if (!preg_match("/[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}/", $this->container['securityGroupRuleId'])) {
                $invalidProperties[] = "invalid value for 'securityGroupRuleId', must be conform to the pattern /[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}/.";
            }
