...
class SecurityGroupRule implements ModelInterface, ArrayAccess
{
    ...
    * ethertype  功能说明：IP协议类型 取值范围：IPv4,IPv6
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['remoteGroupId'] === null) {
            ...
            if (!is_null($this->container['remoteAddressGroupId']) && (mb_strlen($this->container['remoteAddressGroupId']) > 255)) {
                $invalidProperties[] = "invalid value for 'remoteAddressGroupId', the character length must be smaller than or equal to 255.";
            }
