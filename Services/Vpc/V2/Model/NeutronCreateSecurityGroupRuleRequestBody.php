...
class NeutronCreateSecurityGroupRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronCreateSecurityGroupRuleRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleOption'
    ];
    ...
    *  securityGroupRule
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleOption $securityGroupRule securityGroupRule
    *
    * @return $this
    */
