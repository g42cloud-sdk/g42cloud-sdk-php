...
class ExtraDhcpOpt implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['optName']) && (mb_strlen($this->container['optName']) > 255)) {
                $invalidProperties[] = "invalid value for 'optName', the character length must be smaller than or equal to 255.";
            }
            if (!is_null($this->container['optName']) && (mb_strlen($this->container['optName']) < 0)) {
                $invalidProperties[] = "invalid value for 'optName', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['optValue']) && (mb_strlen($this->container['optValue']) > 255)) {
                $invalidProperties[] = "invalid value for 'optValue', the character length must be smaller than or equal to 255.";
            }
            if (!is_null($this->container['optValue']) && (mb_strlen($this->container['optValue']) < 0)) {
                $invalidProperties[] = "invalid value for 'optValue', the character length must be bigger than or equal to 0.";
            }
