...
class CreateSecurityGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroup' => '\G42Cloud\SDK\Vpc\V2\Model\CreateSecurityGroupOption'
    ];
    ...
    *  securityGroup
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\CreateSecurityGroupOption
    */
    ...
    * Sets securityGroup
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\CreateSecurityGroupOption $securityGroup securityGroup
    *
    * @return $this
    */
