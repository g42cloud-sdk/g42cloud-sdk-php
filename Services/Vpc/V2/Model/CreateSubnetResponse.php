...
class CreateSubnetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubnetResponse';
    ...
    */
    protected static $openAPITypes = [
            'subnet' => '\G42Cloud\SDK\Vpc\V2\Model\Subnet'
    ];
    ...
    * Sets subnet
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\Subnet|null $subnet subnet
    *
    * @return $this
    */
