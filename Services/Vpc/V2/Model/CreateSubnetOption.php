...
class CreateSubnetOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'extraDhcpOpts' => '\G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOption[]'
    ];
    ...
    *  子网配置的NTP地址
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOption[]|null
    */
    ...
    * Sets extraDhcpOpts
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOption[]|null $extraDhcpOpts 子网配置的NTP地址
    *
    * @return $this
    */
