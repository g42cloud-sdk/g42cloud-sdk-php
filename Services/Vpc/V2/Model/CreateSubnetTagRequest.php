...
class CreateSubnetTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubnetTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'subnetId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\CreateSubnetTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\CreateSubnetTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\CreateSubnetTagRequestBody|null $body body
    *
    * @return $this
    */
