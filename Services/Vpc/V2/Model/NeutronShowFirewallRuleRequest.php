...
class NeutronShowFirewallRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronShowFirewallRuleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * firewallRuleId  网络ACL规则ID
    *
    * @var string[]
    */
