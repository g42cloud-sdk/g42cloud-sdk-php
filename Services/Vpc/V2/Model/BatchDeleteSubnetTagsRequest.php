...
class BatchDeleteSubnetTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSubnetTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'subnetId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\BatchDeleteSubnetTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\BatchDeleteSubnetTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\BatchDeleteSubnetTagsRequestBody|null $body body
    *
    * @return $this
    */
