...
class CreateRouteTableReq implements ModelInterface, ArrayAccess
{
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\RouteTableRoute[]|null
    */
    ...
    * Sets routes
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\RouteTableRoute[]|null $routes 功能说明：路由对象，参见route字段说明  约束：每个路由表最大关联200条路由
    *
    * @return $this
    */
