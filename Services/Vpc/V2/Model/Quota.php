...
class Quota implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\G42Cloud\SDK\Vpc\V2\Model\ResourceResult[]'
    ];
    ...
    *  资源列表对象
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\ResourceResult[]
    */
    ...
    * Sets resources
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\ResourceResult[] $resources 资源列表对象
    *
    * @return $this
    */
