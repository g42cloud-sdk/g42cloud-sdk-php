...
class AcceptVpcPeeringResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AcceptVpcPeeringResponse';
    ...
    *  requestVpcInfo
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\VpcInfo|null
    */
    ...
    * Sets requestVpcInfo
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\VpcInfo|null $requestVpcInfo requestVpcInfo
    *
    * @return $this
    */
    ...
    * Sets acceptVpcInfo
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\VpcInfo|null $acceptVpcInfo acceptVpcInfo
    *
    * @return $this
    */
