...
class NeutronCreateSecurityGroupRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronCreateSecurityGroupRuleRequestBody|null $body body
    *
    * @return $this
    */
