...
class NeutronUpdateFirewallRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallRuleRequestBody|null $body body
    *
    * @return $this
    */
