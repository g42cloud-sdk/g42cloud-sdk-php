...
class BatchDeleteVpcTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteVpcTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'vpcId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\BatchDeleteVpcTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\BatchDeleteVpcTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\BatchDeleteVpcTagsRequestBody|null $body body
    *
    * @return $this
    */
