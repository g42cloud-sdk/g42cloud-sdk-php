...
class ListVpcPeeringsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'peerings' => '\G42Cloud\SDK\Vpc\V2\Model\VpcPeering[]',
            'peeringsLinks' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]'
    ];
    ...
    *  peering对象列表
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\VpcPeering[]|null
    */
    ...
    * Sets peerings
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\VpcPeering[]|null $peerings peering对象列表
    *
    * @return $this
    */
    ...
    * Sets peeringsLinks
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]|null $peeringsLinks 分页信息
    *
    * @return $this
    */
