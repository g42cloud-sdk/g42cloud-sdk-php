...
class ShowSecurityGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroup' => '\G42Cloud\SDK\Vpc\V2\Model\SecurityGroup'
    ];
    ...
    *  securityGroup
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\SecurityGroup|null
    */
    ...
    * Sets securityGroup
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\SecurityGroup|null $securityGroup securityGroup
    *
    * @return $this
    */
