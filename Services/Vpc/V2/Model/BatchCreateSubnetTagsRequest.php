...
class BatchCreateSubnetTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateSubnetTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'subnetId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\BatchCreateSubnetTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\BatchCreateSubnetTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\BatchCreateSubnetTagsRequestBody|null $body body
    *
    * @return $this
    */
