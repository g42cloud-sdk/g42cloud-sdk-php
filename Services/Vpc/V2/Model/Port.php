...
class Port implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'adminStateUp' => 'bool',
            'macAddress' => 'string',
            'fixedIps' => '\G42Cloud\SDK\Vpc\V2\Model\FixedIp[]',
            'deviceId' => 'string',
            'deviceOwner' => 'string',
            'tenantId' => 'string',
            'status' => 'string',
            'securityGroups' => 'string[]',
            'allowedAddressPairs' => '\G42Cloud\SDK\Vpc\V2\Model\AllowedAddressPair[]',
            'extraDhcpOpts' => '\G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOpt[]',
            'bindingvnicType' => 'string',
            'dnsAssignment' => '\G42Cloud\SDK\Vpc\V2\Model\DnsAssignMent[]',
            'dnsName' => 'string',
            'bindingvifDetails' => '\G42Cloud\SDK\Vpc\V2\Model\BindingVifDetails',
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\FixedIp[]
    */
    ...
    * Sets fixedIps
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\FixedIp[] $fixedIps 功能说明：端口IP 例如：\"fixed_ips\": [{\"subnet_id\": \"4dc70db6-cb7f-4200-9790-a6a910776bba\", \"ip_address\": \"192.169.25.79\"}] 约束：一个端口只支持一个fixed_ip，且不支持更新。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\AllowedAddressPair[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\AllowedAddressPair[] $allowedAddressPairs 功能说明：IP/Mac对列表 约束：IP地址不允许为 “0.0.0.0” 如果配置地址池较大（CIDR掩码小于24位），建议为该port配置一个单独的安全组。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOpt[]
    */
    ...
    * Sets extraDhcpOpts
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\ExtraDhcpOpt[] $extraDhcpOpts 功能说明：DHCP的扩展Option(扩展属性)
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\DnsAssignMent[]
    */
    ...
    * Sets dnsAssignment
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\DnsAssignMent[] $dnsAssignment 功能说明：主网卡默认内网域名信息 约束：不支持设置和更新，由系统自动维护
    *
    * @return $this
    */
    ...
    *  bindingvifDetails
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\BindingVifDetails
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\BindingVifDetails $bindingvifDetails bindingvifDetails
    *
    * @return $this
    */
