...
class CreatePrivateipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrivateipRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'privateips' => '\G42Cloud\SDK\Vpc\V2\Model\CreatePrivateipOption[]'
    ];
    ...
    *  私有IP列表对象
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\CreatePrivateipOption[]
    */
    ...
    * Sets privateips
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\CreatePrivateipOption[] $privateips 私有IP列表对象
    *
    * @return $this
    */
