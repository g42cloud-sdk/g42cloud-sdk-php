...
class NeutronUpdateFirewallRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronUpdateFirewallRuleRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'firewallRule' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallRuleOption'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['firewallRule'] === null) {
            $invalidProperties[] = "'firewallRule' can't be null";
        }
    ...
    *  firewallRule
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallRuleOption
    */
    ...
    * Sets firewallRule
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallRuleOption $firewallRule firewallRule
    *
    * @return $this
    */
