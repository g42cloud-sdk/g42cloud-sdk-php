...
class VpcPeering implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VpcPeering';
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'status' => 'string',
            'requestVpcInfo' => '\G42Cloud\SDK\Vpc\V2\Model\VpcInfo',
            'acceptVpcInfo' => '\G42Cloud\SDK\Vpc\V2\Model\VpcInfo',
            'createdAt' => '\DateTime',
            'updatedAt' => '\DateTime',
            'description' => 'string'
    ];
    ...
    * Sets status
    *
    * @param string $status 功能说明：对等连接状态 取值范围： - PENDING_ACCEPTANCE：等待接受 - REJECTED：已拒绝。 - EXPIRED：已过期。 - DELETED：已删除。 - ACTIVE：活动的。
    *
    * @return $this
    */
    ...
    *  requestVpcInfo
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\VpcInfo
    */
    ...
    * Sets requestVpcInfo
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\VpcInfo $requestVpcInfo requestVpcInfo
    *
    * @return $this
    */
    ...
    * Sets acceptVpcInfo
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\VpcInfo $acceptVpcInfo acceptVpcInfo
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string $description 对等连接描述
    *
    * @return $this
    */
