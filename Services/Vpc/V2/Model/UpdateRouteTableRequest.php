...
class UpdateRouteTableRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'routetableId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\UpdateRoutetableReqBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\UpdateRoutetableReqBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\UpdateRoutetableReqBody|null $body body
    *
    * @return $this
    */
