...
class UpdatePortRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePortRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'portId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\UpdatePortRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\UpdatePortRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\UpdatePortRequestBody|null $body body
    *
    * @return $this
    */
