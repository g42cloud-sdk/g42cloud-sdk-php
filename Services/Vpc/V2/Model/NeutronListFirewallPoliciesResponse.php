...
class NeutronListFirewallPoliciesResponse implements ModelInterface, ArrayAccess
{
    ...
    * firewallPolicies  firewall_policy对象列表
    * firewallPoliciesLinks  分页信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'firewallPolicies' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronFirewallPolicy[]',
            'firewallPoliciesLinks' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]'
    ];
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronFirewallPolicy[]|null $firewallPolicies firewall_policy对象列表
    *
    * @return $this
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronPageLink[]|null $firewallPoliciesLinks 分页信息
    *
    * @return $this
    */
