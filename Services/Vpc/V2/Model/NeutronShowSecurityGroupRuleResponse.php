...
class NeutronShowSecurityGroupRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronShowSecurityGroupRuleResponse';
