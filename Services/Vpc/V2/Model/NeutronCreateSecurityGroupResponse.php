...
class NeutronCreateSecurityGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronCreateSecurityGroupResponse';
    ...
    */
    protected static $openAPITypes = [
            'securityGroup' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroup'
    ];
    ...
    * Sets securityGroup
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroup|null $securityGroup securityGroup
    *
    * @return $this
    */
