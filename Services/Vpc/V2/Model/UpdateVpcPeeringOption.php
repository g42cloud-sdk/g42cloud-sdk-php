...
class UpdateVpcPeeringOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpcPeeringOption';
    ...
    * Sets description
    *
    * @param string|null $description 功能说明：对等连接描述 取值范围：0-255个字符，支持数字、字母、中文字符
    *
    * @return $this
    */
