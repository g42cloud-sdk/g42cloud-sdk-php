...
class ListRouteTablesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRouteTablesResponse';
    ...
    */
    protected static $openAPITypes = [
            'routetables' => '\G42Cloud\SDK\Vpc\V2\Model\RouteTableListResp[]'
    ];
    ...
    *  路由表对象列表
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\RouteTableListResp[]|null
    */
    ...
    * Sets routetables
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\RouteTableListResp[]|null $routetables 路由表对象列表
    *
    * @return $this
    */
