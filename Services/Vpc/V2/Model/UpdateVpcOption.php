...
class UpdateVpcOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'description' => 'string',
            'cidr' => 'string',
            'routes' => '\G42Cloud\SDK\Vpc\V2\Model\Route[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\Route[]|null
    */
    ...
    * Sets routes
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\Route[]|null $routes 功能说明：路由信息列表，详情参见route对象
    *
    * @return $this
    */
