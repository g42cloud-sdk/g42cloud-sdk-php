...
class NeutronRemoveFirewallRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronRemoveFirewallRuleResponse';
    ...
    * Sets id
    *
    * @param string|null $id 功能说明：网络ACL策略ID
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 功能说明：网络ACL策略名称
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 功能说明：网络ACL策略的描述信息 取值范围：0-255个字符
    *
    * @return $this
    */
    ...
    * Sets firewallRules
    *
    * @param string[]|null $firewallRules 功能说明：网络ACL策略关联的规则的ID列表
    *
    * @return $this
    */
    ...
    * Sets audited
    *
    * @param bool|null $audited 功能说明：每次policy或者它相关的rule有变动，该参数将会被置为False
    *
    * @return $this
    */
    ...
    * Sets public
    *
    * @param bool|null $public 功能说明：网络ACL策略是否对其他网络ACL策略可见 取值范围：true(可见)、false(不可见)
    *
    * @return $this
    */
    ...
    * Sets tenantId
    *
    * @param string|null $tenantId 功能说明：网络ACL策略所属项目ID
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string|null $projectId 功能说明：网络ACL策略所属项目ID
    *
    * @return $this
    */
