...
class RouteTableResp implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'default' => 'bool',
            'routes' => '\G42Cloud\SDK\Vpc\V2\Model\RouteTableRoute[]',
            'subnets' => '\G42Cloud\SDK\Vpc\V2\Model\SubnetList[]',
            'tenantId' => 'string',
            'vpcId' => 'string',
            'description' => 'string'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\RouteTableRoute[]
    */
    ...
    * Sets routes
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\RouteTableRoute[] $routes 功能说明：路由对象，参见route字段说明。  约束：每个路由表最大关联200条路由
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\SubnetList[]
    */
    ...
    * Sets subnets
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\SubnetList[] $subnets 功能说明：路由表所关联的子网  约束：只能关联路由表所属VPC下的子网
    *
    * @return $this
    */
