...
class CreateSubnetRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubnetRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'subnet' => '\G42Cloud\SDK\Vpc\V2\Model\CreateSubnetOption'
    ];
    ...
    *  subnet
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\CreateSubnetOption
    */
    ...
    * Sets subnet
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\CreateSubnetOption $subnet subnet
    *
    * @return $this
    */
