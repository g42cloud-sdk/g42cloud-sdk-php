...
class NeutronSecurityGroup implements ModelInterface, ArrayAccess
{
    ...
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroupRule[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroupRule[] $securityGroupRules 安全组规则，详情参见Security Group Rule对象
    *
    * @return $this
    */
