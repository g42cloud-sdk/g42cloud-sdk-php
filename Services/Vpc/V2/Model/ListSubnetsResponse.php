...
class ListSubnetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubnetsResponse';
    ...
    */
    protected static $openAPITypes = [
            'subnets' => '\G42Cloud\SDK\Vpc\V2\Model\Subnet[]'
    ];
    ...
    *  subnet对象列表
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\Subnet[]|null
    */
    ...
    * Sets subnets
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\Subnet[]|null $subnets subnet对象列表
    *
    * @return $this
    */
