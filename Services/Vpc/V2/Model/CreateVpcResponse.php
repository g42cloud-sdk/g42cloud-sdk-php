...
class CreateVpcResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpcResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpc' => '\G42Cloud\SDK\Vpc\V2\Model\Vpc'
    ];
    ...
    * Sets vpc
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\Vpc|null $vpc vpc
    *
    * @return $this
    */
