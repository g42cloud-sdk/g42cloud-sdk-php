...
class NeutronFirewallPolicy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronFirewallPolicy';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['audited'] === null) {
            $invalidProperties[] = "'audited' can't be null";
        }
        ...
        if ($this->container['firewallRules'] === null) {
            $invalidProperties[] = "'firewallRules' can't be null";
        }
    ...
    * Sets description
    *
    * @param string $description 网络ACL防火墙策略描述。
    *
    * @return $this
    */
    ...
    * Sets firewallRules
    *
    * @param string[] $firewallRules 策略引用的网络ACL防火墙规则链。
    *
    * @return $this
    */
    ...
    * Sets id
    *
    * @param string $id 网络ACL防火墙策略uuid标识。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string $name 网络ACL防火墙策略名称。
    *
    * @return $this
    */
