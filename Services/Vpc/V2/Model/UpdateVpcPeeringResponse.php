...
class UpdateVpcPeeringResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpcPeeringResponse';
    ...
    */
    protected static $openAPITypes = [
            'peering' => '\G42Cloud\SDK\Vpc\V2\Model\VpcPeering'
    ];
    ...
    * Sets peering
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\VpcPeering|null $peering peering
    *
    * @return $this
    */
