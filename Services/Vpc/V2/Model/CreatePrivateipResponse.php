...
class CreatePrivateipResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrivateipResponse';
    ...
    */
    protected static $openAPITypes = [
            'privateips' => '\G42Cloud\SDK\Vpc\V2\Model\Privateip[]'
    ];
    ...
    *  私有IP列表对象
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\Privateip[]|null
    */
    ...
    * Sets privateips
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\Privateip[]|null $privateips 私有IP列表对象
    *
    * @return $this
    */
