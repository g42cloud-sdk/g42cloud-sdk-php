...
class NeutronUpdateFirewallRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronUpdateFirewallRuleResponse';
    ...
    */
    protected static $openAPITypes = [
            'firewallRule' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronFirewallRule'
    ];
    ...
    * Sets firewallRule
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronFirewallRule|null $firewallRule firewallRule
    *
    * @return $this
    */
