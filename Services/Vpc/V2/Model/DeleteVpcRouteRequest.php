...
class DeleteVpcRouteRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteVpcRouteRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['routeId'] === null) {
            ...
            if (!preg_match("/[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}/", $this->container['routeId'])) {
                $invalidProperties[] = "invalid value for 'routeId', must be conform to the pattern /[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}/.";
            }
