...
class NeutronCreateSecurityGroupRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NeutronCreateSecurityGroupRuleResponse';
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroupRule'
    ];
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronSecurityGroupRule|null $securityGroupRule securityGroupRule
    *
    * @return $this
    */
