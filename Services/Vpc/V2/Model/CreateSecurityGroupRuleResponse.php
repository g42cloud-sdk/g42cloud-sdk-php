...
class CreateSecurityGroupRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroupRule' => '\G42Cloud\SDK\Vpc\V2\Model\SecurityGroupRule'
    ];
    ...
    *  securityGroupRule
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\SecurityGroupRule|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\SecurityGroupRule|null $securityGroupRule securityGroupRule
    *
    * @return $this
    */
