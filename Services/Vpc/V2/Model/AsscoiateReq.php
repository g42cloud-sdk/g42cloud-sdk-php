...
class AsscoiateReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AsscoiateReq';
    ...
    */
    protected static $openAPITypes = [
            'subnets' => '\G42Cloud\SDK\Vpc\V2\Model\AssociateRouteTableAndSubnetReq'
    ];
    ...
    *  subnets
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\AssociateRouteTableAndSubnetReq
    */
    ...
    * Sets subnets
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\AssociateRouteTableAndSubnetReq $subnets subnets
    *
    * @return $this
    */
