...
class DisassociateRouteTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateRouteTableRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'routetableId' => 'string',
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\RoutetableAssociateReqbody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\RoutetableAssociateReqbody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\RoutetableAssociateReqbody|null $body body
    *
    * @return $this
    */
