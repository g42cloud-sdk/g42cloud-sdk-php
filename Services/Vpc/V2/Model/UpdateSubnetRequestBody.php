...
class UpdateSubnetRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSubnetRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'subnet' => '\G42Cloud\SDK\Vpc\V2\Model\UpdateSubnetOption'
    ];
    ...
    *  subnet
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\UpdateSubnetOption
    */
    ...
    * Sets subnet
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\UpdateSubnetOption $subnet subnet
    *
    * @return $this
    */
