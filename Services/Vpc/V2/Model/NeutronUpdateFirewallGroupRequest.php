...
class NeutronUpdateFirewallGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Vpc\V2\Model\NeutronUpdateFirewallGroupRequestBody|null $body body
    *
    * @return $this
    */
