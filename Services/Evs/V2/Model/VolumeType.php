...
class VolumeType implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'name' => 'string',
            'extraSpecs' => '\G42Cloud\SDK\Evs\V2\Model\VolumeTypeExtraSpecs',
            'description' => 'string',
            'qosSpecsId' => 'string',
            'isPublic' => 'bool'
    ];
    ...
    *  extraSpecs
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\VolumeTypeExtraSpecs|null
    */
    ...
    * Sets extraSpecs
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\VolumeTypeExtraSpecs|null $extraSpecs extraSpecs
    *
    * @return $this
    */
