...
class JobEntities implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'volumeId' => 'string',
            'name' => 'string',
            'subJobs' => '\G42Cloud\SDK\Evs\V2\Model\SubJob[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\SubJob[]|null
    */
    ...
    * Sets subJobs
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\SubJob[]|null $subJobs 子Job的信息。当存在子Job信息时，entities中的其他字段将不会返回。
    *
    * @return $this
    */
