...
class BatchCreateVolumeTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateVolumeTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'volumeId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\BatchCreateVolumeTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\BatchCreateVolumeTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\BatchCreateVolumeTagsRequestBody|null $body body
    *
    * @return $this
    */
