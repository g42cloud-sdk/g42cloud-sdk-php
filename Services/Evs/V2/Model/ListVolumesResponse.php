...
class ListVolumesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'volumesLinks' => '\G42Cloud\SDK\Evs\V2\Model\Link[]',
            'volumes' => '\G42Cloud\SDK\Evs\V2\Model\VolumeDetail[]'
    ];
    ...
    * Sets volumesLinks
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Link[]|null $volumesLinks 云硬盘列表查询位置标记。如果本次查询只返回部分列表信息时，会返回查询到的当前磁盘mark标记的url，可以继续使用这个url查询剩余列表信息。
    *
    * @return $this
    */
    ...
    * Sets volumes
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\VolumeDetail[]|null $volumes 查询请求返回的云硬盘列表。
    *
    * @return $this
    */
