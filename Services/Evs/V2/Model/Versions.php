...
class Versions implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'mediaTypes' => '\G42Cloud\SDK\Evs\V2\Model\MediaTypes[]',
            'minVersion' => 'string',
            'status' => 'string',
            'updated' => 'string',
            'version' => 'string'
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Link[] $links 接口版本信息的URI描述信息
    *
    * @return $this
    */
    ...
    *  接口版本的请求消息类型信息
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\MediaTypes[]
    */
    ...
    * Sets mediaTypes
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\MediaTypes[] $mediaTypes 接口版本的请求消息类型信息
    *
    * @return $this
    */
