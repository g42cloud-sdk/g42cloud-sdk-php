...
class Resource implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'resourceName' => 'string',
            'resourceDetail' => '\G42Cloud\SDK\Evs\V2\Model\VolumeDetailForTag',
    ...
    *  resourceDetail
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\VolumeDetailForTag
    */
    ...
    * Sets resourceDetail
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\VolumeDetailForTag $resourceDetail resourceDetail
    *
    * @return $this
    */
    ...
    * Sets tags
    *
    * @param map[string,string][] $tags 标签列表。
    *
    * @return $this
    */
