...
class BatchDeleteVolumeTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteVolumeTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'volumeId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\BatchDeleteVolumeTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\BatchDeleteVolumeTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\BatchDeleteVolumeTagsRequestBody|null $body body
    *
    * @return $this
    */
