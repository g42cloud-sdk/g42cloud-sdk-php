...
class CinderAcceptVolumeTransferOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CinderAcceptVolumeTransferOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * authKey  云硬盘过户的身份认证密钥。  创建云硬盘过户时会返回该身份认证密钥。
    *
    * @var string[]
    */
    ...
    * Sets authKey
    *
    * @param string $authKey 云硬盘过户的身份认证密钥。  创建云硬盘过户时会返回该身份认证密钥。
    *
    * @return $this
    */
