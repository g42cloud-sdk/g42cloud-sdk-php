...
class VolumeTransferSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VolumeTransferSummary';
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Link[] $links 云硬盘过户记录的链接
    *
    * @return $this
    */
