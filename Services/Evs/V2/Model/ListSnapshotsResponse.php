...
class ListSnapshotsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'snapshots' => '\G42Cloud\SDK\Evs\V2\Model\SnapshotList[]',
            'snapshotsLinks' => '\G42Cloud\SDK\Evs\V2\Model\Link[]'
    ];
    ...
    *  快照信息。
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\SnapshotList[]|null
    */
    ...
    * Sets snapshots
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\SnapshotList[]|null $snapshots 快照信息。
    *
    * @return $this
    */
    ...
    * Sets snapshotsLinks
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Link[]|null $snapshotsLinks 云硬盘快照列表查询位置标记。当查询时指定limit时会返回该字段，返回该字段表示本次查询只查出了部分云硬盘快照信息。
    *
    * @return $this
    */
