...
class ResizeVolumeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResizeVolumeRequest';
    ...
    */
    protected static $openAPITypes = [
            'volumeId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\ResizeVolumeRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\ResizeVolumeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\ResizeVolumeRequestBody|null $body body
    *
    * @return $this
    */
