...
class CinderAcceptVolumeTransferRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'transferId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\CinderAcceptVolumeTransferRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\CinderAcceptVolumeTransferRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\CinderAcceptVolumeTransferRequestBody|null $body body
    *
    * @return $this
    */
