...
class CinderListAvailabilityZonesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'availabilityZoneInfo' => '\G42Cloud\SDK\Evs\V2\Model\AzInfo[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\AzInfo[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\AzInfo[]|null $availabilityZoneInfo 查询请求返回的可用分区列表，请参见• [availabilityZoneInfo参数说明](https://support.huaweicloud.com/api-evs/evs_04_2081.html#evs_04_2081__li19751007201910)。
    *
    * @return $this
    */
