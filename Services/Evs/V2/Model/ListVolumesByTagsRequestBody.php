...
class ListVolumesByTagsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'action' => 'string',
            'limit' => 'int',
            'matches' => '\G42Cloud\SDK\Evs\V2\Model\Match[]',
            'offset' => 'int',
            'tags' => '\G42Cloud\SDK\Evs\V2\Model\TagsForListVolumes[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\Match[]|null
    */
    ...
    * Sets matches
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Match[]|null $matches 资源本身支持的查询条件。标签列表中的标签key值不允许重复。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\TagsForListVolumes[]
    */
    ...
    * Sets tags
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\TagsForListVolumes[] $tags 标签的键值对。标签列表中最多包含10个key 。标签列表中的标签key值不允许重复。标签列表中多个key之间是“与”的关系，云硬盘必须满足请求中所有key才会匹配出来。
    *
    * @return $this
    */
