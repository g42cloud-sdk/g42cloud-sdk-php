...
class CreateVolumeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * bssParam  bssParam
    * volume  volume
    * serverId  创建云硬盘并挂载到目标虚拟机。 创建的云硬盘的计费模式会与虚拟机的计费模式保持一致。 目前只支持ECS服务的虚拟机，暂不支持BMS的裸金属服务器。
    * osSchHnTschedulerHints  osSchHnTschedulerHints
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'bssParam' => '\G42Cloud\SDK\Evs\V2\Model\BssParamForCreateVolume',
            'volume' => '\G42Cloud\SDK\Evs\V2\Model\CreateVolumeOption',
            'serverId' => 'string',
            'osSchHnTschedulerHints' => '\G42Cloud\SDK\Evs\V2\Model\CreateVolumeSchedulerHints'
    ];
    ...
    *  bssParam
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\BssParamForCreateVolume|null
    */
    ...
    * Sets bssParam
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\BssParamForCreateVolume|null $bssParam bssParam
    *
    * @return $this
    */
    ...
    *  volume
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\CreateVolumeOption
    */
    ...
    * Sets volume
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\CreateVolumeOption $volume volume
    *
    * @return $this
    */
    ...
    * Sets serverId
    *
    * @param string|null $serverId 创建云硬盘并挂载到目标虚拟机。 创建的云硬盘的计费模式会与虚拟机的计费模式保持一致。 目前只支持ECS服务的虚拟机，暂不支持BMS的裸金属服务器。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\CreateVolumeSchedulerHints|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\CreateVolumeSchedulerHints|null $osSchHnTschedulerHints osSchHnTschedulerHints
    *
    * @return $this
    */
