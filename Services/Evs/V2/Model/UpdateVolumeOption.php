...
class UpdateVolumeOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVolumeOption';
    ...
    * Sets description
    *
    * @param string|null $description 新的云硬盘的描述，name和description不能同时为null。最大支持255个字节。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 新的云硬盘的名字，name和description不能同时为null。最大支持255个字节。
    *
    * @return $this
    */
