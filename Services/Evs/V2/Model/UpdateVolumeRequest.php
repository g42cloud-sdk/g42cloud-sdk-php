...
class UpdateVolumeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVolumeRequest';
    ...
    */
    protected static $openAPITypes = [
            'volumeId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\UpdateVolumeRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\UpdateVolumeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\UpdateVolumeRequestBody|null $body body
    *
    * @return $this
    */
