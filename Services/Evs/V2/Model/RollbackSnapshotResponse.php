...
class RollbackSnapshotResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RollbackSnapshotResponse';
    ...
    */
    protected static $openAPITypes = [
            'rollback' => '\G42Cloud\SDK\Evs\V2\Model\RollbackInfo'
    ];
    ...
    *  rollback
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\RollbackInfo|null
    */
    ...
    * Sets rollback
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\RollbackInfo|null $rollback rollback
    *
    * @return $this
    */
