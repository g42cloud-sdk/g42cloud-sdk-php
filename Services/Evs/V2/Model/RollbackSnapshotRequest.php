...
class RollbackSnapshotRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RollbackSnapshotRequest';
    ...
    */
    protected static $openAPITypes = [
            'snapshotId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\RollbackSnapshotRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\RollbackSnapshotRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\RollbackSnapshotRequestBody|null $body body
    *
    * @return $this
    */
