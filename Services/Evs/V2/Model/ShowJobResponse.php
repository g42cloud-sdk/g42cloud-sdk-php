...
class ShowJobResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'entities' => '\G42Cloud\SDK\Evs\V2\Model\JobEntities',
            'jobId' => 'string',
            'jobType' => 'string',
            'beginTime' => 'string',
            'endTime' => 'string',
    ...
    *  entities
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\JobEntities|null
    */
    ...
    * Sets entities
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\JobEntities|null $entities entities
    *
    * @return $this
    */
    ...
    * Sets jobType
    *
    * @param string|null $jobType job的类型。createVolume：创建单个云硬盘。batchCreateVolume：批量创建云硬盘。deleteVolume：删除单个云硬盘。extendVolume：扩容云硬盘。bulkDeleteVolume：批量删除云硬盘。deleteSingleVolume：批量删除时逐个删除单个云硬盘。retypeVolume：对云硬盘做硬盘类型变更。
    *
    * @return $this
    */
