...
class UpdateSnapshotRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSnapshotRequest';
    ...
    */
    protected static $openAPITypes = [
            'snapshotId' => 'string',
            'body' => '\G42Cloud\SDK\Evs\V2\Model\UpdateSnapshotRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\UpdateSnapshotRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\UpdateSnapshotRequestBody|null $body body
    *
    * @return $this
    */
