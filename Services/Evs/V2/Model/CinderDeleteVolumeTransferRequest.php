...
class CinderDeleteVolumeTransferRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CinderDeleteVolumeTransferRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * transferId  云硬盘过户记录ID
    *
    * @var string[]
    */
