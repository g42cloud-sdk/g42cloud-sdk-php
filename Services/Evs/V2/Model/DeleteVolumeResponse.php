...
class DeleteVolumeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteVolumeResponse';
    ...
    * Sets jobId
    *
    * @param string|null $jobId 正常返回时返回的任务ID。
    *
    * @return $this
    */
