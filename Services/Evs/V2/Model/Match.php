...
class Match implements ModelInterface, ArrayAccess
{
    ...
    * key  键。取值范围如下： resource_name：资源名称。 service_type：服务类型。
    * value  值。最大长度255个字符。 key为“resource_name”时，value为模糊匹配。
    *
    * @var string[]
    */
    ...
    */
    ...
    const KEY_RESOURCE_NAME = 'resource_name';
    const KEY_SERVICE_TYPE = 'service_type';
    ...
    * Sets key
    *
    * @param string $key 键。取值范围如下： resource_name：资源名称。 service_type：服务类型。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 值。最大长度255个字符。 key为“resource_name”时，value为模糊匹配。
    *
    * @return $this
    */
