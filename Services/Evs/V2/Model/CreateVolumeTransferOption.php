...
class CreateVolumeTransferOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVolumeTransferOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  云硬盘过户记录的名称。最大支持255个字节。
    * volumeId  云硬盘ID。  通过[查询所有云硬盘详情](https://support.huaweicloud.com/api-evs/evs_04_3033.html)获取。
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string $name 云硬盘过户记录的名称。最大支持255个字节。
    *
    * @return $this
    */
    ...
    * Sets volumeId
    *
    * @param string $volumeId 云硬盘ID。  通过[查询所有云硬盘详情](https://support.huaweicloud.com/api-evs/evs_04_3033.html)获取。
    *
    * @return $this
    */
