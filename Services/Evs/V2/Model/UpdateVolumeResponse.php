...
class UpdateVolumeResponse implements ModelInterface, ArrayAccess
{
    ...
    *  是否挂载信息。
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\Attachment[]|null
    */
    ...
    * Sets attachments
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Attachment[]|null $attachments 是否挂载信息。
    *
    * @return $this
    */
    ...
    *  云硬盘uri自描述信息
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\Link[]|null
    */
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\Link[]|null $links 云硬盘uri自描述信息
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\VolumeMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\VolumeMetadata|null $metadata metadata
    *
    * @return $this
    */
