...
class SubJob implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'entities' => '\G42Cloud\SDK\Evs\V2\Model\SubJobEntities',
            'jobId' => 'string',
            'jobType' => 'string',
            'beginTime' => 'string',
            'endTime' => 'string',
    ...
    *  entities
    *
    * @return \G42Cloud\SDK\Evs\V2\Model\SubJobEntities
    */
    ...
    * Sets entities
    *
    * @param \G42Cloud\SDK\Evs\V2\Model\SubJobEntities $entities entities
    *
    * @return $this
    */
