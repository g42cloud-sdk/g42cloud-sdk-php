...
class CreateImageRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dataImages' => '\G42Cloud\SDK\Ims\V2\Model\CreateDataImage[]',
            'description' => 'string',
            'enterpriseProjectId' => 'string',
            'imageTags' => '\G42Cloud\SDK\Ims\V2\Model\TagKeyValue[]',
            'instanceId' => 'string',
            'name' => 'string',
            'tags' => 'string[]',
            'maxRam' => 'int',
    ...
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\CreateDataImage[]|null
    */
    ...
    * Sets dataImages
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\CreateDataImage[]|null $dataImages 需要转换的数据盘信息，其中，当使用云服务器上的数据盘进行私有数据盘镜像创建时，该字段必选。 如果不是用于制作数据盘镜像，该字段默认为空。
    *
    * @return $this
    */
    ...
    * Sets imageTags
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\TagKeyValue[]|null $imageTags 新规范的镜像标签列表。默认为空。tags和image_tags只能使用一个。
    *
    * @return $this
    */
