...
class ShowJobProgressResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'failReason' => 'string',
            'entities' => '\G42Cloud\SDK\Ims\V2\Model\JobProgressEntities'
    ];
    ...
    * Sets beginTime
    *
    * @param string|null $beginTime 任务开始执行时间。格式为UTC时间。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime 任务结束时间。格式为UTC时间。
    *
    * @return $this
    */
    ...
    *  entities
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\JobProgressEntities|null
    */
    ...
    * Sets entities
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\JobProgressEntities|null $entities entities
    *
    * @return $this
    */
