...
class CreateDataImageRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'imageTags' => '\G42Cloud\SDK\Ims\V2\Model\ImageTag[]',
            'imageUrl' => 'string',
            'minDisk' => 'int',
            'name' => 'string',
            'osType' => 'string',
    ...
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\ImageTag[]|null
    */
    ...
    * Sets imageTags
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\ImageTag[]|null $imageTags 新规范的镜像标签列表。默认为空。 tags和image_tags只能使用一个。
    *
    * @return $this
    */
