...
class ShowImageByTagsResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowImageByTagsResource';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'resourceDetail' => '\G42Cloud\SDK\Ims\V2\Model\QueryImageByTagsResourceDetail',
            'tags' => '\G42Cloud\SDK\Ims\V2\Model\TagKeyValue[]',
            'resourceName' => 'string'
    ];
    ...
    *  resourceDetail
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\QueryImageByTagsResourceDetail
    */
    ...
    * Sets resourceDetail
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\QueryImageByTagsResourceDetail $resourceDetail resourceDetail
    *
    * @return $this
    */
    ...
    * Sets tags
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\TagKeyValue[] $tags 镜像的标签列表
    *
    * @return $this
    */
    ...
    * Sets resourceName
    *
    * @param string $resourceName 镜像名称
    *
    * @return $this
    */
