...
class ImageTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageTag';
    ...
    * Sets value
    *
    * @param string|null $value 标签value值
    *
    * @return $this
    */
