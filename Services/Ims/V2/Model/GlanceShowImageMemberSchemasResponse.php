...
class GlanceShowImageMemberSchemasResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GlanceShowImageMemberSchemasResponse';
    ...
    * Sets properties
    *
    * @param object|null $properties 镜像成员属性说明，主要是对基础属性的说明，包含每个属性的取值类型、用途等。
    *
    * @return $this
    */
