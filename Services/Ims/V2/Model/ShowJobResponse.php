...
class ShowJobResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'failReason' => 'string',
            'entities' => '\G42Cloud\SDK\Ims\V2\Model\JobEntities'
    ];
    ...
    *  entities
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\JobEntities|null
    */
    ...
    * Sets entities
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\JobEntities|null $entities entities
    *
    * @return $this
    */
