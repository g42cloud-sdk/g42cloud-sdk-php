...
class AddOrUpdateTagsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddOrUpdateTagsRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'imageId' => 'string',
            'tag' => 'string',
            'imageTag' => '\G42Cloud\SDK\Ims\V2\Model\ResourceTag'
    ];
    ...
    * Sets tag
    *
    * @param string|null $tag 标签数据。 tag和image_tag只能使用一个。
    *
    * @return $this
    */
    ...
    * Sets imageTag
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\ResourceTag|null $imageTag imageTag
    *
    * @return $this
    */
