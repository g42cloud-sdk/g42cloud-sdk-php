...
class ShowImageQuotaResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowImageQuotaResponse';
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\G42Cloud\SDK\Ims\V2\Model\Quota'
    ];
    ...
    *  quotas
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\Quota|null
    */
    ...
    * Sets quotas
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\Quota|null $quotas quotas
    *
    * @return $this
    */
