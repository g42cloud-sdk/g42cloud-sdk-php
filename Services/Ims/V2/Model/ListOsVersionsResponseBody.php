...
class ListOsVersionsResponseBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'platform' => 'string',
            'versionList' => '\G42Cloud\SDK\Ims\V2\Model\OsVersionInfo[]'
    ];
    ...
    *  操作系统的详情值
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\OsVersionInfo[]
    */
    ...
    * Sets versionList
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\OsVersionInfo[] $versionList 操作系统的详情值
    *
    * @return $this
    */
