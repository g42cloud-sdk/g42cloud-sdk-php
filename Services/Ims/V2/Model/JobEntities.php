...
class JobEntities implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'results' => '\G42Cloud\SDK\Ims\V2\Model\JobEntitiesResult[]'
    ];
    ...
    *  批量任务执行结果
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\JobEntitiesResult[]|null
    */
    ...
    * Sets results
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\JobEntitiesResult[]|null $results 批量任务执行结果
    *
    * @return $this
    */
