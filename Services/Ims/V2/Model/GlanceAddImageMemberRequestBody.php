...
class GlanceAddImageMemberRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GlanceAddImageMemberRequestBody';
    ...
    * Sets member
    *
    * @param string $member 镜像成员。取值为目标用户的项目ID。
    *
    * @return $this
    */
