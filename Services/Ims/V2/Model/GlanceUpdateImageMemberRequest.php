...
class GlanceUpdateImageMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GlanceUpdateImageMemberRequest';
    ...
    */
    protected static $openAPITypes = [
            'imageId' => 'string',
            'memberId' => 'string',
            'body' => '\G42Cloud\SDK\Ims\V2\Model\GlanceUpdateImageMemberRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\GlanceUpdateImageMemberRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\GlanceUpdateImageMemberRequestBody|null $body body
    *
    * @return $this
    */
