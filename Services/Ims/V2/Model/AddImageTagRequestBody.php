...
class AddImageTagRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddImageTagRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'tag' => '\G42Cloud\SDK\Ims\V2\Model\ResourceTag'
    ];
    ...
    * Sets tag
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\ResourceTag $tag tag
    *
    * @return $this
    */
