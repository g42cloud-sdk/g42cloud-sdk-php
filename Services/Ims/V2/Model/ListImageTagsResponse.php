...
class ListImageTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageTagsResponse';
    ...
    * Sets tags
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\ResourceTag[]|null $tags 标签列表
    *
    * @return $this
    */
