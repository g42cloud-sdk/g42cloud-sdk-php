...
class GlanceListImagesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'first' => 'string',
            'images' => '\G42Cloud\SDK\Ims\V2\Model\GlanceShowImageResponseBody[]',
            'schema' => 'string',
            'next' => 'string'
    ];
    ...
    *  资源类型。
    *
    * @return \G42Cloud\SDK\Ims\V2\Model\GlanceShowImageResponseBody[]|null
    */
    ...
    * Sets images
    *
    * @param \G42Cloud\SDK\Ims\V2\Model\GlanceShowImageResponseBody[]|null $images 资源类型。
    *
    * @return $this
    */
