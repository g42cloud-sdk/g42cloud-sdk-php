...
class ServerDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'addresses' => 'map[string,\G42Cloud\SDK\Ecs\V2\Model\ServerAddress[]]',
            'keyName' => 'string',
            'image' => '\G42Cloud\SDK\Ecs\V2\Model\ServerImage',
            'osExtStStaskState' => 'string',
            'osExtStSvmState' => 'string',
            'osExtSrvAttRinstanceName' => 'string',
            'osExtSrvAttRhypervisorHostname' => 'string',
            'flavor' => '\G42Cloud\SDK\Ecs\V2\Model\ServerFlavor',
            'id' => 'string',
            'securityGroups' => '\G42Cloud\SDK\Ecs\V2\Model\ServerSecurityGroup[]',
            ...
            'accessIPv4' => 'string',
            'accessIPv6' => 'string',
            'fault' => '\G42Cloud\SDK\Ecs\V2\Model\ServerFault',
            'progress' => 'int',
            ...
            'osExtendedVolumesvolumesAttached' => '\G42Cloud\SDK\Ecs\V2\Model\ServerExtendVolumeAttachment[]',
            'description' => 'string',
            'hostStatus' => 'string',
            ...
            'locked' => 'bool',
            'tags' => 'string[]',
            'osschedulerHints' => '\G42Cloud\SDK\Ecs\V2\Model\ServerSchedulerHints',
            'enterpriseProjectId' => 'string',
            'sysTags' => '\G42Cloud\SDK\Ecs\V2\Model\ServerSystemTag[]',
            'cpuOptions' => '\G42Cloud\SDK\Ecs\V2\Model\CpuOptions',
            'hypervisor' => '\G42Cloud\SDK\Ecs\V2\Model\Hypervisor'
    ];
    ...
    *  弹性云服务器的网络属性。
    *
    * @return map[string,\G42Cloud\SDK\Ecs\V2\Model\ServerAddress[]]
    */
    ...
    * Sets addresses
    *
    * @param map[string,\G42Cloud\SDK\Ecs\V2\Model\ServerAddress[]] $addresses 弹性云服务器的网络属性。
    *
    * @return $this
    */
    ...
    *  image
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerImage
    */
    ...
    * Sets image
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerImage $image image
    *
    * @return $this
    */
    ...
    *  flavor
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerFlavor
    */
    ...
    * Sets flavor
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerFlavor $flavor flavor
    *
    * @return $this
    */
    ...
    *  弹性云服务器所属安全组列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerSecurityGroup[]
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerSecurityGroup[] $securityGroups 弹性云服务器所属安全组列表。
    *
    * @return $this
    */
    ...
    *  fault
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerFault|null
    */
    ...
    * Sets fault
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerFault|null $fault fault
    *
    * @return $this
    */
    ...
    *  挂载到弹性云服务器上的磁盘。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerExtendVolumeAttachment[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerExtendVolumeAttachment[] $osExtendedVolumesvolumesAttached 挂载到弹性云服务器上的磁盘。
    *
    * @return $this
    */
    ...
    *  osschedulerHints
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerSchedulerHints|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerSchedulerHints|null $osschedulerHints osschedulerHints
    *
    * @return $this
    */
    ...
    *  弹性云服务器系统标签。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerSystemTag[]|null
    */
    ...
    * Sets sysTags
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerSystemTag[]|null $sysTags 弹性云服务器系统标签。
    *
    * @return $this
    */
    ...
    *  cpuOptions
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\CpuOptions|null
    */
    ...
    * Sets cpuOptions
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\CpuOptions|null $cpuOptions cpuOptions
    *
    * @return $this
    */
    ...
    *  hypervisor
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\Hypervisor|null
    */
    ...
    * Sets hypervisor
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\Hypervisor|null $hypervisor hypervisor
    *
    * @return $this
    */
