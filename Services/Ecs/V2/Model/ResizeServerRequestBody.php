...
class ResizeServerRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resize' => '\G42Cloud\SDK\Ecs\V2\Model\ResizePrePaidServerOption',
            'dryRun' => 'bool'
    ];
    ...
    *  resize
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ResizePrePaidServerOption
    */
    ...
    * Sets resize
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ResizePrePaidServerOption $resize resize
    *
    * @return $this
    */
