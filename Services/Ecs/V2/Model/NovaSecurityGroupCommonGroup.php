...
class NovaSecurityGroupCommonGroup implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaSecurityGroupCommonGroup';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  对端安全组的名称
    * tenantId  对端安全组所属租户的租户ID
    *
    * @var string[]
    */
