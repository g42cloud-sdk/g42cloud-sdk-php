...
class UpdateServerRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\G42Cloud\SDK\Ecs\V2\Model\UpdateServerRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\UpdateServerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\UpdateServerRequestBody|null $body body
    *
    * @return $this
    */
