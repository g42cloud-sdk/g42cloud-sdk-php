...
class ListServerBlockDevicesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'attachableQuantity' => '\G42Cloud\SDK\Ecs\V2\Model\BlockDeviceAttachableQuantity',
            'volumeAttachments' => '\G42Cloud\SDK\Ecs\V2\Model\ServerBlockDevice[]'
    ];
    ...
    *  attachableQuantity
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\BlockDeviceAttachableQuantity|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\BlockDeviceAttachableQuantity|null $attachableQuantity attachableQuantity
    *
    * @return $this
    */
    ...
    *  云服务器挂载信息列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerBlockDevice[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerBlockDevice[]|null $volumeAttachments 云服务器挂载信息列表。
    *
    * @return $this
    */
