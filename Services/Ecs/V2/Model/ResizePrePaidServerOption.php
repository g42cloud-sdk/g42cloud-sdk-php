...
class ResizePrePaidServerOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\ResizeServerExtendParam',
            'mode' => 'string'
    ];
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ResizeServerExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ResizeServerExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
