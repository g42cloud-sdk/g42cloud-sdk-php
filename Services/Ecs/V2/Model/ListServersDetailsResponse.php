...
class ListServersDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'servers' => '\G42Cloud\SDK\Ecs\V2\Model\ServerDetail[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerDetail[]|null
    */
    ...
    * Sets servers
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerDetail[]|null $servers 弹性云服务器详情列表，具体参照-查询云服务器详情接口。查询级别不同，返回的详情不同。
    *
    * @return $this
    */
