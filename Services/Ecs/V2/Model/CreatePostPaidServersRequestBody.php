...
class CreatePostPaidServersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'server' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServer'
    ];
    ...
    *  server
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServer
    */
    ...
    * Sets server
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServer $server server
    *
    * @return $this
    */
