...
class NovaServerInterfaceDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'fixedIps' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerInterfaceFixedIp[]',
            'macAddr' => 'string',
            'netId' => 'string',
            'portId' => 'string',
            'portState' => 'string'
    ...
    *  网卡私网IP信息列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerInterfaceFixedIp[]
    */
    ...
    * Sets fixedIps
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerInterfaceFixedIp[] $fixedIps 网卡私网IP信息列表。
    *
    * @return $this
    */
