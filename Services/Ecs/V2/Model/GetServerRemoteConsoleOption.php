...
class GetServerRemoteConsoleOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetServerRemoteConsoleOption';
    ...
    * Sets protocol
    *
    * @param string $protocol 远程登录协议，请将protocol配置为“vnc”。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string $type 远程登录的类型，请将type配置为“novnc”。
    *
    * @return $this
    */
