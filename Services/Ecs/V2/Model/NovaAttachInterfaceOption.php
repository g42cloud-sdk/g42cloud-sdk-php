...
class NovaAttachInterfaceOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'fixedIps' => '\G42Cloud\SDK\Ecs\V2\Model\NovaAttachInterfaceFixedIp[]',
            'netId' => 'string',
            'portId' => 'string'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaAttachInterfaceFixedIp[]|null
    */
    ...
    * Sets fixedIps
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaAttachInterfaceFixedIp[]|null $fixedIps 私有IP。  有port_id时，该参数不起作用，并且有该参数时，必须有net_id。  只有列表中第一个元素有效。传入两个及以上元素会报错。
    *
    * @return $this
    */
