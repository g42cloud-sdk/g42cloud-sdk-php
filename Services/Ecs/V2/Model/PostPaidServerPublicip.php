...
class PostPaidServerPublicip implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'eip' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEip',
    ...
    *  eip
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEip|null
    */
    ...
    * Sets eip
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEip|null $eip eip
    *
    * @return $this
    */
