...
class PostPaidServer implements ModelInterface, ArrayAccess
{
    ...
    * flavorRef  待创建云服务器的系统规格的ID。  可通过 [规格列表接口] 查询，该接口支持通过 availability_zone 参数过滤出待创建云服务器可用区下可用的规格。  已上线的各规格详情介绍请参见《[弹性云服务器产品介绍](https://support.huaweicloud.com/ecs/index.html)》的“实例类型与规格”章节。
    ...
    */
    protected static $openAPITypes = [
            ...
            'count' => 'int',
            'dataVolumes' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolume[]',
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerExtendParam',
            'flavorRef' => 'string',
            'imageRef' => 'string',
            'isAutoRename' => 'bool',
            'keyName' => 'string',
            ...
            'name' => 'string',
            'nics' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerNic[]',
            'osschedulerHints' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerSchedulerHints',
            'publicip' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerPublicip',
            'rootVolume' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerRootVolume',
            'securityGroups' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerSecurityGroup[]',
            'serverTags' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerTag[]',
            'tags' => 'string[]',
            'userData' => 'string',
            'vpcid' => 'string',
            'description' => 'string'
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolume[]|null
    */
    ...
    * Sets dataVolumes
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolume[]|null $dataVolumes 云服务器对应数据盘相关配置。每一个数据结构代表一块待创建的数据盘。 约束：目前新创建的弹性云服务器最多可挂载23块数据盘。
    *
    * @return $this
    */
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
    ...
    /**
    * Gets flavorRef
    *  待创建云服务器的系统规格的ID。  可通过 [规格列表接口] 查询，该接口支持通过 availability_zone 参数过滤出待创建云服务器可用区下可用的规格。  已上线的各规格详情介绍请参见《[弹性云服务器产品介绍](https://support.huaweicloud.com/ecs/index.html)》的“实例类型与规格”章节。
    *
    * @return string
    */
    ...
    * Sets flavorRef
    *
    * @param string $flavorRef 待创建云服务器的系统规格的ID。  可通过 [规格列表接口] 查询，该接口支持通过 availability_zone 参数过滤出待创建云服务器可用区下可用的规格。  已上线的各规格详情介绍请参见《[弹性云服务器产品介绍](https://support.huaweicloud.com/ecs/index.html)》的“实例类型与规格”章节。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerNic[]
    */
    ...
    * Sets nics
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerNic[] $nics 待创建云服务器的网卡信息。  约束：  - 网卡对应的子网（subnet）必须属于vpcid对应的VPC。 - 当前单个云服务器支持最多挂载12张网卡。 - 不同的规格对网卡上限有一定的区别，参考[规格清单](https://support.huaweicloud.com/productdesc-ecs/zh-cn_topic_0159822360.html)。
    *
    * @return $this
    */
    ...
    *  osschedulerHints
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerSchedulerHints|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerSchedulerHints|null $osschedulerHints osschedulerHints
    *
    * @return $this
    */
    ...
    *  publicip
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerPublicip|null
    */
    ...
    * Sets publicip
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerPublicip|null $publicip publicip
    *
    * @return $this
    */
    ...
    *  rootVolume
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerRootVolume
    */
    ...
    * Sets rootVolume
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerRootVolume $rootVolume rootVolume
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerSecurityGroup[]|null
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerSecurityGroup[]|null $securityGroups 云服务器对应安全组信息。  约束：当该值指定为空时，默认给云服务器绑定default安全组。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerTag[]|null
    */
    ...
    * Sets serverTags
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerTag[]|null $serverTags 弹性云服务器的标签。  > 说明： >  > 创建弹性云服务器时，一台弹性云服务器最多可以添加10个标签。 > 公有云新增server_tags字段，该字段与tags字段功能相同，支持的key、value取值范围更广，建议使用server_tags字段。
    *
    * @return $this
    */
