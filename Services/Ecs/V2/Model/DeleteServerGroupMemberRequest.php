...
class DeleteServerGroupMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteServerGroupMemberRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Ecs\V2\Model\DeleteServerGroupMemberRequestBody'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['serverGroupId'] === null) {
            $invalidProperties[] = "'serverGroupId' can't be null";
        }
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\DeleteServerGroupMemberRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\DeleteServerGroupMemberRequestBody|null $body body
    *
    * @return $this
    */
