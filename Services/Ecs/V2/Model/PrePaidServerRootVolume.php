...
class PrePaidServerRootVolume implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'volumetype' => 'string',
            'size' => 'int',
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\PrePaidServerRootVolumeExtendParam',
            'clusterType' => 'string',
            'clusterId' => 'string',
            'hwpassthrough' => 'bool'
    ];
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerRootVolumeExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerRootVolumeExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
