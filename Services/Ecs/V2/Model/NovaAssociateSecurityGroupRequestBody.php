...
class NovaAssociateSecurityGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'addSecurityGroup' => '\G42Cloud\SDK\Ecs\V2\Model\NovaAddSecurityGroupOption'
    ];
    ...
    *  addSecurityGroup
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaAddSecurityGroupOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaAddSecurityGroupOption $addSecurityGroup addSecurityGroup
    *
    * @return $this
    */
