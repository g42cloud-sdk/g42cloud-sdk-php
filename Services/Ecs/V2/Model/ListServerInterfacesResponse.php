...
class ListServerInterfacesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'attachableQuantity' => '\G42Cloud\SDK\Ecs\V2\Model\InterfaceAttachableQuantity',
            'interfaceAttachments' => '\G42Cloud\SDK\Ecs\V2\Model\InterfaceAttachment[]'
    ];
    ...
    *  attachableQuantity
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\InterfaceAttachableQuantity|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\InterfaceAttachableQuantity|null $attachableQuantity attachableQuantity
    *
    * @return $this
    */
    ...
    *  云服务器网卡信息列表
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\InterfaceAttachment[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\InterfaceAttachment[]|null $interfaceAttachments 云服务器网卡信息列表
    *
    * @return $this
    */
