...
class InterfaceAttachment implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'fixedIps' => '\G42Cloud\SDK\Ecs\V2\Model\ServerInterfaceFixedIp[]',
            'macAddr' => 'string',
            'netId' => 'string',
            'portId' => 'string',
            'portState' => 'string',
    ...
    *  网卡私网IP信息列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerInterfaceFixedIp[]|null
    */
    ...
    * Sets fixedIps
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerInterfaceFixedIp[]|null $fixedIps 网卡私网IP信息列表。
    *
    * @return $this
    */
