...
class PostPaidServerEip implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'iptype' => 'string',
            'bandwidth' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEipBandwidth',
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEipExtendParam'
    ];
    ...
    *  bandwidth
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEipBandwidth
    */
    ...
    * Sets bandwidth
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEipBandwidth $bandwidth bandwidth
    *
    * @return $this
    */
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEipExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerEipExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
