...
class BatchRebootServersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchRebootServersRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'reboot' => '\G42Cloud\SDK\Ecs\V2\Model\BatchRebootSeversOption'
    ];
    ...
    *  reboot
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\BatchRebootSeversOption
    */
    ...
    * Sets reboot
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\BatchRebootSeversOption $reboot reboot
    *
    * @return $this
    */
