...
class ReinstallServerWithCloudInitOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'keyname' => 'string',
            'userid' => 'string',
            'metadata' => '\G42Cloud\SDK\Ecs\V2\Model\ReinstallSeverMetadata',
            'mode' => 'string'
    ];
    ...
    *  metadata
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ReinstallSeverMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ReinstallSeverMetadata|null $metadata metadata
    *
    * @return $this
    */
