...
class SubJob implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'entities' => '\G42Cloud\SDK\Ecs\V2\Model\SubJobEntities',
            'jobId' => 'string',
            'jobType' => 'string',
            'beginTime' => 'string',
            'endTime' => 'string',
    ...
    *  entities
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\SubJobEntities|null
    */
    ...
    * Sets entities
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\SubJobEntities|null $entities entities
    *
    * @return $this
    */
