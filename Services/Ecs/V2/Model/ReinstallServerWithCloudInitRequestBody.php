...
class ReinstallServerWithCloudInitRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReinstallServerWithCloudInitRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'osReinstall' => '\G42Cloud\SDK\Ecs\V2\Model\ReinstallServerWithCloudInitOption'
    ];
    ...
    *  osReinstall
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ReinstallServerWithCloudInitOption
    */
    ...
    * Sets osReinstall
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ReinstallServerWithCloudInitOption $osReinstall osReinstall
    *
    * @return $this
    */
