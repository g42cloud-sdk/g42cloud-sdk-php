...
class ShowServerGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowServerGroupResponse';
    ...
    */
    protected static $openAPITypes = [
            'serverGroup' => '\G42Cloud\SDK\Ecs\V2\Model\ShowServerGroupResult'
    ];
    ...
    *  serverGroup
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ShowServerGroupResult|null
    */
    ...
    * Sets serverGroup
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ShowServerGroupResult|null $serverGroup serverGroup
    *
    * @return $this
    */
