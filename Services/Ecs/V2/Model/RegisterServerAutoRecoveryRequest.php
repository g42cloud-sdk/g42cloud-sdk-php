...
class RegisterServerAutoRecoveryRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\G42Cloud\SDK\Ecs\V2\Model\RegisterServerAutoRecoveryRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\RegisterServerAutoRecoveryRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\RegisterServerAutoRecoveryRequestBody|null $body body
    *
    * @return $this
    */
