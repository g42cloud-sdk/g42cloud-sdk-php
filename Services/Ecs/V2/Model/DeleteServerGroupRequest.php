...
class DeleteServerGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteServerGroupRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverGroupId  弹性云服务器组UUID。
    *
    * @var string[]
    */
