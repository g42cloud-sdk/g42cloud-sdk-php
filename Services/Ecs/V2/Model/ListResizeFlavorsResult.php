...
class ListResizeFlavorsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResizeFlavorsResult';
    ...
    */
    protected static $openAPITypes = [
            ...
            'extraSpecs' => '\G42Cloud\SDK\Ecs\V2\Model\FlavorExtraSpec',
    ...
    * Sets extraSpecs
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\FlavorExtraSpec $extraSpecs extraSpecs
    *
    * @return $this
    */
