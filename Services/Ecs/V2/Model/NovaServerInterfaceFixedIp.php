...
class NovaServerInterfaceFixedIp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaServerInterfaceFixedIp';
    ...
    * Sets ipAddress
    *
    * @param string $ipAddress 网卡私网IP信息。
    *
    * @return $this
    */
    ...
    * Sets subnetId
    *
    * @param string $subnetId 网卡私网IP对应子网信息。
    *
    * @return $this
    */
