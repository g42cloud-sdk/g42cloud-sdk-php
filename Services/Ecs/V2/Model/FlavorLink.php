...
class FlavorLink implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FlavorLink';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * href  对应快捷链接。
    * rel  快捷链接标记名称。
    * type  快捷链接类型，当前接口未使用，缺省值为null。
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string $type 快捷链接类型，当前接口未使用，缺省值为null。
    *
    * @return $this
    */
