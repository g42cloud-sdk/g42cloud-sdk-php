...
class NovaListAvailabilityZonesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaListAvailabilityZonesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * availabilityZoneInfo  可用域信息。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'availabilityZoneInfo' => '\G42Cloud\SDK\Ecs\V2\Model\NovaAvailabilityZone[]'
    ];
    ...
    *  可用域信息。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaAvailabilityZone[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaAvailabilityZone[]|null $availabilityZoneInfo 可用域信息。
    *
    * @return $this
    */
