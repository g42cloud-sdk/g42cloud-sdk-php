...
class CreateServersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateServersRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'server' => '\G42Cloud\SDK\Ecs\V2\Model\PrePaidServer'
    ];
    ...
    *  server
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PrePaidServer
    */
    ...
    * Sets server
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PrePaidServer $server server
    *
    * @return $this
    */
