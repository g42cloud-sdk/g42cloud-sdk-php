...
class PrePaidServerEip implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'iptype' => 'string',
            'bandwidth' => '\G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEipBandwidth',
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEipExtendParam'
    ];
    ...
    *  bandwidth
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEipBandwidth
    */
    ...
    * Sets bandwidth
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEipBandwidth $bandwidth bandwidth
    *
    * @return $this
    */
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEipExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEipExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
