...
class PostPaidServerExtendParam implements ModelInterface, ArrayAccess
{
    ...
    * regionId  云服务器所在区域ID。  请参考[地区和终端节点]获取。
    ...
    * cbCsbsBackup  云备份策略和云备份存储库详情，取值包含备份策略ID和云备份存储库ID。
    *
    * @var string[]
    */
    ...
    * Sets regionId
    *
    * @param string|null $regionId 云服务器所在区域ID。  请参考[地区和终端节点]获取。
    *
    * @return $this
    */
    ...
    * Sets cbCsbsBackup
    *
    * @param string|null $cbCsbsBackup 云备份策略和云备份存储库详情，取值包含备份策略ID和云备份存储库ID。
    *
    * @return $this
    */
