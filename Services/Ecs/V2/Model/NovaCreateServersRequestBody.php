...
class NovaCreateServersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'server' => '\G42Cloud\SDK\Ecs\V2\Model\NovaCreateServersOption',
            'osschedulerHints' => '\G42Cloud\SDK\Ecs\V2\Model\NovaCreateServersSchedulerHint'
    ];
    ...
    *  server
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaCreateServersOption
    */
    ...
    * Sets server
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaCreateServersOption $server server
    *
    * @return $this
    */
    ...
    *  osschedulerHints
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaCreateServersSchedulerHint|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaCreateServersSchedulerHint|null $osschedulerHints osschedulerHints
    *
    * @return $this
    */
