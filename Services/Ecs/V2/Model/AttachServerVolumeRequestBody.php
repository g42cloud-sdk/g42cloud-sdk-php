...
class AttachServerVolumeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'volumeAttachment' => '\G42Cloud\SDK\Ecs\V2\Model\AttachServerVolumeOption',
            'dryRun' => 'bool'
    ];
    ...
    *  volumeAttachment
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\AttachServerVolumeOption
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\AttachServerVolumeOption $volumeAttachment volumeAttachment
    *
    * @return $this
    */
