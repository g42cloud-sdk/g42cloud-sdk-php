...
class UpdateServerAddress implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateServerAddress';
    ...
    * Sets version
    *
    * @param int $version IP地址版本。  - 4：代表IPv4。 - 6：代表IPv6。
    *
    * @return $this
    */
