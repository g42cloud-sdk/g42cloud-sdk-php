...
class NovaServer implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'created' => 'string',
            'updated' => 'string',
            'flavor' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerFlavor',
            'image' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerImage',
            'tenantId' => 'string',
            'keyName' => 'string',
            'userId' => 'string',
            'metadata' => 'map[string,string]',
            'hostId' => 'string',
            'addresses' => 'map[string,\G42Cloud\SDK\Ecs\V2\Model\NovaNetwork[]]',
            'securityGroups' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerSecurityGroup[]',
            'links' => '\G42Cloud\SDK\Ecs\V2\Model\NovaLink[]',
            ...
            'osExtendedVolumesvolumesAttached' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerVolume[]',
            'fault' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerFault',
            'description' => 'string',
            'hostStatus' => 'string',
            ...
            'configDrive' => 'string',
            'progress' => 'int',
            'osschedulerHints' => '\G42Cloud\SDK\Ecs\V2\Model\NovaServerSchedulerHints'
    ];
    ...
    *  flavor
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerFlavor
    */
    ...
    * Sets flavor
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerFlavor $flavor flavor
    *
    * @return $this
    */
    ...
    *  image
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerImage
    */
    ...
    * Sets image
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerImage $image image
    *
    * @return $this
    */
    ...
    *  云服务器对应的网络地址信息。
    *
    * @return map[string,\G42Cloud\SDK\Ecs\V2\Model\NovaNetwork[]]
    */
    ...
    * Sets addresses
    *
    * @param map[string,\G42Cloud\SDK\Ecs\V2\Model\NovaNetwork[]] $addresses 云服务器对应的网络地址信息。
    *
    * @return $this
    */
    ...
    *  云服务器所属安全组列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerSecurityGroup[]
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerSecurityGroup[] $securityGroups 云服务器所属安全组列表。
    *
    * @return $this
    */
    ...
    *  云服务器相关标记快捷链接信息。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaLink[]
    */
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaLink[] $links 云服务器相关标记快捷链接信息。
    *
    * @return $this
    */
    ...
    *  云服务器挂载的云磁盘信息。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerVolume[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerVolume[] $osExtendedVolumesvolumesAttached 云服务器挂载的云磁盘信息。
    *
    * @return $this
    */
    ...
    *  fault
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerFault|null
    */
    ...
    * Sets fault
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerFault|null $fault fault
    *
    * @return $this
    */
    ...
    *  osschedulerHints
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaServerSchedulerHints|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaServerSchedulerHints|null $osschedulerHints osschedulerHints
    *
    * @return $this
    */
