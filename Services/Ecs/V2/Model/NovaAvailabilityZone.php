...
class NovaAvailabilityZone implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'hosts' => 'string[]',
            'zoneName' => 'string',
            'zoneState' => '\G42Cloud\SDK\Ecs\V2\Model\NovaAvailabilityZoneState'
    ];
    ...
    *  zoneState
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaAvailabilityZoneState
    */
    ...
    * Sets zoneState
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaAvailabilityZoneState $zoneState zoneState
    *
    * @return $this
    */
