...
class BatchStartServersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'osStart' => '\G42Cloud\SDK\Ecs\V2\Model\BatchStartServersOption'
    ];
    ...
    *  osStart
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\BatchStartServersOption
    */
    ...
    * Sets osStart
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\BatchStartServersOption $osStart osStart
    *
    * @return $this
    */
