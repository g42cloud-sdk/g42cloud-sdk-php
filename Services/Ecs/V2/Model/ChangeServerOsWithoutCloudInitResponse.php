...
class ChangeServerOsWithoutCloudInitResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeServerOsWithoutCloudInitResponse';
