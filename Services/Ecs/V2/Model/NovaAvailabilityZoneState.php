...
class NovaAvailabilityZoneState implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaAvailabilityZoneState';
