...
class PostPaidServerDataVolume implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'multiattach' => 'bool',
            'hwpassthrough' => 'bool',
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolumeExtendParam',
            'clusterType' => 'string',
            'clusterId' => 'string',
            'metadata' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolumeMetadata',
            'dataImageId' => 'string',
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolumeExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolumeExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolumeMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerDataVolumeMetadata|null $metadata metadata
    *
    * @return $this
    */
