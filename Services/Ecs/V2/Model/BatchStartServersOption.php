...
class BatchStartServersOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchStartServersOption';
    ...
    * Sets servers
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerId[] $servers 云服务器ID列表
    *
    * @return $this
    */
