...
class NovaListServerSecurityGroupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'securityGroups' => '\G42Cloud\SDK\Ecs\V2\Model\NovaSecurityGroup[]'
    ];
    ...
    *  security_group列表
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaSecurityGroup[]|null
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaSecurityGroup[]|null $securityGroups security_group列表
    *
    * @return $this
    */
