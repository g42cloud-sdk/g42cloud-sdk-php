...
class UpdateServerResult implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'addresses' => 'map[string,\G42Cloud\SDK\Ecs\V2\Model\UpdateServerAddress[]]',
            'created' => 'string',
            'hostId' => 'string',
            'flavor' => '\G42Cloud\SDK\Ecs\V2\Model\SimpleFlavor',
            'osDcFdiskConfig' => 'string',
            'userId' => 'string',
            'name' => 'string',
            'progress' => 'int',
            'links' => '\G42Cloud\SDK\Ecs\V2\Model\Link[]',
            'id' => 'string',
            'updated' => 'string',
            'locked' => 'bool',
            'description' => 'string',
    ...
    *  弹性云服务器的网络属性。
    *
    * @return map[string,\G42Cloud\SDK\Ecs\V2\Model\UpdateServerAddress[]]
    */
    ...
    * Sets addresses
    *
    * @param map[string,\G42Cloud\SDK\Ecs\V2\Model\UpdateServerAddress[]] $addresses 弹性云服务器的网络属性。
    *
    * @return $this
    */
    ...
    *  flavor
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\SimpleFlavor
    */
    ...
    * Sets flavor
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\SimpleFlavor $flavor flavor
    *
    * @return $this
    */
    ...
    *  云服务器相关标记快捷链接信息。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\Link[]
    */
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\Link[] $links 云服务器相关标记快捷链接信息。
    *
    * @return $this
    */
