...
class ListServerGroupsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serverGroups' => '\G42Cloud\SDK\Ecs\V2\Model\ListServerGroupsResult[]',
            'pageInfo' => '\G42Cloud\SDK\Ecs\V2\Model\ListServerGroupsPageInfoResult'
    ];
    ...
    *  弹性云服务器组信息
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ListServerGroupsResult[]|null
    */
    ...
    * Sets serverGroups
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ListServerGroupsResult[]|null $serverGroups 弹性云服务器组信息
    *
    * @return $this
    */
    ...
    *  pageInfo
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ListServerGroupsPageInfoResult|null
    */
    ...
    * Sets pageInfo
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ListServerGroupsPageInfoResult|null $pageInfo pageInfo
    *
    * @return $this
    */
