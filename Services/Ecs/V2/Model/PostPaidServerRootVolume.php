...
class PostPaidServerRootVolume implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostPaidServerRootVolume';
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusterType' => 'string',
            'clusterId' => 'string',
            'extendparam' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerRootVolumeExtendParam'
    ];
    ...
    *  extendparam
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerRootVolumeExtendParam|null
    */
    ...
    * Sets extendparam
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerRootVolumeExtendParam|null $extendparam extendparam
    *
    * @return $this
    */
