...
class ServerGroupMember implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServerGroupMember';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['instanceUuid'] === null) {
            $invalidProperties[] = "'instanceUuid' can't be null";
        }
    ...
    * Sets instanceUuid
    *
    * @param string $instanceUuid 云服务器UUID。
    *
    * @return $this
    */
