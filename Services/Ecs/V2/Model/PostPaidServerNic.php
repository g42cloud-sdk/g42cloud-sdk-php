...
class PostPaidServerNic implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostPaidServerNic';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subnetId  待创建云服务器所在的子网信息，需要指定vpcid对应VPC下的子网ID，UUID格式。  可以通过VPC服务 [查询子网] 接口查询，该接口支持通过创建云服务器填写的vpcid进行过滤查询。
    ...
    */
    protected static $openAPITypes = [
            ...
            'ipAddress' => 'string',
            'ipv6Enable' => 'bool',
            'ipv6Bandwidth' => '\G42Cloud\SDK\Ecs\V2\Model\PostPaidServerIpv6Bandwidth'
    ];
    ...
    */
    ...
    /**
    * Gets subnetId
    *  待创建云服务器所在的子网信息，需要指定vpcid对应VPC下的子网ID，UUID格式。  可以通过VPC服务 [查询子网] 接口查询，该接口支持通过创建云服务器填写的vpcid进行过滤查询。
    *
    * @return string
    */
    ...
    * Sets subnetId
    *
    * @param string $subnetId 待创建云服务器所在的子网信息，需要指定vpcid对应VPC下的子网ID，UUID格式。  可以通过VPC服务 [查询子网] 接口查询，该接口支持通过创建云服务器填写的vpcid进行过滤查询。
    *
    * @return $this
    */
    ...
    *  ipv6Bandwidth
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerIpv6Bandwidth|null
    */
    ...
    * Sets ipv6Bandwidth
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PostPaidServerIpv6Bandwidth|null $ipv6Bandwidth ipv6Bandwidth
    *
    * @return $this
    */
