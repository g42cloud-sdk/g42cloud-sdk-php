...
class ChangeServerOsWithoutCloudInitRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'osChange' => '\G42Cloud\SDK\Ecs\V2\Model\ChangeServerOsWithoutCloudInitOption'
    ];
    ...
    *  osChange
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ChangeServerOsWithoutCloudInitOption
    */
    ...
    * Sets osChange
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ChangeServerOsWithoutCloudInitOption $osChange osChange
    *
    * @return $this
    */
