...
class BatchAddServerNicsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddServerNicsRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'nics' => '\G42Cloud\SDK\Ecs\V2\Model\BatchAddServerNicOption[]'
    ];
    ...
    *  需要添加的网卡参数列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\BatchAddServerNicOption[]
    */
    ...
    * Sets nics
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\BatchAddServerNicOption[] $nics 需要添加的网卡参数列表。
    *
    * @return $this
    */
