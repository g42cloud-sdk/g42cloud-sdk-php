...
class AssociateServerVirtualIpOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateServerVirtualIpOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subnetId  网卡的子网ID。
    * ipAddress  网卡即将配置的私有IP的地址。
    * reverseBinding  私有IP的allowed_address_pairs属性是否添加网卡的IP/Mac对。
    *
    * @var string[]
    */
    ...
    * Sets ipAddress
    *
    * @param string $ipAddress 网卡即将配置的私有IP的地址。
    *
    * @return $this
    */
