...
class ShowServerBlockDeviceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowServerBlockDeviceResponse';
    ...
    */
    protected static $openAPITypes = [
            'volumeAttachment' => '\G42Cloud\SDK\Ecs\V2\Model\ServerBlockDevice'
    ];
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerBlockDevice|null $volumeAttachment volumeAttachment
    *
    * @return $this
    */
