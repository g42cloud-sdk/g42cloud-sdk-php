...
class ChangeServerOsWithCloudInitRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeServerOsWithCloudInitRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'osChange' => '\G42Cloud\SDK\Ecs\V2\Model\ChangeServerOsWithCloudInitOption'
    ];
    ...
    *  osChange
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ChangeServerOsWithCloudInitOption
    */
    ...
    * Sets osChange
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ChangeServerOsWithCloudInitOption $osChange osChange
    *
    * @return $this
    */
