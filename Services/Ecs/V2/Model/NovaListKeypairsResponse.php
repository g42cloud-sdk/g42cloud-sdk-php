...
class NovaListKeypairsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaListKeypairsResponse';
    ...
    */
    protected static $openAPITypes = [
            'keypairs' => '\G42Cloud\SDK\Ecs\V2\Model\NovaListKeypairsResult[]'
    ];
    ...
    *  密钥信息列表。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\NovaListKeypairsResult[]|null
    */
    ...
    * Sets keypairs
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\NovaListKeypairsResult[]|null $keypairs 密钥信息列表。
    *
    * @return $this
    */
