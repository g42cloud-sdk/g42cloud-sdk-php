...
class Flavor implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'links' => '\G42Cloud\SDK\Ecs\V2\Model\FlavorLink[]',
            'osExtraSpecs' => '\G42Cloud\SDK\Ecs\V2\Model\FlavorExtraSpec',
            'attachableQuantity' => '\G42Cloud\SDK\Ecs\V2\Model\ServerAttachableQuantity'
    ];
    ...
    *  规格相关快捷链接地址。
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\FlavorLink[]
    */
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\FlavorLink[] $links 规格相关快捷链接地址。
    *
    * @return $this
    */
    ...
    *  osExtraSpecs
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\FlavorExtraSpec
    */
    ...
    * Sets osExtraSpecs
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\FlavorExtraSpec $osExtraSpecs osExtraSpecs
    *
    * @return $this
    */
    ...
    *  attachableQuantity
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerAttachableQuantity|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerAttachableQuantity|null $attachableQuantity attachableQuantity
    *
    * @return $this
    */
