...
class NovaCreateKeypairOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaCreateKeypairOption';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['publicKey']) && (mb_strlen($this->container['publicKey']) < 1)) {
                $invalidProperties[] = "invalid value for 'publicKey', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets publicKey
    *
    * @param string|null $publicKey 导入的公钥信息。  建议导入的公钥长度不大于1024字节。  说明：  - 长度超过1024字节会导致云服务器注入该密钥失败。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 密钥类型，值为“ssh”或“x509”。  说明：  - 微版本2.2支持。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string $name 密钥名称。  新创建的密钥名称不能和已有密钥名称相同。
    *
    * @return $this
    */
    ...
    * Sets userId
    *
    * @param string|null $userId 密钥的用户ID。  说明：  - 微版本2.10支持。
    *
    * @return $this
    */
