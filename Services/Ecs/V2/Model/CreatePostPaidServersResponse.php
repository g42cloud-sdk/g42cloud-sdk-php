...
class CreatePostPaidServersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePostPaidServersResponse';
    ...
    * Sets serverIds
    *
    * @param string[]|null $serverIds 云服务器ID列表。
    *
    * @return $this
    */
