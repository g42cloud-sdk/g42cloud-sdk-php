...
class ServerLimits implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'limitByFlavor' => '\G42Cloud\SDK\Ecs\V2\Model\ProjectFlavorLimit[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ProjectFlavorLimit[]|null
    */
    ...
    * Sets limitByFlavor
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ProjectFlavorLimit[]|null $limitByFlavor 使用该flavor可以申请的弹性云服务器数量。  值为“-1”时，表示无数量限制。
    *
    * @return $this
    */
