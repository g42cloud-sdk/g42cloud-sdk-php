...
class ReinstallServerWithoutCloudInitResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReinstallServerWithoutCloudInitResponse';
