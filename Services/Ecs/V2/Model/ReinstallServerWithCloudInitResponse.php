...
class ReinstallServerWithCloudInitResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReinstallServerWithCloudInitResponse';
