...
class ChangeServerOsWithCloudInitOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'userid' => 'string',
            'imageid' => 'string',
            'metadata' => '\G42Cloud\SDK\Ecs\V2\Model\ChangeSeversOsMetadata',
            'mode' => 'string'
    ];
    ...
    *  metadata
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ChangeSeversOsMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ChangeSeversOsMetadata|null $metadata metadata
    *
    * @return $this
    */
