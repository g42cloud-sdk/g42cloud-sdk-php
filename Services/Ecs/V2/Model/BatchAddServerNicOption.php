...
class BatchAddServerNicOption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'subnetId' => 'string',
            'securityGroups' => '\G42Cloud\SDK\Ecs\V2\Model\ServerNicSecurityGroup[]',
            'ipAddress' => 'string',
            'ipv6Enable' => 'bool',
            'ipv6Bandwidth' => '\G42Cloud\SDK\Ecs\V2\Model\Ipv6Bandwidth'
    ];
    ...
    * Sets subnetId
    *
    * @param string $subnetId 云服务器添加网卡的信息。  需要指定云服务器所属虚拟私有云下已创建的网络（network）的ID，UUID格式。 指定subnet_id时不能再指定port_id参数。
    *
    * @return $this
    */
    ...
    *  添加网卡的安全组信息
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\ServerNicSecurityGroup[]|null
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\ServerNicSecurityGroup[]|null $securityGroups 添加网卡的安全组信息
    *
    * @return $this
    */
    ...
    *  ipv6Bandwidth
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\Ipv6Bandwidth|null
    */
    ...
    * Sets ipv6Bandwidth
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\Ipv6Bandwidth|null $ipv6Bandwidth ipv6Bandwidth
    *
    * @return $this
    */
