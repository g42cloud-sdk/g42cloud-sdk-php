...
class PrePaidServerPublicip implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrePaidServerPublicip';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'eip' => '\G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEip',
    ...
    *  eip
    *
    * @return \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEip|null
    */
    ...
    * Sets eip
    *
    * @param \G42Cloud\SDK\Ecs\V2\Model\PrePaidServerEip|null $eip eip
    *
    * @return $this
    */
