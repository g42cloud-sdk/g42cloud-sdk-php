...
class ListQualityEnhanceDefaultTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListQualityEnhanceDefaultTemplateResponse';
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\QualityEnhanceTemplateInfo[]',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\QualityEnhanceTemplateInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\QualityEnhanceTemplateInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
