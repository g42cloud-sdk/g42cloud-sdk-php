...
class TranscodeDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'multitaskInfo' => '\G42Cloud\SDK\Mpc\V1\Model\MultiTaskInfo[]',
            'inputFile' => '\G42Cloud\SDK\Mpc\V1\Model\SourceInfo'
    ];
    ...
    *  一进多出情况下部分转码失败的情况。
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MultiTaskInfo[]|null
    */
    ...
    * Sets multitaskInfo
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MultiTaskInfo[]|null $multitaskInfo 一进多出情况下部分转码失败的情况。
    *
    * @return $this
    */
    ...
    *  inputFile
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\SourceInfo|null
    */
    ...
    * Sets inputFile
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\SourceInfo|null $inputFile inputFile
    *
    * @return $this
    */
