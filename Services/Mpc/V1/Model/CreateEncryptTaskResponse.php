...
class CreateEncryptTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEncryptTaskResponse';
    ...
    * Sets taskId
    *
    * @param string|null $taskId 加密任务Id
    *
    * @return $this
    */
