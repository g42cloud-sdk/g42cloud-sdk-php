...
class MpeCallBackReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'completeRatio' => 'int',
            'description' => 'string',
            'metaData' => '\G42Cloud\SDK\Mpc\V1\Model\MpeMetaData'
    ];
    ...
    *  metaData
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MpeMetaData|null
    */
    ...
    * Sets metaData
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MpeMetaData|null $metaData metaData
    *
    * @return $this
    */
