...
class VideoDenoise implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VideoDenoise';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  降噪算法名称\"hw-denoise\"、\"waifu2x\"。
    ...
    * Sets name
    *
    * @param string|null $name 降噪算法名称\"hw-denoise\"、\"waifu2x\"。
    *
    * @return $this
    */
