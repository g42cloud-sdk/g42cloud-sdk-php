...
class ImageWatermarkSetting implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageWatermarkSetting';
    ...
    * overlayInput  对应拼接列表中第几个片段打水印，从0开始，\"0表示第1个，“1”表示第二个，不带或填\"ALL\"表示所有拼接片源打水印。
    * input  input
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['overlayInput']) && (mb_strlen($this->container['overlayInput']) > 32)) {
                $invalidProperties[] = "invalid value for 'overlayInput', the character length must be smaller than or equal to 32.";
            }
            if (!is_null($this->container['overlayInput']) && (mb_strlen($this->container['overlayInput']) < 0)) {
                $invalidProperties[] = "invalid value for 'overlayInput', the character length must be bigger than or equal to 0.";
            }
    ...
    */
    ...
    {
        return $this->container['overlayInput'];
    }

    /**
    * Sets overlayInput
    *
    * @param string|null $overlayInput 对应拼接列表中第几个片段打水印，从0开始，\"0表示第1个，“1”表示第二个，不带或填\"ALL\"表示所有拼接片源打水印。
    *
    * @return $this
    */
    public function setOverlayInput($overlayInput)
    {
        $this->container['overlayInput'] = $overlayInput;
        return $this;
    }
