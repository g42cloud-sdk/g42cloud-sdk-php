...
class ListStatSummaryResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'summary' => '\G42Cloud\SDK\Mpc\V1\Model\StatSummary[]',
            'total' => 'float',
            'statType' => 'string'
    ];
    ...
    *  统计概览信息
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\StatSummary[]|null
    */
    ...
    * Sets summary
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\StatSummary[]|null $summary 统计概览信息
    *
    * @return $this
    */
