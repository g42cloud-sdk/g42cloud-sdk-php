...
class ListTranscodingTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\QueryTranscodingsTaskResponse[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  返回任务组
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\QueryTranscodingsTaskResponse[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\QueryTranscodingsTaskResponse[]|null $taskArray 返回任务组
    *
    * @return $this
    */
