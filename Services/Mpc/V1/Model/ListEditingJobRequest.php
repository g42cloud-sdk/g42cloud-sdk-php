...
class ListEditingJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEditingJobRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  客户端语言
    * jobId  任务ID。一次最多10个
    * status  任务执行状态。  取值如下： - INIT：初始状态 - WAITING：待启动 - PREPROCESSING：处理中 - SUCCEED：处理成功 - FAILED：处理失败 - CANCELED：已取消
    ...
    * Sets jobId
    *
    * @param string[]|null $jobId 任务ID。一次最多10个
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 任务执行状态。  取值如下： - INIT：初始状态 - WAITING：待启动 - PREPROCESSING：处理中 - SUCCEED：处理成功 - FAILED：处理失败 - CANCELED：已取消
    *
    * @return $this
    */
