...
class MergeChannelsTaskInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MergeChannelsTaskInfo';
    ...
    * Sets audioFiles
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AudioFile[]|null $audioFiles 音频文件列表
    *
    * @return $this
    */
