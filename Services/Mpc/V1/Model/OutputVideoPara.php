...
class OutputVideoPara implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'size' => 'int',
            'pack' => 'string',
            'video' => '\G42Cloud\SDK\Mpc\V1\Model\VideoInfo',
            'audio' => '\G42Cloud\SDK\Mpc\V1\Model\AudioInfo',
            'fileName' => 'string',
            'converDuration' => 'double',
            'error' => '\G42Cloud\SDK\Mpc\V1\Model\XCodeError'
    ];
    ...
    *  video
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoInfo|null
    */
    ...
    * Sets video
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoInfo|null $video video
    *
    * @return $this
    */
    ...
    *  audio
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\AudioInfo|null
    */
    ...
    * Sets audio
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AudioInfo|null $audio audio
    *
    * @return $this
    */
    ...
    *  error
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\XCodeError|null
    */
    ...
    * Sets error
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\XCodeError|null $error error
    *
    * @return $this
    */
