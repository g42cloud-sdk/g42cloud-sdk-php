...
class CreateEditingJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEditingJobResponse';
    ...
    * Sets jobId
    *
    * @param string|null $jobId 接受任务后产生的任务ID。
    *
    * @return $this
    */
