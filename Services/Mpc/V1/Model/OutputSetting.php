...
class OutputSetting implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'format' => 'string',
            'video' => '\G42Cloud\SDK\Mpc\V1\Model\EditVideoInfo',
            'audio' => '\G42Cloud\SDK\Mpc\V1\Model\EditAudioInfo',
            'hls' => '\G42Cloud\SDK\Mpc\V1\Model\EditHlsInfo',
    ...
    *  video
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\EditVideoInfo|null
    */
    ...
    * Sets video
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\EditVideoInfo|null $video video
    *
    * @return $this
    */
    ...
    *  audio
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\EditAudioInfo|null
    */
    ...
    * Sets audio
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\EditAudioInfo|null $audio audio
    *
    * @return $this
    */
    ...
    *  hls
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\EditHlsInfo|null
    */
    ...
    * Sets hls
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\EditHlsInfo|null $hls hls
    *
    * @return $this
    */
