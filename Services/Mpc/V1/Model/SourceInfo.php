...
class SourceInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'format' => 'string',
            'size' => 'int',
            'videoInfo' => '\G42Cloud\SDK\Mpc\V1\Model\VideoInfo',
            'audioInfo' => '\G42Cloud\SDK\Mpc\V1\Model\AudioInfo[]'
    ];
    ...
    * Sets videoInfo
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoInfo|null $videoInfo videoInfo
    *
    * @return $this
    */
    ...
    * Sets audioInfo
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AudioInfo[]|null $audioInfo 音频信息
    *
    * @return $this
    */
