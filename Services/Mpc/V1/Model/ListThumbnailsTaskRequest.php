...
class ListThumbnailsTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListThumbnailsTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  客户端语言
    * taskId  截图服务接受任务后产生的任务ID。一次最多10个
    * status  任务状态。  取值如下： - WAITING: 等待启动 - PROCESSING：截图中 - SUCCEEDED：截图成功 - FAILED：截图失败 - CANCELED：已删除
    ...
    * Sets taskId
    *
    * @param string[]|null $taskId 截图服务接受任务后产生的任务ID。一次最多10个
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 任务状态。  取值如下： - WAITING: 等待启动 - PROCESSING：截图中 - SUCCEEDED：截图成功 - FAILED：截图失败 - CANCELED：已删除
    *
    * @return $this
    */
