...
class CreateThumbReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'userData' => 'string',
            'thumbnailPara' => '\G42Cloud\SDK\Mpc\V1\Model\ThumbnailPara',
            'tar' => 'int',
            'sync' => 'int',
            'originalDir' => 'int'
    ];
    ...
    * Sets input
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo $input input
    *
    * @return $this
    */
    ...
    *  thumbnailPara
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ThumbnailPara
    */
    ...
    * Sets thumbnailPara
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ThumbnailPara $thumbnailPara thumbnailPara
    *
    * @return $this
    */
