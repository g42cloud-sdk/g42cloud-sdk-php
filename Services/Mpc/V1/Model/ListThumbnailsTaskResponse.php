...
class ListThumbnailsTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListThumbnailsTaskResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskArray  截图任务组
    * isTruncated  查询结果是否被截取。 - 1代表被截取，即还有结果未被返回，可以通过设置page和size参数继续查询。 - 0代表未被截取，即所有结果已被返回。
    * total  查询结果的数量。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\ThumbTask[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['isTruncated']) && ($this->container['isTruncated'] > 1)) {
                $invalidProperties[] = "invalid value for 'isTruncated', must be smaller than or equal to 1.";
            }
    ...
    *  截图任务组
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ThumbTask[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ThumbTask[]|null $taskArray 截图任务组
    *
    * @return $this
    */
    ...
    * Sets isTruncated
    *
    * @param int|null $isTruncated 查询结果是否被截取。 - 1代表被截取，即还有结果未被返回，可以通过设置page和size参数继续查询。 - 0代表未被截取，即所有结果已被返回。
    *
    * @return $this
    */
