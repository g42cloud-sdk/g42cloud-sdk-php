...
class CreateTranscodingReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'userData' => 'string',
            'watermarks' => '\G42Cloud\SDK\Mpc\V1\Model\WatermarkRequest[]',
            'thumbnail' => '\G42Cloud\SDK\Mpc\V1\Model\Thumbnail',
            'priority' => 'int',
            'subtitle' => '\G42Cloud\SDK\Mpc\V1\Model\Subtitle',
            'encryption' => '\G42Cloud\SDK\Mpc\V1\Model\Encryption',
            'crop' => '\G42Cloud\SDK\Mpc\V1\Model\Crop',
            'audioTrack' => '\G42Cloud\SDK\Mpc\V1\Model\AudioTrack',
            'multiAudio' => '\G42Cloud\SDK\Mpc\V1\Model\MultiAudio',
            'videoProcess' => '\G42Cloud\SDK\Mpc\V1\Model\VideoProcess',
            'audioProcess' => '\G42Cloud\SDK\Mpc\V1\Model\AudioProcess'
    ];
    ...
    *  output
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo
    */
    ...
    * Sets output
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo $output output
    *
    * @return $this
    */
    ...
    * Sets avParameters
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AvParameters[]|null $avParameters 转码参数。  若同时设置“trans_template_id”和此参数，则优先使用此参数进行转码，不带trans_template_id时，该参数必选。
    *
    * @return $this
    */
    ...
    *  图片水印参数，数组，最多支持20个成员。
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\WatermarkRequest[]|null
    */
    ...
    * Sets watermarks
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\WatermarkRequest[]|null $watermarks 图片水印参数，数组，最多支持20个成员。
    *
    * @return $this
    */
    ...
    *  thumbnail
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\Thumbnail|null
    */
    ...
    * Sets thumbnail
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\Thumbnail|null $thumbnail thumbnail
    *
    * @return $this
    */
    ...
    *  subtitle
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\Subtitle|null
    */
    ...
    * Sets subtitle
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\Subtitle|null $subtitle subtitle
    *
    * @return $this
    */
    ...
    *  crop
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\Crop|null
    */
    ...
    * Sets crop
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\Crop|null $crop crop
    *
    * @return $this
    */
    ...
    *  audioTrack
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\AudioTrack|null
    */
    ...
    * Sets audioTrack
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AudioTrack|null $audioTrack audioTrack
    *
    * @return $this
    */
    ...
    *  multiAudio
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MultiAudio|null
    */
    ...
    * Sets multiAudio
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MultiAudio|null $multiAudio multiAudio
    *
    * @return $this
    */
    ...
    *  videoProcess
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoProcess|null
    */
    ...
    * Sets videoProcess
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoProcess|null $videoProcess videoProcess
    *
    * @return $this
    */
    ...
    *  audioProcess
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\AudioProcess|null
    */
    ...
    * Sets audioProcess
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AudioProcess|null $audioProcess audioProcess
    *
    * @return $this
    */
