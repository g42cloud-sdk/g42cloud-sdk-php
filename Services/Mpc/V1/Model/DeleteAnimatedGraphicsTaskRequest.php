...
class DeleteAnimatedGraphicsTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAnimatedGraphicsTaskRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if ((mb_strlen($this->container['taskId']) > 16)) {
