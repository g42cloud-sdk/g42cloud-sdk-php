...
class TemplateInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'templateId' => 'int',
            'template' => '\G42Cloud\SDK\Mpc\V1\Model\QueryTransTemplate'
    ];
    ...
    *  template
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\QueryTransTemplate|null
    */
    ...
    * Sets template
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\QueryTransTemplate|null $template template
    *
    * @return $this
    */
