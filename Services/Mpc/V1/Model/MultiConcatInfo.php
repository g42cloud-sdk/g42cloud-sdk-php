...
class MultiConcatInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'inputs' => '\G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo[]',
    ...
    * Sets inputs
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo[] $inputs 拼接任务输入源地址。
    *
    * @return $this
    */
    ...
    * Sets avParameters
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AvParameters[]|null $avParameters 转码参数。 设置“trans_template_id”和此参数，则优先使用此参数进行转码。
    *
    * @return $this
    */
