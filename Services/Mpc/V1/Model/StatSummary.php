...
class StatSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StatSummary';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * value  精确到小数点后两位。
    * date  日期,精确到天,格式样例：2018/03/01。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['value']) && ($this->container['value'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'value', must be smaller than or equal to 2147483647.";
            }
    ...
    * Sets value
    *
    * @param float|null $value 精确到小数点后两位。
    *
    * @return $this
    */
    ...
    * Sets date
    *
    * @param string|null $date 日期,精确到天,格式样例：2018/03/01。
    *
    * @return $this
    */
