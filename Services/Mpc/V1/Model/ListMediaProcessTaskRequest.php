...
class ListMediaProcessTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMediaProcessTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  独立加密任务ID。一次最多10个
    * status  任务状态。  取值如下： - WAITING：等待启动 - PROCESSING：处理中 - SUCCEEDED：处理成功 - FAILED：处理失败 - CANCELED：已取消
    ...
    * Sets taskId
    *
    * @param string[]|null $taskId 独立加密任务ID。一次最多10个
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 任务状态。  取值如下： - WAITING：等待启动 - PROCESSING：处理中 - SUCCEEDED：处理成功 - FAILED：处理失败 - CANCELED：已取消
    *
    * @return $this
    */
