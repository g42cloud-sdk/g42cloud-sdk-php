...
class ListResetTracksTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResetTracksTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\ResetTracksTaskInfo[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ResetTracksTaskInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ResetTracksTaskInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
