...
class ListEditingJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEditingJobResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'jobs' => '\G42Cloud\SDK\Mpc\V1\Model\EditingJob[]'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\EditingJob[]|null
    */
    ...
    * Sets jobs
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\EditingJob[]|null $jobs 任务列表
    *
    * @return $this
    */
