...
class WatermarkTemplate implements ModelInterface, ArrayAccess
{
    ...
    * templateId  水印模板ID
    * templateName  水印模板名称。
    * type  水印类型，当前只支持Image（图片水印）。后续根据需求再支持Text（文字水印）。
    *
    * @var string[]
    */
    ...
    * Sets templateId
    *
    * @param int|null $templateId 水印模板ID
    *
    * @return $this
    */
    ...
    * Sets templateName
    *
    * @param string|null $templateName 水印模板名称。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 水印类型，当前只支持Image（图片水印）。后续根据需求再支持Text（文字水印）。
    *
    * @return $this
    */
