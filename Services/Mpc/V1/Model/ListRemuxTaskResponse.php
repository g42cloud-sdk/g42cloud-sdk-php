...
class ListRemuxTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRemuxTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'tasks' => '\G42Cloud\SDK\Mpc\V1\Model\RemuxTask[]'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\RemuxTask[]|null
    */
    ...
    * Sets tasks
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\RemuxTask[]|null $tasks 任务列表
    *
    * @return $this
    */
