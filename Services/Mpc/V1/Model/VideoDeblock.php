...
class VideoDeblock implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VideoDeblock';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  去块算法名称\"hw-deblock\"。
    ...
    * Sets name
    *
    * @param string|null $name 去块算法名称\"hw-deblock\"。
    *
    * @return $this
    */
