...
class EditingJob implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EditingJob';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  任务ID
    * status  任务状态。  取值如下： - INIT：初始状态。 - WAITING：等待启动。 - PROCESSING：处理中。 - SUCCEED：处理成功。 - FAILED：处理失败。 - CANCELED：已取消。
    * createTime  任务创建时间
    * startTime  任务启动时间
    * endTime  任务结束时间
    * errorCode  任务的返回码。
    ...
    * output  output
    * editTaskReq  editTaskReq
    * outputFileInfo  剪辑输出meta信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'editTaskReq' => '\G42Cloud\SDK\Mpc\V1\Model\CreateEditingJobReq',
            'outputFileInfo' => '\G42Cloud\SDK\Mpc\V1\Model\OutputFileInfo[]'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'editType' => 'edit_type',
            'output' => 'output',
            'editTaskReq' => 'edit_task_req',
            'outputFileInfo' => 'output_file_info'
    ];
    ...
    */
    protected static $setters = [
            ...
            'output' => 'setOutput',
            'editTaskReq' => 'setEditTaskReq',
            'outputFileInfo' => 'setOutputFileInfo'
    ];
    ...
    */
    protected static $getters = [
            ...
            'output' => 'getOutput',
            'editTaskReq' => 'getEditTaskReq',
            'outputFileInfo' => 'getOutputFileInfo'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['editTaskReq'] = isset($data['editTaskReq']) ? $data['editTaskReq'] : null;
        $this->container['outputFileInfo'] = isset($data['outputFileInfo']) ? $data['outputFileInfo'] : null;
    }
    ...
    * Sets status
    *
    * @param string|null $status 任务状态。  取值如下： - INIT：初始状态。 - WAITING：等待启动。 - PROCESSING：处理中。 - SUCCEED：处理成功。 - FAILED：处理失败。 - CANCELED：已取消。
    *
    * @return $this
    */
    ...
    * Sets startTime
    *
    * @param string|null $startTime 任务启动时间
    *
    * @return $this
    */
    ...
    * Sets errorCode
    *
    * @param string|null $errorCode 任务的返回码。
    *
    * @return $this
    */
    ...
    *  editTaskReq
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\CreateEditingJobReq|null
    */
    public function getEditTaskReq()
    {
        return $this->container['editTaskReq'];
    }

    /**
    * Sets editTaskReq
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\CreateEditingJobReq|null $editTaskReq editTaskReq
    *
    * @return $this
    */
    public function setEditTaskReq($editTaskReq)
    {
        $this->container['editTaskReq'] = $editTaskReq;
        return $this;
    }
    ...
    *  剪辑输出meta信息
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\OutputFileInfo[]|null
    */
    public function getOutputFileInfo()
    {
        return $this->container['outputFileInfo'];
    }

    /**
    * Sets outputFileInfo
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\OutputFileInfo[]|null $outputFileInfo 剪辑输出meta信息
    *
    * @return $this
    */
    public function setOutputFileInfo($outputFileInfo)
    {
        $this->container['outputFileInfo'] = $outputFileInfo;
        return $this;
    }
