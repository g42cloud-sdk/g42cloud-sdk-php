...
class ListAllObsObjListResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'objects' => '\G42Cloud\SDK\Mpc\V1\Model\ObsObject[]'
    ];
    ...
    *  返回OBS对象组
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ObsObject[]|null
    */
    ...
    * Sets objects
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ObsObject[]|null $objects 返回OBS对象组
    *
    * @return $this
    */
