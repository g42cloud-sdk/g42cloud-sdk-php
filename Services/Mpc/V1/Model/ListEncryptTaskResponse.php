...
class ListEncryptTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEncryptTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\EachEncryptRsp[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['isTruncated']) && ($this->container['isTruncated'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'isTruncated', must be smaller than or equal to 2147483647.";
            }
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\EachEncryptRsp[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\EachEncryptRsp[]|null $taskArray 任务列表
    *
    * @return $this
    */
    ...
    * Sets isTruncated
    *
    * @param int|null $isTruncated 是否截断
    *
    * @return $this
    */
