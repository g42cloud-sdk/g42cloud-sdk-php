...
class ListMediaProcessTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMediaProcessTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\MediaProcessTaskInfo[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MediaProcessTaskInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MediaProcessTaskInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
