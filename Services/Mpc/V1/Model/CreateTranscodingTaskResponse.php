...
class CreateTranscodingTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['taskId']) && ($this->container['taskId'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'taskId', must be smaller than or equal to 2147483647.";
            }
            if (!is_null($this->container['taskId']) && ($this->container['taskId'] < 0)) {
    ...
    * Sets taskId
    *
    * @param int|null $taskId 任务ID。 如果返回值为200 OK，为接受任务后产生的任务ID。
    *
    * @return $this
    */
