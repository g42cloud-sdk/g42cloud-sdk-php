...
class ListTranscodeDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTranscodeDetailResponse';
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\TaskDetailInfo[]'
    ];
    ...
    *  转码详情任务组
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\TaskDetailInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\TaskDetailInfo[]|null $taskArray 转码详情任务组
    *
    * @return $this
    */
