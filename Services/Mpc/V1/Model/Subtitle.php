...
class Subtitle implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'inputs' => '\G42Cloud\SDK\Mpc\V1\Model\MulInputFileInfo[]',
            'subtitleType' => 'int'
    ];
    ...
    *  多字幕文件地址。
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MulInputFileInfo[]|null
    */
    ...
    * Sets inputs
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MulInputFileInfo[]|null $inputs 多字幕文件地址。
    *
    * @return $this
    */
