...
class MbTasksReportReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'taskName' => 'string',
            'retry' => 'bool',
            'parameter' => '\G42Cloud\SDK\Mpc\V1\Model\MbTaskParameter'
    ];
    ...
    *  parameter
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MbTaskParameter|null
    */
    ...
    * Sets parameter
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MbTaskParameter|null $parameter parameter
    *
    * @return $this
    */
