...
class CreateQualityEnhanceTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateQualityEnhanceTemplateResponse';
