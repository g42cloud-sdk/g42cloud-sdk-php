...
class QualityEnhanceVideo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'videoDenoise' => '\G42Cloud\SDK\Mpc\V1\Model\VideoDenoise',
            'videoSharp' => '\G42Cloud\SDK\Mpc\V1\Model\VideoSharp',
            'videoContrast' => '\G42Cloud\SDK\Mpc\V1\Model\VideoContrast',
            'videoSuperresolution' => '\G42Cloud\SDK\Mpc\V1\Model\VideoSuperresolution',
            'videoDeblock' => '\G42Cloud\SDK\Mpc\V1\Model\VideoDeblock',
            'videoSaturation' => '\G42Cloud\SDK\Mpc\V1\Model\VideoSaturation'
    ];
    ...
    *  videoDenoise
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoDenoise|null
    */
    ...
    * Sets videoDenoise
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoDenoise|null $videoDenoise videoDenoise
    *
    * @return $this
    */
    ...
    *  videoSharp
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoSharp|null
    */
    ...
    * Sets videoSharp
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoSharp|null $videoSharp videoSharp
    *
    * @return $this
    */
    ...
    *  videoContrast
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoContrast|null
    */
    ...
    * Sets videoContrast
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoContrast|null $videoContrast videoContrast
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoSuperresolution|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoSuperresolution|null $videoSuperresolution videoSuperresolution
    *
    * @return $this
    */
    ...
    *  videoDeblock
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoDeblock|null
    */
    ...
    * Sets videoDeblock
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoDeblock|null $videoDeblock videoDeblock
    *
    * @return $this
    */
    ...
    *  videoSaturation
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoSaturation|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoSaturation|null $videoSaturation videoSaturation
    *
    * @return $this
    */
