...
class ListExtractTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListExtractTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'tasks' => '\G42Cloud\SDK\Mpc\V1\Model\ExtractTask[]'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ExtractTask[]|null
    */
    ...
    * Sets tasks
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ExtractTask[]|null $tasks 任务列表
    *
    * @return $this
    */
