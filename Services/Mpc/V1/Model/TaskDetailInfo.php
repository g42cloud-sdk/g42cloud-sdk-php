...
class TaskDetailInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'description' => 'string',
            'mediaDetail' => '\G42Cloud\SDK\Mpc\V1\Model\MediaDetail',
            'xcodeError' => '\G42Cloud\SDK\Mpc\V1\Model\ErrorResponse'
    ];
    ...
    *  mediaDetail
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MediaDetail|null
    */
    ...
    * Sets mediaDetail
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MediaDetail|null $mediaDetail mediaDetail
    *
    * @return $this
    */
    ...
    *  xcodeError
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\ErrorResponse|null
    */
    ...
    * Sets xcodeError
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ErrorResponse|null $xcodeError xcodeError
    *
    * @return $this
    */
