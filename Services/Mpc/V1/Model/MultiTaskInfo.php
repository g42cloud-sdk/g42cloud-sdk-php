...
class MultiTaskInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'templateId' => 'int',
            'error' => '\G42Cloud\SDK\Mpc\V1\Model\ErrorResponse',
            'outputFile' => '\G42Cloud\SDK\Mpc\V1\Model\SourceInfo'
    ];
    ...
    * Sets error
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ErrorResponse|null $error error
    *
    * @return $this
    */
    ...
    * Sets outputFile
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\SourceInfo|null $outputFile outputFile
    *
    * @return $this
    */
