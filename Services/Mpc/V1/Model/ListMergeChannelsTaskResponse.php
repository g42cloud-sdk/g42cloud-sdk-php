...
class ListMergeChannelsTaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskArray' => '\G42Cloud\SDK\Mpc\V1\Model\MergeChannelsTaskInfo[]',
            'isTruncated' => 'int',
            'total' => 'int'
    ];
    ...
    *  任务列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MergeChannelsTaskInfo[]|null
    */
    ...
    * Sets taskArray
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MergeChannelsTaskInfo[]|null $taskArray 任务列表
    *
    * @return $this
    */
