...
class EditSetting implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'timelineEnd' => 'string',
            'transTemplateId' => 'int',
            'avParameter' => '\G42Cloud\SDK\Mpc\V1\Model\AvParameters',
            'mosaics' => '\G42Cloud\SDK\Mpc\V1\Model\MosaicInfo[]',
            'imageWatermarks' => '\G42Cloud\SDK\Mpc\V1\Model\ImageWatermarkSetting[]',
            'heads' => '\G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo[]',
            'tails' => '\G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo[]',
    ...
    * Sets avParameter
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\AvParameters|null $avParameter avParameter
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\MosaicInfo[]|null
    */
    ...
    * Sets mosaics
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\MosaicInfo[]|null $mosaics 马赛克（模糊处理）配置，会对input指定的源文件进行马赛克处理，马赛克基于视频左上角为参考位置
    *
    * @return $this
    */
    ...
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ImageWatermarkSetting[]|null $imageWatermarks 图片水印配置，会对input指定的源文件进行马赛克处理。水印设置参数里面的overlay_input字段不填
    *
    * @return $this
    */
    ...
    * Sets heads
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo[]|null $heads 头部文件列表，需要指定文件名。列表内文件会按照顺序拼接在input指定文件的前面
    *
    * @return $this
    */
    ...
    * Sets tails
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\ObsObjInfo[]|null $tails 尾部文件列表，需要指定文件名。列表内文件会按照顺序拼接在input指定文件的后面
    *
    * @return $this
    */
