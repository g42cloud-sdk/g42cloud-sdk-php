...
class Encryption implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'hlsEncrypt' => '\G42Cloud\SDK\Mpc\V1\Model\HlsEncrypt'
    ];
    ...
    *  hlsEncrypt
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\HlsEncrypt|null
    */
    ...
    * Sets hlsEncrypt
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\HlsEncrypt|null $hlsEncrypt hlsEncrypt
    *
    * @return $this
    */
