...
class TemplateGroup implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'templateIds' => 'int[]',
            'videos' => '\G42Cloud\SDK\Mpc\V1\Model\VideoAndTemplate[]',
            'audio' => '\G42Cloud\SDK\Mpc\V1\Model\Audio',
            'videoCommon' => '\G42Cloud\SDK\Mpc\V1\Model\VideoCommon',
            'common' => '\G42Cloud\SDK\Mpc\V1\Model\Common'
    ];
    ...
    * Sets templateIds
    *
    * @param int[]|null $templateIds 模板组模板ID
    *
    * @return $this
    */
    ...
    *  视频信息列表
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoAndTemplate[]|null
    */
    ...
    * Sets videos
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoAndTemplate[]|null $videos 视频信息列表
    *
    * @return $this
    */
    ...
    *  audio
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\Audio|null
    */
    ...
    * Sets audio
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\Audio|null $audio audio
    *
    * @return $this
    */
    ...
    *  videoCommon
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\VideoCommon|null
    */
    ...
    * Sets videoCommon
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\VideoCommon|null $videoCommon videoCommon
    *
    * @return $this
    */
    ...
    *  common
    *
    * @return \G42Cloud\SDK\Mpc\V1\Model\Common|null
    */
    ...
    * Sets common
    *
    * @param \G42Cloud\SDK\Mpc\V1\Model\Common|null $common common
    *
    * @return $this
    */
