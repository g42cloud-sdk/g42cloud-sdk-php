...
class CreateExtractTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateExtractTaskResponse';
    ...
    * createTime  任务创建时间
    * output  output
    * outputFileName  解析文件名称
    * description  任务描述，如当任务异常时，此字段为异常的具体信息
    * metadata  metadata
    *
    * @var string[]
    */
    ...
    * Sets outputFileName
    *
    * @param string|null $outputFileName 解析文件名称
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 任务描述，如当任务异常时，此字段为异常的具体信息
    *
    * @return $this
    */
