...
class ListTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTemplateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * templateId  自定义转码模板ID，最多10个
    ...
    * Sets templateId
    *
    * @param int[]|null $templateId 自定义转码模板ID，最多10个
    *
    * @return $this
    */
