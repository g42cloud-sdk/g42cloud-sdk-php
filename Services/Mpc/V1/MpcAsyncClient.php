...
class MpcAsyncClient extends Client
{
    ...
    {
        return new ClientBuilder(new MpcAsyncClient());
    }
    ...
    public function createAnimatedGraphicsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateAnimatedGraphicsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateAnimatedGraphicsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteAnimatedGraphicsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteAnimatedGraphicsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteAnimatedGraphicsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listAnimatedGraphicsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListAnimatedGraphicsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListAnimatedGraphicsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createAgenciesTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateAgenciesTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateAgenciesTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listAllBucketsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListAllBucketsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListAllBucketsRequest',
            $asyncRequest = true);
    }
    ...
    public function listAllObsObjListAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListAllObsObjListResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListAllObsObjListRequest',
            $asyncRequest = true);
    }
    ...
    public function listNotifyEventAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListNotifyEventResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListNotifyEventRequest',
            $asyncRequest = true);
    }
    ...
    public function listNotifySmnTopicConfigAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListNotifySmnTopicConfigResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListNotifySmnTopicConfigRequest',
            $asyncRequest = true);
    }
    ...
    public function notifySmnTopicConfigAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\NotifySmnTopicConfigResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\NotifySmnTopicConfigRequest',
            $asyncRequest = true);
    }
    ...
    public function showAgenciesTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ShowAgenciesTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ShowAgenciesTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function updateBucketAuthorizedAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\UpdateBucketAuthorizedResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\UpdateBucketAuthorizedRequest',
            $asyncRequest = true);
    }
    ...
    public function createEditingJobAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateEditingJobResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateEditingJobRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteEditingJobAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteEditingJobResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteEditingJobRequest',
            $asyncRequest = true);
    }
    ...
    public function listEditingJobAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListEditingJobResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListEditingJobRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function createEncryptTaskAsync($request)
    {
        return $this->createEncryptTaskAsyncWithHttpInfo($request);
    }
    
    public function createEncryptTaskAsyncWithHttpInfo($request){
        $collection_formats = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateEncryptTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateEncryptTaskRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function deleteEncryptTaskAsync($request)
    {
        return $this->deleteEncryptTaskAsyncWithHttpInfo($request);
    }
    
    public function deleteEncryptTaskAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/encryptions';
        $formParams = [];
        $queryParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteEncryptTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteEncryptTaskRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function listEncryptTaskAsync($request)
    {
        return $this->listEncryptTaskAsyncWithHttpInfo($request);
    }
    
    public function listEncryptTaskAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/encryptions';
        $formParams = [];
        $queryParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListEncryptTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListEncryptTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createExtractTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateExtractTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateExtractTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteExtractTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteExtractTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteExtractTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listExtractTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListExtractTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListExtractTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createMbTasksReportAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateMbTasksReportResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateMbTasksReportRequest',
            $asyncRequest = true);
    }
    ...
    public function createMergeChannelsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateMergeChannelsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateMergeChannelsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createResetTracksTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateResetTracksTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateResetTracksTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteMergeChannelsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteMergeChannelsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteMergeChannelsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteResetTracksTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteResetTracksTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteResetTracksTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listMergeChannelsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListMergeChannelsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListMergeChannelsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listResetTracksTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListResetTracksTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListResetTracksTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createMediaProcessTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateMediaProcessTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateMediaProcessTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteMediaProcessTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteMediaProcessTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteMediaProcessTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listMediaProcessTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListMediaProcessTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListMediaProcessTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createMpeCallBackAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateMpeCallBackResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateMpeCallBackRequest',
            $asyncRequest = true);
    }
    ...
    public function createQualityEnhanceTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateQualityEnhanceTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateQualityEnhanceTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteQualityEnhanceTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteQualityEnhanceTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteQualityEnhanceTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function listQualityEnhanceDefaultTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListQualityEnhanceDefaultTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListQualityEnhanceDefaultTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function updateQualityEnhanceTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\UpdateQualityEnhanceTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\UpdateQualityEnhanceTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function listTranscodeDetailAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListTranscodeDetailResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListTranscodeDetailRequest',
            $asyncRequest = true);
    }
    ...
    public function cancelRemuxTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CancelRemuxTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CancelRemuxTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createRemuxTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateRemuxTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateRemuxTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createRetryRemuxTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateRetryRemuxTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateRetryRemuxTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteRemuxTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteRemuxTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteRemuxTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listRemuxTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListRemuxTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListRemuxTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createTemplateGroupAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateTemplateGroupResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateTemplateGroupRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteTemplateGroupAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTemplateGroupResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTemplateGroupRequest',
            $asyncRequest = true);
    }
    ...
    public function listTemplateGroupAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListTemplateGroupResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListTemplateGroupRequest',
            $asyncRequest = true);
    }
    ...
    public function updateTemplateGroupAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\UpdateTemplateGroupResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\UpdateTemplateGroupRequest',
            $asyncRequest = true);
    }
    ...
    public function createThumbnailsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateThumbnailsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateThumbnailsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteThumbnailsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteThumbnailsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteThumbnailsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function listThumbnailsTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListThumbnailsTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListThumbnailsTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createTranscodingTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateTranscodingTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateTranscodingTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteTranscodingTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTranscodingTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTranscodingTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteTranscodingTaskByConsoleAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTranscodingTaskByConsoleResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTranscodingTaskByConsoleRequest',
            $asyncRequest = true);
    }
    ...
    public function listStatSummaryAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListStatSummaryResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListStatSummaryRequest',
            $asyncRequest = true);
    }
    ...
    public function listTranscodingTaskAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListTranscodingTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListTranscodingTaskRequest',
            $asyncRequest = true);
    }
    ...
    public function createTransTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateTransTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateTransTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function listTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function updateTransTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\UpdateTransTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\UpdateTransTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function createWatermarkTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\CreateWatermarkTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\CreateWatermarkTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteWatermarkTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\DeleteWatermarkTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\DeleteWatermarkTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function listWatermarkTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\ListWatermarkTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\ListWatermarkTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function updateWatermarkTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Mpc\V1\Model\UpdateWatermarkTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Mpc\V1\Model\UpdateWatermarkTemplateRequest',
            $asyncRequest = true);
    }
