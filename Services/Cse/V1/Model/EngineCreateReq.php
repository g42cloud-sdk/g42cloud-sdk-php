...
class EngineCreateReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'subnetCidr' => 'string',
            'publicIpId' => 'string',
            'authCred' => '\G42Cloud\SDK\Cse\V1\Model\EngineRbacPwd',
            'specType' => 'string',
    ...
    */
    ...
    const PAYMENT__1 = '1';
    const FLAVOR_CSE_S1_SMALL = 'cse.s1.small';
    const FLAVOR_CSE_S1_MEDIUM = 'cse.s1.medium';
    const FLAVOR_CSE_S1_LARGE = 'cse.s1.large';
    const FLAVOR_CSE_S1_XLARGE = 'cse.s1.xlarge';
    ...
    */
    ...
    {
        return [
            self::FLAVOR_CSE_S1_SMALL,
            self::FLAVOR_CSE_S1_MEDIUM,
            self::FLAVOR_CSE_S1_LARGE,
            self::FLAVOR_CSE_S1_XLARGE,
        ];
    }
    ...
    *  authCred
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\EngineRbacPwd|null
    */
    ...
    * Sets authCred
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\EngineRbacPwd|null $authCred authCred
    *
    * @return $this
    */
