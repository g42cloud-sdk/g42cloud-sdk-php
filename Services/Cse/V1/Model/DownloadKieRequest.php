...
class DownloadKieRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'label' => 'string',
            'match' => 'string',
            'body' => '\G42Cloud\SDK\Cse\V1\Model\DownloadKieReqBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\DownloadKieReqBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\DownloadKieReqBody|null $body body
    *
    * @return $this
    */
