...
class Spec implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'cluster' => 'string',
            'clusterId' => 'string',
            'clusterNodes' => '\G42Cloud\SDK\Cse\V1\Model\SpecClusterNode',
            'flavor' => 'string',
            'region' => 'string',
            'version' => 'string',
            'extendParam' => 'string'
    ...
    *  clusterNodes
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\SpecClusterNode|null
    */
    ...
    * Sets clusterNodes
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\SpecClusterNode|null $clusterNodes clusterNodes
    *
    * @return $this
    */
