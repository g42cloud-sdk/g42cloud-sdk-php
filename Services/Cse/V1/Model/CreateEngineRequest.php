...
class CreateEngineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEngineRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Cse\V1\Model\EngineCreateReq'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\EngineCreateReq|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\EngineCreateReq|null $body body
    *
    * @return $this
    */
