...
class UploadKieRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'override' => 'string',
            'label' => 'string',
            'body' => '\G42Cloud\SDK\Cse\V1\Model\UploadKieRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\UploadKieRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\UploadKieRequestBody|null $body body
    *
    * @return $this
    */
