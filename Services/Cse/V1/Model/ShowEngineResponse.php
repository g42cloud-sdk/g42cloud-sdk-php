...
class ShowEngineResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'createUser' => 'string',
            'createTime' => 'int',
            'cceSpec' => '\G42Cloud\SDK\Cse\V1\Model\Spec',
            'externalEntrypoint' => '\G42Cloud\SDK\Cse\V1\Model\EngineExternalEntrypoint',
    ...
    *  cceSpec
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\Spec|null
    */
    ...
    * Sets cceSpec
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\Spec|null $cceSpec cceSpec
    *
    * @return $this
    */
    ...
    *  externalEntrypoint
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\EngineExternalEntrypoint|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\EngineExternalEntrypoint|null $externalEntrypoint externalEntrypoint
    *
    * @return $this
    */
