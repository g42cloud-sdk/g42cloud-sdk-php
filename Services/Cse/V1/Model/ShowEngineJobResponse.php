...
class ShowEngineJobResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'endTime' => 'int',
            'context' => 'string',
            'tasks' => '\G42Cloud\SDK\Cse\V1\Model\TaskSteps[]'
    ];
    ...
    *  任务包含的处理阶段
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\TaskSteps[]|null
    */
    ...
    * Sets tasks
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\TaskSteps[]|null $tasks 任务包含的处理阶段
    *
    * @return $this
    */
