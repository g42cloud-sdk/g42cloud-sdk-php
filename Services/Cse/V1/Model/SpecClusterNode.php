...
class SpecClusterNode implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SpecClusterNode';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterNodes  CCE节点信息。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'clusterNodes' => '\G42Cloud\SDK\Cse\V1\Model\ClusterNode[]'
    ];
    ...
    *  CCE节点信息。
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\ClusterNode[]|null
    */
    ...
    * Sets clusterNodes
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\ClusterNode[]|null $clusterNodes CCE节点信息。
    *
    * @return $this
    */
