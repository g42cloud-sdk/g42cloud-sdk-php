...
class UploadKieRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadKieRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * uploadFile  导入文件内容的格式必须为键值对映射，例如:{\"data\":[{\"key1\":\"value1\",\"key2\":\"value2\"}]}}
    *
    * @var string[]
    */
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile 导入文件内容的格式必须为键值对映射，例如:{\"data\":[{\"key1\":\"value1\",\"key2\":\"value2\"}]}}
    *
    * @return $this
    */
