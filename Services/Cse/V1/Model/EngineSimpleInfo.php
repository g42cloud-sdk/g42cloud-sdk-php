...
class EngineSimpleInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'serviceEndpoint' => 'map[string,\G42Cloud\SDK\Cse\V1\Model\EntrypointItem]',
            'publicAddress' => 'string',
            'publicServiceEndpoint' => 'map[string,\G42Cloud\SDK\Cse\V1\Model\EntrypointItem]',
            'totalInstance' => 'int',
            'usedInstance' => 'int',
            ...
            'specType' => 'string',
            'reference' => '\G42Cloud\SDK\Cse\V1\Model\EngineReference'
    ];
    ...
    *  微服务引擎专享版组件的访问地址。
    *
    * @return map[string,\G42Cloud\SDK\Cse\V1\Model\EntrypointItem]|null
    */
    ...
    *
    * @param map[string,\G42Cloud\SDK\Cse\V1\Model\EntrypointItem]|null $serviceEndpoint 微服务引擎专享版组件的访问地址。
    *
    * @return $this
    */
    ...
    *
    * @param map[string,\G42Cloud\SDK\Cse\V1\Model\EntrypointItem]|null $publicServiceEndpoint 微服务引擎专享版的公网接入地址
    *
    * @return $this
    */
    ...
    *  reference
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\EngineReference|null
    */
    ...
    * Sets reference
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\EngineReference|null $reference reference
    *
    * @return $this
    */
