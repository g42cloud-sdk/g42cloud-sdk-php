...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'data' => '\G42Cloud\SDK\Cse\V1\Model\FlavorBrief[]'
    ];
    ...
    * Sets total
    *
    * @param int|null $total 微服务引擎专享版规格总个数
    *
    * @return $this
    */
    ...
    *  微服务引擎专享版规格详情
    *
    * @return \G42Cloud\SDK\Cse\V1\Model\FlavorBrief[]|null
    */
    ...
    * Sets data
    *
    * @param \G42Cloud\SDK\Cse\V1\Model\FlavorBrief[]|null $data 微服务引擎专享版规格详情
    *
    * @return $this
    */
