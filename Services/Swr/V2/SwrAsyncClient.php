...
class SwrAsyncClient extends Client
{
    ...
    public function createImageSyncRepoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateImageSyncRepoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequest',
            $asyncRequest = true);
    }
    ...
    public function createManualImageSyncRepoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateManualImageSyncRepoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateManualImageSyncRepoRequest',
            $asyncRequest = true);
    }
    ...
    public function createNamespaceAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateNamespaceResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateNamespaceRequest',
            $asyncRequest = true);
    }
    ...
    public function createNamespaceAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateNamespaceAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateNamespaceAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function createRepoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateRepoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateRepoRequest',
            $asyncRequest = true);
    }
    ...
    public function createRepoDomainsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateRepoDomainsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateRepoDomainsRequest',
            $asyncRequest = true);
    }
    ...
    public function createRetentionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateRetentionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateRetentionRequest',
            $asyncRequest = true);
    }
    ...
    public function createSecretAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateSecretResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateSecretRequest',
            $asyncRequest = true);
    }
    ...
    public function createTriggerAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateTriggerResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateTriggerRequest',
            $asyncRequest = true);
    }
    ...
    public function createUserRepositoryAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\CreateUserRepositoryAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\CreateUserRepositoryAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteImageSyncRepoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteImageSyncRepoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteImageSyncRepoRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteNamespaceAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteNamespaceAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteNamespaceAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteNamespacesAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteNamespacesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteNamespacesRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteRepoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteRepoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteRepoRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteRepoDomainsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteRepoDomainsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteRepoDomainsRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteRepoTagAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteRepoTagResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteRepoTagRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteRetentionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteRetentionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteRetentionRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteTriggerAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteTriggerResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteTriggerRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteUserRepositoryAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\DeleteUserRepositoryAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\DeleteUserRepositoryAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function listImageAutoSyncReposDetailsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListImageAutoSyncReposDetailsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListImageAutoSyncReposDetailsRequest',
            $asyncRequest = true);
    }
    ...
    public function listNamespacesAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListNamespacesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListNamespacesRequest',
            $asyncRequest = true);
    }
    ...
    public function listQuotasAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListQuotasResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListQuotasRequest',
            $asyncRequest = true);
    }
    ...
    public function listRepoDomainsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListRepoDomainsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListRepoDomainsRequest',
            $asyncRequest = true);
    }
    ...
    public function listReposDetailsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListReposDetailsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListReposDetailsRequest',
            $asyncRequest = true);
    }
    ...
    public function listRepositoryTagsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListRepositoryTagsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListRepositoryTagsRequest',
            $asyncRequest = true);
    }
    ...
    public function listRetentionHistoriesAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListRetentionHistoriesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListRetentionHistoriesRequest',
            $asyncRequest = true);
    }
    ...
    public function listRetentionsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListRetentionsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListRetentionsRequest',
            $asyncRequest = true);
    }
    ...
    public function listSharedReposDetailsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListSharedReposDetailsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListSharedReposDetailsRequest',
            $asyncRequest = true);
    }
    ...
    public function listTriggersDetailsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListTriggersDetailsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListTriggersDetailsRequest',
            $asyncRequest = true);
    }
    ...
    public function showAccessDomainAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowAccessDomainResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowAccessDomainRequest',
            $asyncRequest = true);
    }
    ...
    public function showNamespaceAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowNamespaceResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowNamespaceRequest',
            $asyncRequest = true);
    }
    ...
    public function showNamespaceAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowNamespaceAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowNamespaceAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function showRepositoryAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowRepositoryResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowRepositoryRequest',
            $asyncRequest = true);
    }
    ...
    public function showRetentionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowRetentionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowRetentionRequest',
            $asyncRequest = true);
    }
    ...
    public function showSyncJobAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowSyncJobResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowSyncJobRequest',
            $asyncRequest = true);
    }
    ...
    public function showTriggerAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowTriggerResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowTriggerRequest',
            $asyncRequest = true);
    }
    ...
    public function showUserRepositoryAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowUserRepositoryAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowUserRepositoryAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function updateNamespaceAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\UpdateNamespaceAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\UpdateNamespaceAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function updateRepoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\UpdateRepoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\UpdateRepoRequest',
            $asyncRequest = true);
    }
    ...
    public function updateRepoDomainsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\UpdateRepoDomainsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequest',
            $asyncRequest = true);
    }
    ...
    public function updateRetentionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\UpdateRetentionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\UpdateRetentionRequest',
            $asyncRequest = true);
    }
    ...
    public function updateTriggerAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\UpdateTriggerResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\UpdateTriggerRequest',
            $asyncRequest = true);
    }
    ...
    public function updateUserRepositoryAuthAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\UpdateUserRepositoryAuthResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\UpdateUserRepositoryAuthRequest',
            $asyncRequest = true);
    }
    ...
    public function listApiVersionsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ListApiVersionsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ListApiVersionsRequest',
            $asyncRequest = true);
    }
    ...
    public function showApiVersionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Swr\V2\Model\ShowApiVersionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Swr\V2\Model\ShowApiVersionRequest',
            $asyncRequest = true);
    }
