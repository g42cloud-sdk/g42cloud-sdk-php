...
class CreateRetentionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRetentionRequest';
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\CreateRetentionRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\CreateRetentionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\CreateRetentionRequestBody|null $body body
    *
    * @return $this
    */
