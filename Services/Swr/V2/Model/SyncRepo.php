...
class SyncRepo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SyncRepo';
    ...
    * repoName  仓库名
    * syncAuto  自动同步
    * updatedAt  更新时间，UTC日期格式，时间为UTC标准时间，用户需要根据本地时间计算偏移量；如东8区需要+8:00
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['syncAuto'] = isset($data['syncAuto']) ? $data['syncAuto'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['syncAuto'] === null) {
            $invalidProperties[] = "'syncAuto' can't be null";
        }
    ...
    * @return bool
    */
    public function getSyncAuto()
    {
        return $this->container['syncAuto'];
    }

    /**
    * Sets syncAuto
    *
    * @param bool $syncAuto 自动同步
    *
    * @return $this
    */
    public function setSyncAuto($syncAuto)
    {
        $this->container['syncAuto'] = $syncAuto;
        return $this;
    }
    ...
    * Sets updatedAt
    *
    * @param string $updatedAt 更新时间，UTC日期格式，时间为UTC标准时间，用户需要根据本地时间计算偏移量；如东8区需要+8:00
    *
    * @return $this
    */
