...
class UpdateRetentionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'repository' => 'string',
            'retentionId' => 'int',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\UpdateRetentionRequestBody'
    ];
    ...
    * Sets retentionId
    *
    * @param int $retentionId 镜像老化规则id
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\UpdateRetentionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\UpdateRetentionRequestBody|null $body body
    *
    * @return $this
    */
