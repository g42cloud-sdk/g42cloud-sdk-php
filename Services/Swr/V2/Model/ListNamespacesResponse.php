...
class ListNamespacesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNamespacesResponse';
    ...
    */
    protected static $openAPITypes = [
            'namespaces' => '\G42Cloud\SDK\Swr\V2\Model\ShowNamespace[]'
    ];
    ...
    *  组织列表
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\ShowNamespace[]|null
    */
    ...
    * Sets namespaces
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\ShowNamespace[]|null $namespaces 组织列表
    *
    * @return $this
    */
