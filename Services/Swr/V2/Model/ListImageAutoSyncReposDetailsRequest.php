...
class ListImageAutoSyncReposDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageAutoSyncReposDetailsRequest';
