...
class ListRepositoryTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRepositoryTagsResponse';
    ...
    */
    protected static $openAPITypes = [
            'body' => '\G42Cloud\SDK\Swr\V2\Model\ShowReposTagResp[]',
            'contentRange' => 'string'
    ];
    ...
    *  镜像tag列表
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\ShowReposTagResp[]|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\ShowReposTagResp[]|null $body 镜像tag列表
    *
    * @return $this
    */
