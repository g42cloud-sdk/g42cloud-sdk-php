...
class CreateRetentionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRetentionRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * algorithm  回收规则匹配策略，固定为\"or\"
    * rules  镜像老化规则
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'algorithm' => 'string',
            'rules' => '\G42Cloud\SDK\Swr\V2\Model\Rule[]'
    ];
    ...
    * Sets algorithm
    *
    * @param string $algorithm 回收规则匹配策略，固定为\"or\"
    *
    * @return $this
    */
    ...
    *  镜像老化规则
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\Rule[]
    */
    ...
    * Sets rules
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\Rule[] $rules 镜像老化规则
    *
    * @return $this
    */
