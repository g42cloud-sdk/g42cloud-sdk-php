...
class Retention implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Retention';
    ...
    * Sets algorithm
    *
    * @param string $algorithm 回收规则匹配策略，or
    *
    * @return $this
    */
