...
class TagSelector implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TagSelector';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * kind  匹配规则，label、regexp
    ...
    * Sets kind
    *
    * @param string $kind 匹配规则，label、regexp
    *
    * @return $this
    */
    ...
    * Sets pattern
    *
    * @param string $pattern kind是label时，设置为镜像版本,kind是regexp时，设置为正则表达式
    *
    * @return $this
    */
