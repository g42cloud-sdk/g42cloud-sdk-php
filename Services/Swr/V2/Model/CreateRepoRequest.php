...
class CreateRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\CreateRepoRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\CreateRepoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\CreateRepoRequestBody|null $body body
    *
    * @return $this
    */
