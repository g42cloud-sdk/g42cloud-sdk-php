...
class Rule implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'template' => 'string',
            'params' => 'object',
            'tagSelectors' => '\G42Cloud\SDK\Swr\V2\Model\TagSelector[]'
    ];
    ...
    *  例外镜像
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\TagSelector[]
    */
    ...
    * Sets tagSelectors
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\TagSelector[] $tagSelectors 例外镜像
    *
    * @return $this
    */
