...
class ListRetentionHistoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRetentionHistoriesRequest';
    ...
    * Sets filter
    *
    * @param string|null $filter 应填写 limit::{limit}|offset::{offset}, 其中{limit}为返回条数,{offset}为起始索引, 注意：offset和limit参数需要配套使用
    *
    * @return $this
    */
