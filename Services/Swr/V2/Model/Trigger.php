...
class Trigger implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'enable' => 'string',
            'name' => 'string',
            'triggerHistory' => '\G42Cloud\SDK\Swr\V2\Model\TriggerHistories[]',
            'triggerMode' => 'string',
            'triggerType' => 'string'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['triggerHistory'] === null) {
            $invalidProperties[] = "'triggerHistory' can't be null";
        }
        if ($this->container['triggerMode'] === null) {
            $invalidProperties[] = "'triggerMode' can't be null";
        }
    ...
    *  触发器历史
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\TriggerHistories[]
    */
    ...
    * Sets triggerHistory
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\TriggerHistories[] $triggerHistory 触发器历史
    *
    * @return $this
    */
    ...
    * Sets triggerMode
    *
    * @param string $triggerMode 触发器类型，cce、cci
    *
    * @return $this
    */
