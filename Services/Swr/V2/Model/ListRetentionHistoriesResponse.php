...
class ListRetentionHistoriesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'retentionLog' => '\G42Cloud\SDK\Swr\V2\Model\RetentionLog[]',
            'total' => 'int',
            'contentRange' => 'string'
    ];
    ...
    *  镜像老化日志
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\RetentionLog[]|null
    */
    ...
    * Sets retentionLog
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\RetentionLog[]|null $retentionLog 镜像老化日志
    *
    * @return $this
    */
