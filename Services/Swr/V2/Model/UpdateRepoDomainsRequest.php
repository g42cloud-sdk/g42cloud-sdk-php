...
class UpdateRepoDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRepoDomainsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'repository' => 'string',
            'accessDomain' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\UpdateRepoDomainsRequestBody|null $body body
    *
    * @return $this
    */
