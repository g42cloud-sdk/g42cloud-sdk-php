...
class CreateSecretResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'auths' => 'map[string,\G42Cloud\SDK\Swr\V2\Model\AuthInfo]',
    ...
    *  认证信息
    *
    * @return map[string,\G42Cloud\SDK\Swr\V2\Model\AuthInfo]|null
    */
    ...
    * Sets auths
    *
    * @param map[string,\G42Cloud\SDK\Swr\V2\Model\AuthInfo]|null $auths 认证信息
    *
    * @return $this
    */
