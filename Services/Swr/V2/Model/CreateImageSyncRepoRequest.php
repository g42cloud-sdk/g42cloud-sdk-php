...
class CreateImageSyncRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateImageSyncRepoRequest';
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\CreateImageSyncRepoRequestBody|null $body body
    *
    * @return $this
    */
