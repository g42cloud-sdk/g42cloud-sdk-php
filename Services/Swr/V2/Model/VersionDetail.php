...
class VersionDetail implements ModelInterface, ArrayAccess
{
    ...
    * updated  版本发布时间，要求用UTC时间表示。如v1发布的时间2014-06-28T12:20:21Z。
    * minVersion  若该版本API 支持微版本，则填支持的最小微版本号， 如果不支持微版本，则填空。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'links' => '\G42Cloud\SDK\Swr\V2\Model\Link',
            'version' => 'string',
            'status' => 'string',
            'updated' => 'string',
            'minVersion' => 'string'
    ...
    *  links
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\Link
    */
    ...
    * Sets links
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\Link $links links
    *
    * @return $this
    */
    ...
    * Sets version
    *
    * @param string $version 若该版本API支持微版本，则填支持的最大微版本号，如果不支持微版本，则填空。
    *
    * @return $this
    */
    ...
    * Sets updated
    *
    * @param string $updated 版本发布时间，要求用UTC时间表示。如v1发布的时间2014-06-28T12:20:21Z。
    *
    * @return $this
    */
    ...
    * Sets minVersion
    *
    * @param string $minVersion 若该版本API 支持微版本，则填支持的最小微版本号， 如果不支持微版本，则填空。
    *
    * @return $this
    */
