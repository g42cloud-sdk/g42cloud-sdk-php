...
class CreateTriggerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTriggerRequest';
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\CreateTriggerRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\CreateTriggerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\CreateTriggerRequestBody|null $body body
    *
    * @return $this
    */
