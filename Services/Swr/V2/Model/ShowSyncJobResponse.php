...
class ShowSyncJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSyncJobResponse';
    ...
    */
    protected static $openAPITypes = [
            'body' => '\G42Cloud\SDK\Swr\V2\Model\SyncJob[]',
            'contentRange' => 'string'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\SyncJob[]|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\SyncJob[]|null $body body
    *
    * @return $this
    */
