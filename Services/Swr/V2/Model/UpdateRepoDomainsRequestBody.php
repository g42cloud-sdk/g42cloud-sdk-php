...
class UpdateRepoDomainsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRepoDomainsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * permit  当前只支持read权限
    * deadline  截止时间，UTC时间格式。永久有效为forever
    * description  描述。默认值为空字符串
    *
    * @var string[]
    */
    ...
    * Sets description
    *
    * @param string|null $description 描述。默认值为空字符串
    *
    * @return $this
    */
