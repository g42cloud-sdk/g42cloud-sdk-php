...
class CreateRepoDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRepoDomainsRequest';
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\CreateRepoDomainsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\CreateRepoDomainsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\CreateRepoDomainsRequestBody|null $body body
    *
    * @return $this
    */
