...
class CreateUserRepositoryAuthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateUserRepositoryAuthRequest';
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\UserAuth[]'
    ];
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\UserAuth[]|null $body body
    *
    * @return $this
    */
