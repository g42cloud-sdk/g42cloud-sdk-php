...
class CreateManualImageSyncRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateManualImageSyncRepoRequest';
    ...
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'repository' => 'string',
            'body' => '\G42Cloud\SDK\Swr\V2\Model\CreateManualImageSyncRepoRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\CreateManualImageSyncRepoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\CreateManualImageSyncRepoRequestBody|null $body body
    *
    * @return $this
    */
