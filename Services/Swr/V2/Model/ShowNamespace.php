...
class ShowNamespace implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowNamespace';
    ...
    * Sets name
    *
    * @param string $name 组织名称。小写字母开头，后面跟小写字母、数字、小数点、下划线或中划线（其中下划线最多允许连续两个，小数点、下划线、中划线不能直接相连），小写字母或数字结尾，1-64个字符。
    *
    * @return $this
    */
    ...
    * Sets creatorName
    *
    * @param string $creatorName IAM用户名
    *
    * @return $this
    */
