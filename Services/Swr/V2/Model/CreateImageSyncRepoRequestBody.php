...
class CreateImageSyncRepoRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateImageSyncRepoRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * remoteRegionId  目标region ID。
    * remoteNamespace  目标组织
    * syncAuto  自动同步，默认为false
    ...
    * Sets syncAuto
    *
    * @param bool|null $syncAuto 自动同步，默认为false
    *
    * @return $this
    */
