...
class ShowNamespaceAuthResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowNamespaceAuthResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'creatorName' => 'string',
            'selfAuth' => '\G42Cloud\SDK\Swr\V2\Model\UserAuth',
            'othersAuths' => '\G42Cloud\SDK\Swr\V2\Model\UserAuth[]'
    ];
    ...
    * Sets creatorName
    *
    * @param string|null $creatorName 组织创建者
    *
    * @return $this
    */
    ...
    *  selfAuth
    *
    * @return \G42Cloud\SDK\Swr\V2\Model\UserAuth|null
    */
    ...
    * Sets selfAuth
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\UserAuth|null $selfAuth selfAuth
    *
    * @return $this
    */
    ...
    * Sets othersAuths
    *
    * @param \G42Cloud\SDK\Swr\V2\Model\UserAuth[]|null $othersAuths 其他用户的权限
    *
    * @return $this
    */
