...
class ListResourceInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\ListInstanceRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\ListInstanceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ListInstanceRequestBody|null $body body
    *
    * @return $this
    */
