...
class PublishMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublishMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\PublishMessageRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\PublishMessageRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\PublishMessageRequestBody|null $body body
    *
    * @return $this
    */
