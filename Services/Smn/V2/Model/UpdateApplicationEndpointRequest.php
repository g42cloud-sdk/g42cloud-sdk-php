...
class UpdateApplicationEndpointRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationEndpointRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * endpointUrn  Endpoint的唯一资源标识，可通过[查询Application的Endpoint列表](https://support.huaweicloud.com/api-smn/ListApplicationEndpoints.html)获取该标识。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'endpointUrn' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\UpdateApplicationEndpointRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\UpdateApplicationEndpointRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\UpdateApplicationEndpointRequestBody|null $body body
    *
    * @return $this
    */
