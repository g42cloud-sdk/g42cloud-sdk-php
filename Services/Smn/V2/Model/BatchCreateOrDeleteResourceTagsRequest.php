...
class BatchCreateOrDeleteResourceTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateOrDeleteResourceTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\BatchCreateOrDeleteResourceTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\BatchCreateOrDeleteResourceTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\BatchCreateOrDeleteResourceTagsRequestBody|null $body body
    *
    * @return $this
    */
