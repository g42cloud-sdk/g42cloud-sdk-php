...
class ListApplicationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'applications' => '\G42Cloud\SDK\Smn\V2\Model\ApplicationItem[]'
    ];
    ...
    *
    * @param int|null $applicationCount 返回的Application个数。该参数不受offset和limit影响，即返回的是您账户下所有的Application个数。
    *
    * @return $this
    */
    ...
    *  Application列表。
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\ApplicationItem[]|null
    */
    ...
    * Sets applications
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ApplicationItem[]|null $applications Application列表。
    *
    * @return $this
    */
