...
class UpdateMessageTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMessageTemplateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * messageTemplateId  模板唯一的资源标识，可通过查询[消息模板列表](https://support.huaweicloud.com/api-smn/ListMessageTemplates.html)获取该标识。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Smn\V2\Model\UpdateMessageTemplateRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\UpdateMessageTemplateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\UpdateMessageTemplateRequestBody|null $body body
    *
    * @return $this
    */
