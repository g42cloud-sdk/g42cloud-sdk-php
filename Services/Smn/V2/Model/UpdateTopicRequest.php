...
class UpdateTopicRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTopicRequest';
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\UpdateTopicRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\UpdateTopicRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\UpdateTopicRequestBody|null $body body
    *
    * @return $this
    */
