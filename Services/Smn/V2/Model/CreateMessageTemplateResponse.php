...
class CreateMessageTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMessageTemplateResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求的唯一标识ID。
    * messageTemplateId  模板唯一的资源标识。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $messageTemplateId 模板唯一的资源标识。
    *
    * @return $this
    */
