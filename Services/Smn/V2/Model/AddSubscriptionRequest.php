...
class AddSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddSubscriptionRequest';
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\AddSubscriptionRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\AddSubscriptionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\AddSubscriptionRequestBody|null $body body
    *
    * @return $this
    */
