...
class PublishAppMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublishAppMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            'endpointUrn' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\PublishAppMessageRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\PublishAppMessageRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\PublishAppMessageRequestBody|null $body body
    *
    * @return $this
    */
