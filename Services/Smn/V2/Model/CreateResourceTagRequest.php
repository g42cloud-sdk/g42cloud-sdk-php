...
class CreateResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\G42Cloud\SDK\Smn\V2\Model\CreateResourceTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\CreateResourceTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\CreateResourceTagRequestBody|null $body body
    *
    * @return $this
    */
