...
class ListTopicsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTopicsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'topicCount' => 'int',
            'topics' => '\G42Cloud\SDK\Smn\V2\Model\ListTopicsItem[]'
    ];
    ...
    *  Topic结构体数组。
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\ListTopicsItem[]|null
    */
    ...
    * Sets topics
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ListTopicsItem[]|null $topics Topic结构体数组。
    *
    * @return $this
    */
