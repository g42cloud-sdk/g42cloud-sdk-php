...
class ListSubscriptionsByTopicResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'subscriptions' => '\G42Cloud\SDK\Smn\V2\Model\ListSubscriptionsItem[]'
    ];
    ...
    *  Subscription结构体。
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\ListSubscriptionsItem[]|null
    */
    ...
    * Sets subscriptions
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ListSubscriptionsItem[]|null $subscriptions Subscription结构体。
    *
    * @return $this
    */
