...
class UpdateApplicationEndpointRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationEndpointRequestBody';
    ...
    * Sets userData
    *
    * @param string|null $userData 用户自定义数据，最大长度支持UTF-8编码后2048字节。
    *
    * @return $this
    */
