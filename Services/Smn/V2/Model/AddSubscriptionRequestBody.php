...
class AddSubscriptionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'endpoint' => 'string',
            'remark' => 'string',
            'extension' => '\G42Cloud\SDK\Smn\V2\Model\SubscriptionExtension'
    ];
    ...
    *  extension
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\SubscriptionExtension|null
    */
    ...
    * Sets extension
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\SubscriptionExtension|null $extension extension
    *
    * @return $this
    */
