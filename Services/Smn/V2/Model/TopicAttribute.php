...
class TopicAttribute implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'accessPolicy' => '\G42Cloud\SDK\Smn\V2\Model\AccessPolicy',
            'introduction' => 'string'
    ];
    ...
    *  accessPolicy
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\AccessPolicy|null
    */
    ...
    * Sets accessPolicy
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\AccessPolicy|null $accessPolicy accessPolicy
    *
    * @return $this
    */
