...
class ListApplicationEndpointAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApplicationEndpointAttributesRequest';
