...
class CreateApplicationEndpointResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateApplicationEndpointResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求的唯一标识ID。
    * endpointUrn  Endpoint的唯一资源标识。
    *
    * @var string[]
    */
    ...
    * Sets endpointUrn
    *
    * @param string|null $endpointUrn Endpoint的唯一资源标识。
    *
    * @return $this
    */
