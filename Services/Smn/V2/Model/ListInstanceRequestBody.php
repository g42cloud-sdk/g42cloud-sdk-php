...
class ListInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'tags' => '\G42Cloud\SDK\Smn\V2\Model\ResourceTags[]',
            'tagsAny' => '\G42Cloud\SDK\Smn\V2\Model\ResourceTags[]',
            'notTags' => '\G42Cloud\SDK\Smn\V2\Model\ResourceTags[]',
            'notTagsAny' => '\G42Cloud\SDK\Smn\V2\Model\ResourceTags[]',
            'offset' => 'string',
            'limit' => 'string',
            'action' => 'string',
            'matches' => '\G42Cloud\SDK\Smn\V2\Model\TagMatch[]'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\ResourceTags[]|null
    */
    ...
    * Sets tags
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ResourceTags[]|null $tags 最多包含10个key，每个key最多包含10个value，结构体不能缺失。key不能为空或者空字符串。key不能重复，同一个key中value不能重复，不同key对应的资源之间为与的关系。
    *
    * @return $this
    */
    ...
    * Sets tagsAny
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ResourceTags[]|null $tagsAny 最多包含10个key，每个key最多包含10个value，结构体不能缺失。key不能为空或者空字符串。key不能重复，同一个key中value不能重复，不同key对应的资源之间为或的关系。
    *
    * @return $this
    */
    ...
    * Sets notTags
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ResourceTags[]|null $notTags 最多包含10个key，每个key最多包含10个value，结构体不能缺失。key不能为空或者空字符串。key不能重复，同一个key中value不能重复，不同key对应的资源之间为与非的关系。
    *
    * @return $this
    */
    ...
    * Sets notTagsAny
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\ResourceTags[]|null $notTagsAny 最多包含10个key，每个key最多包含10个value，结构体不能缺失。key不能为空或者空字符串。key不能重复，同一个key中value不能重复，不同key对应的资源之间为或非的关系。
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Smn\V2\Model\TagMatch[]|null
    */
    ...
    * Sets matches
    *
    * @param \G42Cloud\SDK\Smn\V2\Model\TagMatch[]|null $matches 搜索字段。  key为要匹配的字段，当前只支持resource_name。  value为匹配的值，当前为精确匹配。
    *
    * @return $this
    */
