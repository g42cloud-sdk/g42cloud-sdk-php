...
class SmnAsyncClient extends Client
{
    ...
    public function createLogtankAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Smn\V2\Model\CreateLogtankResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Smn\V2\Model\CreateLogtankRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteLogtankAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Smn\V2\Model\DeleteLogtankResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Smn\V2\Model\DeleteLogtankRequest',
            $asyncRequest = true);
    }
    ...
    public function listLogtankAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Smn\V2\Model\ListLogtankResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Smn\V2\Model\ListLogtankRequest',
            $asyncRequest = true);
    }
    ...
    public function updateLogtankAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Smn\V2\Model\UpdateLogtankResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Smn\V2\Model\UpdateLogtankRequest',
            $asyncRequest = true);
    }
    ...
    public function updateSubscriptionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\G42Cloud\SDK\Smn\V2\Model\UpdateSubscriptionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\G42Cloud\SDK\Smn\V2\Model\UpdateSubscriptionRequest',
            $asyncRequest = true);
    }
