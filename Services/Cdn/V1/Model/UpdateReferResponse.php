...
class UpdateReferResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateReferResponse';
    ...
    */
    protected static $openAPITypes = [
            'referer' => '\G42Cloud\SDK\Cdn\V1\Model\RefererRsp'
    ];
    ...
    *  referer
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\RefererRsp|null
    */
    ...
    * Sets referer
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\RefererRsp|null $referer referer
    *
    * @return $this
    */
