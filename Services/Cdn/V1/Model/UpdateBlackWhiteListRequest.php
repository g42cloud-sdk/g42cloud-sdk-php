...
class UpdateBlackWhiteListRequest implements ModelInterface, ArrayAccess
{
    ...
    * domainId  需要设置IP黑白名单的域名id。获取方法请参见查询加速域名。
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\BlackWhiteListBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\BlackWhiteListBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\BlackWhiteListBody|null $body body
    *
    * @return $this
    */
