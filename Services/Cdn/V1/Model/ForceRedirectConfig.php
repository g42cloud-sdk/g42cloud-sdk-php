...
class ForceRedirectConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ForceRedirectConfig';
    ...
    * Sets status
    *
    * @param string $status 强制跳转开关（on：打开，off：关闭）。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 强制跳转类型（http：强制跳转HTTP，https：强制跳转HTTPS）。
    *
    * @return $this
    */
