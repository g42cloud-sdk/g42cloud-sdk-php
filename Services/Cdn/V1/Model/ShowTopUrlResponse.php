...
class ShowTopUrlResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serviceArea' => 'string',
            'topUrlSummary' => '\G42Cloud\SDK\Cdn\V1\Model\TopUrlSummary[]'
    ];
    ...
    *  详情数据对象。
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\TopUrlSummary[]|null
    */
    ...
    * Sets topUrlSummary
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\TopUrlSummary[]|null $topUrlSummary 详情数据对象。
    *
    * @return $this
    */
