...
class DomainItemLocationDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DomainItemLocationDetails';
    ...
    */
    protected static $openAPITypes = [
            ...
            'endTime' => 'int',
            'statType' => 'string',
            'domains' => '\G42Cloud\SDK\Cdn\V1\Model\DomainRegion[]'
    ];
    ...
    *  域名详情数据列表
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\DomainRegion[]|null
    */
    ...
    * Sets domains
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\DomainRegion[]|null $domains 域名详情数据列表
    *
    * @return $this
    */
