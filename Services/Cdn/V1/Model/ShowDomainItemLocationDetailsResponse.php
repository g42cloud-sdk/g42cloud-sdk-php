...
class ShowDomainItemLocationDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'domainItemLocationDetails' => '\G42Cloud\SDK\Cdn\V1\Model\DomainItemLocationDetails'
    ];
    ...
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\DomainItemLocationDetails|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\DomainItemLocationDetails|null $domainItemLocationDetails domainItemLocationDetails
    *
    * @return $this
    */
