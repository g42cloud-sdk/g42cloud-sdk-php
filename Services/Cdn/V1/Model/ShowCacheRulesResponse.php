...
class ShowCacheRulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCacheRulesResponse';
    ...
    */
    protected static $openAPITypes = [
            'cacheConfig' => '\G42Cloud\SDK\Cdn\V1\Model\CacheConfig'
    ];
    ...
    *  cacheConfig
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\CacheConfig|null
    */
    ...
    * Sets cacheConfig
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\CacheConfig|null $cacheConfig cacheConfig
    *
    * @return $this
    */
