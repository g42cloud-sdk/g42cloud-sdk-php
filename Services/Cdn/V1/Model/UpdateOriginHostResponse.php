...
class UpdateOriginHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOriginHostResponse';
    ...
    */
    protected static $openAPITypes = [
            'originHost' => '\G42Cloud\SDK\Cdn\V1\Model\DomainOriginHost'
    ];
    ...
    * Sets originHost
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\DomainOriginHost|null $originHost originHost
    *
    * @return $this
    */
