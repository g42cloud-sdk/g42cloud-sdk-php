...
class CreateRefreshTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRefreshTasksRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\RefreshTaskRequest'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\RefreshTaskRequest|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\RefreshTaskRequest|null $body body
    *
    * @return $this
    */
