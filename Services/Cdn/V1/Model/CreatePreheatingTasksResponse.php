...
class CreatePreheatingTasksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePreheatingTasksResponse';
    ...
    * Sets preheatingTask
    *
    * @param string|null $preheatingTask 任务ID
    *
    * @return $this
    */
