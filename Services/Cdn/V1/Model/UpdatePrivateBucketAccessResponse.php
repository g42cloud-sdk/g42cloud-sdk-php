...
class UpdatePrivateBucketAccessResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateBucketAccessResponse';
    ...
    * Sets status
    *
    * @param bool|null $status 桶开启关闭状态（true：开启；false：关闭）
    *
    * @return $this
    */
