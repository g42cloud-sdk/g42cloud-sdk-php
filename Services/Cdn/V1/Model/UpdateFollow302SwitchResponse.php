...
class UpdateFollow302SwitchResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'followStatus' => '\G42Cloud\SDK\Cdn\V1\Model\Follow302StatusBody'
    ];
    ...
    *  followStatus
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\Follow302StatusBody|null
    */
    ...
    * Sets followStatus
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\Follow302StatusBody|null $followStatus followStatus
    *
    * @return $this
    */
