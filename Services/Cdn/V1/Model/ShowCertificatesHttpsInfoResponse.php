...
class ShowCertificatesHttpsInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'https' => '\G42Cloud\SDK\Cdn\V1\Model\HttpsDetail[]'
    ];
    ...
    *  https对象。
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\HttpsDetail[]|null
    */
    ...
    * Sets https
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\HttpsDetail[]|null $https https对象。
    *
    * @return $this
    */
