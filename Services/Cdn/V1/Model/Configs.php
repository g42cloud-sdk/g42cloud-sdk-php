...
class Configs implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'urlAuth' => '\G42Cloud\SDK\Cdn\V1\Model\UrlAuth',
            'https' => '\G42Cloud\SDK\Cdn\V1\Model\HttpPutBody',
    ...
    *  urlAuth
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\UrlAuth|null
    */
    ...
    * Sets urlAuth
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\UrlAuth|null $urlAuth urlAuth
    *
    * @return $this
    */
    ...
    *  https
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\HttpPutBody|null
    */
    ...
    * Sets https
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\HttpPutBody|null $https https
    *
    * @return $this
    */
