...
class CacheConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CacheConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'followOrigin' => 'bool',
            'compress' => '\G42Cloud\SDK\Cdn\V1\Model\CompressRequest',
            'rules' => '\G42Cloud\SDK\Cdn\V1\Model\Rules[]'
    ];
    ...
    *  compress
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\CompressRequest|null
    */
    ...
    * Sets compress
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\CompressRequest|null $compress compress
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\Rules[]|null
    */
    ...
    * Sets rules
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\Rules[]|null $rules 缓存规则，将覆盖之前的规则配置。规则为空重置为默认规则。
    *
    * @return $this
    */
