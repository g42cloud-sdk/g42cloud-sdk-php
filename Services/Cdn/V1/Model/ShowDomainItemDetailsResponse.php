...
class ShowDomainItemDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'domainItemDetails' => '\G42Cloud\SDK\Cdn\V1\Model\DomainItemDetail'
    ];
    ...
    *  domainItemDetails
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\DomainItemDetail|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\DomainItemDetail|null $domainItemDetails domainItemDetails
    *
    * @return $this
    */
