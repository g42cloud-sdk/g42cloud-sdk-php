...
class DomainBody implements ModelInterface, ArrayAccess
{
    ...
    * domainName  加速域名。（ 国际英文域名：域名用字母（A-Z，a-z，大小写等价）、数字（0-9）和连接符（-）组成，各级域名之间用实点（.）连接，国际域名75个字符。注意连接符（-）不能作为域名的开头或结尾字符。）
    ...
    * enterpriseProjectId  企业项目ID，创建域名归属的项目。注意：当使用子账号调用接口时，该参数必传。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'domainName' => 'string',
            'businessType' => 'string',
            'sources' => '\G42Cloud\SDK\Cdn\V1\Model\Sources[]',
            'serviceArea' => 'string',
    ...
    * Sets domainName
    *
    * @param string $domainName 加速域名。（ 国际英文域名：域名用字母（A-Z，a-z，大小写等价）、数字（0-9）和连接符（-）组成，各级域名之间用实点（.）连接，国际域名75个字符。注意连接符（-）不能作为域名的开头或结尾字符。）
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\Sources[]
    */
    ...
    * Sets sources
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\Sources[] $sources 源站域名或源站IP，源站为IP类型时，仅支持IPv4，如需传入多个源站IP，以多个源站对象传入，除IP其他参数请保持一致，主源站最多支持15个源站IP对象，备源站最多支持15个源站IP对象；源站为域名类型时仅支持1个源站对象。不支持IP源站和域名源站混用。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $enterpriseProjectId 企业项目ID，创建域名归属的项目。注意：当使用子账号调用接口时，该参数必传。
    *
    * @return $this
    */
