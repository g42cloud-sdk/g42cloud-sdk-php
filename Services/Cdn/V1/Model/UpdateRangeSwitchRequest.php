...
class UpdateRangeSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRangeSwitchRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'domainId' => 'string',
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\RangeStatusRequest'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\RangeStatusRequest|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\RangeStatusRequest|null $body body
    *
    * @return $this
    */
