...
class CreateDomainResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'domain' => '\G42Cloud\SDK\Cdn\V1\Model\CreateDomainResponseBodyContent'
    ];
    ...
    *  domain
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\CreateDomainResponseBodyContent|null
    */
    ...
    * Sets domain
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\CreateDomainResponseBodyContent|null $domain domain
    *
    * @return $this
    */
