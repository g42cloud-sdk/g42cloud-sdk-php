...
class UpdateDomainOriginRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDomainOriginRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\OriginRequest'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\OriginRequest|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\OriginRequest|null $body body
    *
    * @return $this
    */
