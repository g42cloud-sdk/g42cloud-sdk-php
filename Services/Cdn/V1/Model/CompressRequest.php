...
class CompressRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CompressRequest';
    ...
    * Sets compressSwitch
    *
    * @param int|null $compressSwitch GZIP压缩开关。0关闭。1打开
    *
    * @return $this
    */
