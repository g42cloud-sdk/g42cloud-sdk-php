...
class CompressResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'compressSwitch' => 'int',
            'compressRules' => '\G42Cloud\SDK\Cdn\V1\Model\CompressRules[]'
    ];
    ...
    *  GZIP压缩规则
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\CompressRules[]|null
    */
    ...
    * Sets compressRules
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\CompressRules[]|null $compressRules GZIP压缩规则
    *
    * @return $this
    */
