...
class ShowBlackWhiteListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBlackWhiteListRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * domainId  需要查询IP黑白名单的域名id。获取方法请参见查询加速域名。
