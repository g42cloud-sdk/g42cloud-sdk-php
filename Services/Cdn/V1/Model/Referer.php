...
class Referer implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Referer';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['refererType'] === null) {
            $invalidProperties[] = "'refererType' can't be null";
        }
    ...
    * Sets refererType
    *
    * @param int $refererType Referer类型。取值：0代表不设置Referer过滤；1代表黑名单；2代表白名单。默认取值为0。
    *
    * @return $this
    */
    ...
    * Sets includeEmpty
    *
    * @param bool|null $includeEmpty 是否包含空Referer。如果是黑名单并开启该选项，则表示无referer不允许访问。如果是白名单并开启该选项，则表示无referer允许访问。默认值false。
    *
    * @return $this
    */
