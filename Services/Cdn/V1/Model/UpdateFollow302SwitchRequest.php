...
class UpdateFollow302SwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFollow302SwitchRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\Follow302StatusRequest'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\Follow302StatusRequest|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\Follow302StatusRequest|null $body body
    *
    * @return $this
    */
