...
class UpdateRangeSwitchResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'originRange' => '\G42Cloud\SDK\Cdn\V1\Model\OriginRangeBody'
    ];
    ...
    *  originRange
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\OriginRangeBody|null
    */
    ...
    * Sets originRange
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\OriginRangeBody|null $originRange originRange
    *
    * @return $this
    */
