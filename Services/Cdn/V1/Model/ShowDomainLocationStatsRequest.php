...
class ShowDomainLocationStatsRequest implements ModelInterface, ArrayAccess
{
    ...
    * country  国家编码，多个以英文逗号分隔，all表示全部。
    * province  省份编码，当country为cn（中国）时有效，多个以英文逗号分隔，all表示全部。
    * isp  运营商编码，多个以英文逗号分隔，all表示全部。
    ...
    * Sets country
    *
    * @param string|null $country 国家编码，多个以英文逗号分隔，all表示全部。
    *
    * @return $this
    */
    ...
    * Sets province
    *
    * @param string|null $province 省份编码，当country为cn（中国）时有效，多个以英文逗号分隔，all表示全部。
    *
    * @return $this
    */
    ...
    * Sets isp
    *
    * @param string|null $isp 运营商编码，多个以英文逗号分隔，all表示全部。
    *
    * @return $this
    */
