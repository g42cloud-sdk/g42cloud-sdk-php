...
class UpdateDomainMultiCertificatesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'https' => '\G42Cloud\SDK\Cdn\V1\Model\UpdateDomainMultiCertificatesResponseBodyContent'
    ];
    ...
    *  https
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\UpdateDomainMultiCertificatesResponseBodyContent|null
    */
    ...
    * Sets https
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\UpdateDomainMultiCertificatesResponseBodyContent|null $https https
    *
    * @return $this
    */
