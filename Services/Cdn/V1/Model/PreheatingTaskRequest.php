...
class PreheatingTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'preheatingTask' => '\G42Cloud\SDK\Cdn\V1\Model\PreheatingTaskRequestBody'
    ];
    ...
    *  preheatingTask
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\PreheatingTaskRequestBody
    */
    ...
    * Sets preheatingTask
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\PreheatingTaskRequestBody $preheatingTask preheatingTask
    *
    * @return $this
    */
