...
class RefreshTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'refreshTask' => '\G42Cloud\SDK\Cdn\V1\Model\RefreshTaskRequestBody'
    ];
    ...
    *  refreshTask
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\RefreshTaskRequestBody
    */
    ...
    * Sets refreshTask
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\RefreshTaskRequestBody $refreshTask refreshTask
    *
    * @return $this
    */
