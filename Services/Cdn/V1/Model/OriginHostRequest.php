...
class OriginHostRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'originHost' => '\G42Cloud\SDK\Cdn\V1\Model\OriginHostBody'
    ];
    ...
    *  originHost
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\OriginHostBody
    */
    ...
    * Sets originHost
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\OriginHostBody $originHost originHost
    *
    * @return $this
    */
