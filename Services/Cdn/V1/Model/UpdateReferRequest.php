...
class UpdateReferRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateReferRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'domainId' => 'string',
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\RefererBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\RefererBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\RefererBody|null $body body
    *
    * @return $this
    */
