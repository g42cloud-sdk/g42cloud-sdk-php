...
class CreateRefreshTasksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRefreshTasksResponse';
    ...
    * Sets refreshTask
    *
    * @param string|null $refreshTask 任务ID
    *
    * @return $this
    */
