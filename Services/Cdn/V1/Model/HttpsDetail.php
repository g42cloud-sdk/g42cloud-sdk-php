...
class HttpsDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'forceRedirectConfig' => '\G42Cloud\SDK\Cdn\V1\Model\ForceRedirect',
            'http2' => 'int'
    ];
    ...
    *  forceRedirectConfig
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\ForceRedirect|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\ForceRedirect|null $forceRedirectConfig forceRedirectConfig
    *
    * @return $this
    */
