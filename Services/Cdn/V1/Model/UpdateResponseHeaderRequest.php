...
class UpdateResponseHeaderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateResponseHeaderRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\G42Cloud\SDK\Cdn\V1\Model\HeaderBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Cdn\V1\Model\HeaderBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Cdn\V1\Model\HeaderBody|null $body body
    *
    * @return $this
    */
