...
class VolumeGroups implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'components' => 'string',
            'freeSize' => 'int',
            'logicalVolumes' => '\G42Cloud\SDK\Sms\V3\Model\LogicalVolumes[]',
            'name' => 'string',
            'size' => 'int'
    ];
    ...
    *  lv信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\LogicalVolumes[]|null
    */
    ...
    * Sets logicalVolumes
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\LogicalVolumes[]|null $logicalVolumes lv信息
    *
    * @return $this
    */
