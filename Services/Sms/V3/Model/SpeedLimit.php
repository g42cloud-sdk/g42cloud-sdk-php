...
class SpeedLimit implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SpeedLimit';
    ...
    */
    protected static $openAPITypes = [
            'speedLimit' => '\G42Cloud\SDK\Sms\V3\Model\SpeedLimitlJson[]'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['speedLimit'] === null) {
            $invalidProperties[] = "'speedLimit' can't be null";
        }
    ...
    *  按时间段限速信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SpeedLimitlJson[]
    */
    ...
    * Sets speedLimit
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SpeedLimitlJson[] $speedLimit 按时间段限速信息
    *
    * @return $this
    */
