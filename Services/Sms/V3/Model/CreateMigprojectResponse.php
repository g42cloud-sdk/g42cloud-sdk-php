...
class CreateMigprojectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMigprojectResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  创建迁移项目返回的新添加的迁移项目的id
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id 创建迁移项目返回的新添加的迁移项目的id
    *
    * @return $this
    */
