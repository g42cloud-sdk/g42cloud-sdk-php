...
class SourceServersResponseBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'cpuQuantity' => 'int',
            'memory' => 'int',
            'currentTask' => '\G42Cloud\SDK\Sms\V3\Model\TaskByServerSources',
    ...
    *  currentTask
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TaskByServerSources|null
    */
    ...
    * Sets currentTask
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TaskByServerSources|null $currentTask currentTask
    *
    * @return $this
    */
    ...
    * Sets checks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\EnvironmentCheck[]|null $checks 源端校验检查项列表
    *
    * @return $this
    */
