...
class ListTemplatesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'templates' => '\G42Cloud\SDK\Sms\V3\Model\TemplateResponseBody[]'
    ];
    ...
    * Sets templates
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TemplateResponseBody[]|null $templates 模板信息
    *
    * @return $this
    */
