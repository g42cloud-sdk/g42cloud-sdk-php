...
class ShowServerResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'connected' => 'bool',
            'firmware' => 'string',
            'initTargetServer' => '\G42Cloud\SDK\Sms\V3\Model\InitTargetServer',
            'cpuQuantity' => 'int',
            'memory' => 'int',
            'currentTask' => '\G42Cloud\SDK\Sms\V3\Model\TaskByServerSource',
            'disks' => '\G42Cloud\SDK\Sms\V3\Model\ServerDisk[]',
            'volumeGroups' => '\G42Cloud\SDK\Sms\V3\Model\VolumeGroups[]',
            'btrfsList' => '\G42Cloud\SDK\Sms\V3\Model\BtrfsFileSystem[]',
            'networks' => '\G42Cloud\SDK\Sms\V3\Model\NetWork[]',
            'checks' => '\G42Cloud\SDK\Sms\V3\Model\EnvironmentCheck[]',
    ...
    *  initTargetServer
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\InitTargetServer|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\InitTargetServer|null $initTargetServer initTargetServer
    *
    * @return $this
    */
    ...
    *  currentTask
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TaskByServerSource|null
    */
    ...
    * Sets currentTask
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TaskByServerSource|null $currentTask currentTask
    *
    * @return $this
    */
    ...
    *  源端服务器磁盘信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\ServerDisk[]|null
    */
    ...
    * Sets disks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\ServerDisk[]|null $disks 源端服务器磁盘信息
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\VolumeGroups[]|null
    */
    ...
    * Sets volumeGroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\VolumeGroups[]|null $volumeGroups 源端服务器的卷组信息，Linux必选，如果没有卷组，输入[]
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\BtrfsFileSystem[]|null
    */
    ...
    * Sets btrfsList
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\BtrfsFileSystem[]|null $btrfsList Linux 必选，源端的Btrfs信息。如果源端不存在Btrfs，则为[]
    *
    * @return $this
    */
    ...
    *  源端服务器的网卡信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\NetWork[]|null
    */
    ...
    * Sets networks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\NetWork[]|null $networks 源端服务器的网卡信息
    *
    * @return $this
    */
    ...
    *  源端环境校验信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\EnvironmentCheck[]|null
    */
    ...
    * Sets checks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\EnvironmentCheck[]|null $checks 源端环境校验信息
    *
    * @return $this
    */
