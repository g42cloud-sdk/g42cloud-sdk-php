...
class PhysicalVolumes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PhysicalVolumes';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['inodeSize']) && ($this->container['inodeSize'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'inodeSize', must be smaller than or equal to 9223372036854775807.";
            }
