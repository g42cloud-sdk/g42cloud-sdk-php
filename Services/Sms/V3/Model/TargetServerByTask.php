...
class TargetServerByTask implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'disks' => '\G42Cloud\SDK\Sms\V3\Model\TargetDisks[]',
            'name' => 'string',
            'vmId' => 'string',
    ...
    * Sets btrfsList
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\BtrfsFileSystem[]|null $btrfsList btrfs信息，数据从源端获取
    *
    * @return $this
    */
    ...
    *  磁盘信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TargetDisks[]
    */
    ...
    * Sets disks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TargetDisks[] $disks 磁盘信息
    *
    * @return $this
    */
    ...
    * Sets volumeGroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\VolumeGroups[]|null $volumeGroups 卷组，数据从源端获取
    *
    * @return $this
    */
