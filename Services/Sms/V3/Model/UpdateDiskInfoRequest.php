...
class UpdateDiskInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDiskInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            'sourceId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\PutDiskInfoReq'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutDiskInfoReq|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutDiskInfoReq|null $body body
    *
    * @return $this
    */
