...
class TargetDisk implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'diskId' => 'string',
            'name' => 'string',
            'physicalVolumes' => '\G42Cloud\SDK\Sms\V3\Model\TargetPhysicalVolumes[]',
            'size' => 'int',
            'usedSize' => 'int',
            'diskIndex' => 'string',
            'osDisk' => 'bool',
    ...
    *  逻辑卷信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TargetPhysicalVolumes[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TargetPhysicalVolumes[]|null $physicalVolumes 逻辑卷信息
    *
    * @return $this
    */
