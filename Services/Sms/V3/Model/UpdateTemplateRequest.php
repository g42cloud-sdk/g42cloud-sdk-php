...
class UpdateTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\UpdateTemplateReq'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\UpdateTemplateReq|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\UpdateTemplateReq|null $body body
    *
    * @return $this
    */
