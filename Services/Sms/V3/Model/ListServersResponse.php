...
class ListServersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'sourceServers' => '\G42Cloud\SDK\Sms\V3\Model\SourceServersResponseBody[]'
    ];
    ...
    *  批量查询的源端服务器详列表
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SourceServersResponseBody[]|null
    */
    ...
    * Sets sourceServers
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SourceServersResponseBody[]|null $sourceServers 批量查询的源端服务器详列表
    *
    * @return $this
    */
