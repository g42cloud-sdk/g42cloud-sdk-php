...
class UpdateNetworkCheckInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNetworkCheckInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\NetworkCheckInfoRequestBody'
    ];
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\NetworkCheckInfoRequestBody|null $body body
    *
    * @return $this
    */
