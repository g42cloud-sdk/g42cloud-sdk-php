...
class ListMigprojectsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMigprojectsRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 每一页记录的迁移项目
    *
    * @return $this
    */
