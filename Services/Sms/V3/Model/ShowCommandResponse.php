...
class ShowCommandResponse implements ModelInterface, ArrayAccess
{
    ...
    * commandName  命令名称，分为：START、STOP、DELETE、SYNC
    ...
    */
    protected static $openAPITypes = [
            'commandName' => 'string',
            'commandParam' => '\G42Cloud\SDK\Sms\V3\Model\ComandParam'
    ];
    ...
    * Sets commandName
    *
    * @param string|null $commandName 命令名称，分为：START、STOP、DELETE、SYNC
    *
    * @return $this
    */
    ...
    *  commandParam
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\ComandParam|null
    */
    ...
    * Sets commandParam
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\ComandParam|null $commandParam commandParam
    *
    * @return $this
    */
