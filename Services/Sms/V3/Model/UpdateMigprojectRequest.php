...
class UpdateMigprojectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMigprojectRequest';
    ...
    */
    protected static $openAPITypes = [
            'migProjectId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\MigProject'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\MigProject|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\MigProject|null $body body
    *
    * @return $this
    */
