...
class PutVolumeGroups implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'logicalVolumes' => '\G42Cloud\SDK\Sms\V3\Model\PutLogicalVolume[]',
            'id' => 'string',
            'needMigration' => 'bool',
            'adjustSize' => 'int'
    ];
    ...
    *  lv信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutLogicalVolume[]|null
    */
    ...
    * Sets logicalVolumes
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutLogicalVolume[]|null $logicalVolumes lv信息
    *
    * @return $this
    */
