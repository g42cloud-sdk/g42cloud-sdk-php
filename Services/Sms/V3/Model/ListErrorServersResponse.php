...
class ListErrorServersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'migrationErrors' => '\G42Cloud\SDK\Sms\V3\Model\MigrationErrors[]'
    ];
    ...
    *  迁移过程中发生的错误详情
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\MigrationErrors[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\MigrationErrors[]|null $migrationErrors 迁移过程中发生的错误详情
    *
    * @return $this
    */
