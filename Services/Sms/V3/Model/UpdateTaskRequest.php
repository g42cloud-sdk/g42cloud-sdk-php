...
class UpdateTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\PutTaskReq'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutTaskReq|null $body body
    *
    * @return $this
    */
