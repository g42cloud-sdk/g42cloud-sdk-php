...
class Disk implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'size' => 'int',
            'usedSize' => 'int',
            'physicalVolumes' => '\G42Cloud\SDK\Sms\V3\Model\PhysicalVolumes[]',
            'diskId' => 'string',
            'osDisk' => 'bool',
            'relationName' => 'string'
    ];
    ...
    *  磁盘上的物理分区信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PhysicalVolumes[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PhysicalVolumes[] $physicalVolumes 磁盘上的物理分区信息
    *
    * @return $this
    */
    ...
    * Sets diskId
    *
    * @param string|null $diskId 创建任务时，如果选择已有虚拟机，此参数必选
    *
    * @return $this
    */
