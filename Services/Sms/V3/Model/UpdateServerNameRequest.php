...
class UpdateServerNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateServerNameRequest';
    ...
    */
    protected static $openAPITypes = [
            'sourceId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\PutSourceServerBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutSourceServerBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutSourceServerBody|null $body body
    *
    * @return $this
    */
