...
class InitTargetServer implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'disks' => '\G42Cloud\SDK\Sms\V3\Model\DiskIntargetServer[]',
    ...
    *  推荐的目的端服务器的磁盘信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\DiskIntargetServer[]
    */
    ...
    * Sets disks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\DiskIntargetServer[] $disks 推荐的目的端服务器的磁盘信息
    *
    * @return $this
    */
