...
class UpdateCommandResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCommandResultRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  上报命令执行结果的命令所对应的服务端ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\CommandBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\CommandBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\CommandBody|null $body body
    *
    * @return $this
    */
