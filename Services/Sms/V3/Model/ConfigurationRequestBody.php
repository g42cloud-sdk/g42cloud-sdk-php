...
class ConfigurationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfigurationRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'configurations' => '\G42Cloud\SDK\Sms\V3\Model\ConfigBody[]'
    ];
    ...
    *  配置项列表
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\ConfigBody[]
    */
    ...
    * Sets configurations
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\ConfigBody[] $configurations 配置项列表
    *
    * @return $this
    */
