...
class TaskByServerSource implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'projectName' => 'string',
            'projectId' => 'string',
            'targetServer' => '\G42Cloud\SDK\Sms\V3\Model\TargetServerById',
    ...
    *  targetServer
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TargetServerById|null
    */
    ...
    * Sets targetServer
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TargetServerById|null $targetServer targetServer
    *
    * @return $this
    */
