...
class PutSourceServerBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'migprojectid' => 'string',
            'disks' => '\G42Cloud\SDK\Sms\V3\Model\PutDisk[]',
            'volumeGroups' => '\G42Cloud\SDK\Sms\V3\Model\PutVolumeGroups[]'
    ];
    ...
    *  磁盘
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutDisk[]|null
    */
    ...
    * Sets disks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutDisk[]|null $disks 磁盘
    *
    * @return $this
    */
    ...
    *  卷组
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutVolumeGroups[]|null
    */
    ...
    * Sets volumeGroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutVolumeGroups[]|null $volumeGroups 卷组
    *
    * @return $this
    */
