...
class TargetServer implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TargetServer';
    ...
    */
    protected static $openAPITypes = [
            ...
            'cpuQuantity' => 'int',
            'memory' => 'int',
            'disks' => '\G42Cloud\SDK\Sms\V3\Model\TargetDisk[]',
            'btrfsList' => 'string[]',
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['disks'] === null) {
            ...
            if (!is_null($this->container['flavor']) && (mb_strlen($this->container['flavor']) > 255)) {
            ...
            if (!is_null($this->container['snapshotIds']) && (mb_strlen($this->container['snapshotIds']) > 255)) {
                $invalidProperties[] = "invalid value for 'snapshotIds', the character length must be smaller than or equal to 255.";
            }
    ...
    *  目的端磁盘信息，一般和源端保持一致
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TargetDisk[]
    */
    ...
    * Sets disks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TargetDisk[] $disks 目的端磁盘信息，一般和源端保持一致
    *
    * @return $this
    */
    ...
    * Sets volumeGroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\VolumeGroups[]|null $volumeGroups lvm信息，一般和源端保持一致
    *
    * @return $this
    */
    ...
    * Sets flavor
    *
    * @param string|null $flavor 目的端服务器的规格
    *
    * @return $this
    */
    ...
    * Sets snapshotIds
    *
    * @param string|null $snapshotIds 目的端快照ID
    *
    * @return $this
    */
