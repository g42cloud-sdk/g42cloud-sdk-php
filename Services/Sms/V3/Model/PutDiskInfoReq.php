...
class PutDiskInfoReq implements ModelInterface, ArrayAccess
{
    ...
    * Sets disks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\ServerDisk[]|null $disks 更新的磁盘信息
    *
    * @return $this
    */
    ...
    * Sets volumegroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\VolumeGroups[]|null $volumegroups 更新的卷信息
    *
    * @return $this
    */
    ...
    * Sets btrfsList
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\BtrfsFileSystem[]|null $btrfsList 更新的btrfs信息
    *
    * @return $this
    */
