...
class ServerDisk implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'size' => 'int',
            'usedSize' => 'int',
            'physicalVolumes' => '\G42Cloud\SDK\Sms\V3\Model\PhysicalVolume[]',
            'osDisk' => 'bool',
            'relationName' => 'string',
            'inodeSize' => 'int'
    ];
    ...
    *  磁盘上的物理分区信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PhysicalVolume[]
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PhysicalVolume[] $physicalVolumes 磁盘上的物理分区信息
    *
    * @return $this
    */
