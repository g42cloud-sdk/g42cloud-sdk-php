...
class ListTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'tasks' => '\G42Cloud\SDK\Sms\V3\Model\TasksResponseBody[]'
    ];
    ...
    * Sets count
    *
    * @param int|null $count 符合要求的任务数量，不受分页影响
    *
    * @return $this
    */
    ...
    *  查询到的任务列表
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TasksResponseBody[]|null
    */
    ...
    * Sets tasks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TasksResponseBody[]|null $tasks 查询到的任务列表
    *
    * @return $this
    */
