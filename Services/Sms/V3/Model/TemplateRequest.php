...
class TemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'volumetype' => 'string',
            'flavor' => 'string',
            'vpc' => '\G42Cloud\SDK\Sms\V3\Model\VpcObject',
            'nics' => '\G42Cloud\SDK\Sms\V3\Model\Nics[]',
            'securityGroups' => '\G42Cloud\SDK\Sms\V3\Model\SgObject[]',
            'publicip' => '\G42Cloud\SDK\Sms\V3\Model\PublicIp',
            'disk' => '\G42Cloud\SDK\Sms\V3\Model\TemplateDisk[]',
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['projectid'] === null) {
            ...
            if (!is_null($this->container['targetServerName']) && (mb_strlen($this->container['targetServerName']) < 0)) {
                $invalidProperties[] = "invalid value for 'targetServerName', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['availabilityZone']) && (mb_strlen($this->container['availabilityZone']) > 255)) {
    ...
    *
    * @param string|null $targetServerName 目标端服务器名称
    *
    * @return $this
    */
    ...
    * Sets flavor
    *
    * @param string|null $flavor 虚拟机规格
    *
    * @return $this
    */
    ...
    *  vpc
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\VpcObject|null
    */
    ...
    * Sets vpc
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\VpcObject|null $vpc vpc
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\Nics[]|null
    */
    ...
    * Sets nics
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\Nics[]|null $nics 网卡信息，支持多个网卡，如果是自动创建，只填一个，ID使用“autoCreate”
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SgObject[]|null
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SgObject[]|null $securityGroups 安全组，支持多个安全组，如果是自动创建，只填一个，ID使用“autoCreate”
    *
    * @return $this
    */
    ...
    *  publicip
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PublicIp|null
    */
    ...
    * Sets publicip
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PublicIp|null $publicip publicip
    *
    * @return $this
    */
    ...
    *  磁盘信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TemplateDisk[]|null
    */
    ...
    * Sets disk
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TemplateDisk[]|null $disk 磁盘信息
    *
    * @return $this
    */
    ...
    * Sets imageId
    *
    * @param string|null $imageId 新建目的虚拟机用户选择的镜像版本Id值
    *
    * @return $this
    */
