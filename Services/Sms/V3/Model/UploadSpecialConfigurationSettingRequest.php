...
class UploadSpecialConfigurationSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadSpecialConfigurationSettingRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\ConfigurationRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\ConfigurationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\ConfigurationRequestBody|null $body body
    *
    * @return $this
    */
