...
class BtrfsFileSystem implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'subvolumn' => '\G42Cloud\SDK\Sms\V3\Model\BtrfsSubvolumn[]'
    ];
    ...
    *  子卷信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\BtrfsSubvolumn[]
    */
    ...
    * Sets subvolumn
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\BtrfsSubvolumn[] $subvolumn 子卷信息
    *
    * @return $this
    */
