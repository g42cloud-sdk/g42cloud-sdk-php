...
class ShowMigprojectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMigprojectResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'description' => 'string',
            'isdefault' => 'bool',
            'template' => '\G42Cloud\SDK\Sms\V3\Model\TemplateResponseBody',
            'region' => 'string',
    ...
    *  template
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TemplateResponseBody|null
    */
    ...
    * Sets template
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TemplateResponseBody|null $template template
    *
    * @return $this
    */
