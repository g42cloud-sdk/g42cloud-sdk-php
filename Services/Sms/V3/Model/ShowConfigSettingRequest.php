...
class ShowConfigSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConfigSettingRequest';
    ...
    * Sets configKey
    *
    * @param string|null $configKey 具体请求配置项
    *
    * @return $this
    */
