...
class UpdateSpeedRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSpeedRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\SpeedLimit'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SpeedLimit|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SpeedLimit|null $body body
    *
    * @return $this
    */
