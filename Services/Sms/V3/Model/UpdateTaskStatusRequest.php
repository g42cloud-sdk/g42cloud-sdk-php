...
class UpdateTaskStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTaskStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\UpdateTaskStatusReq'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\UpdateTaskStatusReq|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\UpdateTaskStatusReq|null $body body
    *
    * @return $this
    */
