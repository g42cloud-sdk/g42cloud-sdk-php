...
class UpdateCopyStateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'sourceId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\PutCopyStateReq'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutCopyStateReq|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutCopyStateReq|null $body body
    *
    * @return $this
    */
