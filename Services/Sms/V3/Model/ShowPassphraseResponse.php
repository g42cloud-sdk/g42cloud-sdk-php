...
class ShowPassphraseResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPassphraseResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  任务ID
    * passphrase  安全传输通道证书passphrase
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['passphrase']) && (mb_strlen($this->container['passphrase']) > 255)) {
                $invalidProperties[] = "invalid value for 'passphrase', the character length must be smaller than or equal to 255.";
            }
            if (!is_null($this->container['passphrase']) && (mb_strlen($this->container['passphrase']) < 0)) {
    ...
    * Sets passphrase
    *
    * @param string|null $passphrase 安全传输通道证书passphrase
    *
    * @return $this
    */
