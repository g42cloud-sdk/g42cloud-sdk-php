...
class TasksResponseBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'totalTime' => 'int',
            'migrationIp' => 'string',
            'subTasks' => '\G42Cloud\SDK\Sms\V3\Model\SubTaskAssociatedWithTask[]',
            'sourceServer' => '\G42Cloud\SDK\Sms\V3\Model\SourceServerAssociatedWithTask',
            'enterpriseProjectId' => 'string',
            'targetServer' => '\G42Cloud\SDK\Sms\V3\Model\TargetServerAssociatedWithTask',
            'logCollectStatus' => 'string',
            'cloneServer' => '\G42Cloud\SDK\Sms\V3\Model\CloneServerBrief',
            'syncing' => 'bool',
            'networkCheckInfo' => '\G42Cloud\SDK\Sms\V3\Model\NetworkCheckInfoRequestBody',
            'specialConfig' => '\G42Cloud\SDK\Sms\V3\Model\ConfigBody[]'
    ];
    ...
    *  任务关联的子任务信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SubTaskAssociatedWithTask[]|null
    */
    ...
    * Sets subTasks
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SubTaskAssociatedWithTask[]|null $subTasks 任务关联的子任务信息
    *
    * @return $this
    */
    ...
    *  sourceServer
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SourceServerAssociatedWithTask|null
    */
    ...
    * Sets sourceServer
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SourceServerAssociatedWithTask|null $sourceServer sourceServer
    *
    * @return $this
    */
    ...
    *  targetServer
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TargetServerAssociatedWithTask|null
    */
    ...
    * Sets targetServer
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TargetServerAssociatedWithTask|null $targetServer targetServer
    *
    * @return $this
    */
    ...
    *  cloneServer
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\CloneServerBrief|null
    */
    ...
    * Sets cloneServer
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\CloneServerBrief|null $cloneServer cloneServer
    *
    * @return $this
    */
    ...
    *  networkCheckInfo
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\NetworkCheckInfoRequestBody|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\NetworkCheckInfoRequestBody|null $networkCheckInfo networkCheckInfo
    *
    * @return $this
    */
    ...
    *  特殊配置项配置信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\ConfigBody[]|null
    */
    ...
    * Sets specialConfig
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\ConfigBody[]|null $specialConfig 特殊配置项配置信息
    *
    * @return $this
    */
