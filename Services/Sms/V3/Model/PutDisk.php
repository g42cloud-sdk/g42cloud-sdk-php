...
class PutDisk implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'adjustSize' => 'int',
            'physicalVolumes' => '\G42Cloud\SDK\Sms\V3\Model\PutVolume[]'
    ];
    ...
    *  修改的卷信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PutVolume[]|null
    */
    ...
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PutVolume[]|null $physicalVolumes 修改的卷信息
    *
    * @return $this
    */
