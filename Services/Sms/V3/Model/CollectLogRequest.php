...
class CollectLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CollectLogRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\G42Cloud\SDK\Sms\V3\Model\UploadLogRequestBody'
    ];
    ...
    *  body
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\UploadLogRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\UploadLogRequestBody|null $body body
    *
    * @return $this
    */
