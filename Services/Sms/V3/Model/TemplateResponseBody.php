...
class TemplateResponseBody implements ModelInterface, ArrayAccess
{
    ...
    *  vpc
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\VpcObject
    */
    ...
    * Sets vpc
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\VpcObject $vpc vpc
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\Nics[]
    */
    ...
    * Sets nics
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\Nics[] $nics 网卡信息，支持多个网卡，如果是自动创建，只填一个，ID使用“autoCreate”
    *
    * @return $this
    */
    ...
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\SgObject[]
    */
    ...
    * Sets securityGroups
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\SgObject[] $securityGroups 安全组，支持多个安全组，如果是自动创建，只填一个，ID使用“autoCreate”
    *
    * @return $this
    */
    ...
    *  publicip
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\PublicIp
    */
    ...
    * Sets publicip
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\PublicIp $publicip publicip
    *
    * @return $this
    */
    ...
    *  磁盘信息
    *
    * @return \G42Cloud\SDK\Sms\V3\Model\TemplateDisk[]
    */
    ...
    * Sets disk
    *
    * @param \G42Cloud\SDK\Sms\V3\Model\TemplateDisk[] $disk 磁盘信息
    *
    * @return $this
    */
