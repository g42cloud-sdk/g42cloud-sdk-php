...
namespace G42Cloud\SDK\Core\Http;

use GuzzleHttp\Client;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\Psr7\Request;
use G42Cloud\SDK\Core\Exceptions\CallTimeoutException;
use G42Cloud\SDK\Core\Exceptions\ClientRequestException;
use G42Cloud\SDK\Core\Exceptions\HostUnreachableException;
use G42Cloud\SDK\Core\Exceptions\RetryOutageException;
use G42Cloud\SDK\Core\Exceptions\SdkErrorMessage;
use G42Cloud\SDK\Core\Exceptions\SdkException;
use G42Cloud\SDK\Core\Exceptions\ServerResponseException;
use G42Cloud\SDK\Core\Exceptions\SslHandShakeException;
use G42Cloud\SDK\Core\SdkRequest;
use Monolog\Logger;
